...
namespace HSRP
{
    public partial class WebForm1 : System.Web.UI.Page
    {
      ...
      MailHelper objMailSender = new MailHelper();
        ...
        {
            Response.Redirect(String.Format("Complaints.aspx"));
        }
        ...
        private void GenerateIdsAndSendMail(string strCompNo)
        {
            ...
            lst.Add("dlhsrp@gmail.com");//dlhsrp@gmail.com
            string EmailSubject = "DL Complaint";
            string EmailText = "Respected Sir <br /> <br />Complaint has been raised with following details: <br /> Mail Id: " + txtMail.Text + " <br /> Vehicle No: " + txtRegno.Text + "  <br /> Mobile No: " + txtMobile.Text + " <br /> Complaint No: " + strCompNo + " <br /> Cash Receipt No: " + txtreceipt.Text.ToString() + " <br /> Complaint: " + txtRemarks.Text + " <br /> Regards, <br /> <br /> IT Support Team"; ;

            SendMail(lst, "dlhsrp@gmail.com", "", EmailSubject, EmailText);
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string strQuery = "INSERT INTO [dbo].[Complaint] ([Region],ComplaintNo,[StateId],[OwnerName]" +
                        ...
                        ",[Remarks]" +
                        ",[MobileNo]" +
                        ",[email],[IPAddress],[cashreceiptno])" +
                        "VALUES('" + ddlComplaintRegion.SelectedItem.Text + "','" + strComNo + "','2','" + txtName.Text + "','" + txtRegno.Text +
                        "','" + txtEngineno.Text + "','" + txtChasisNo.Text + "','" + txtRemarks.Text + "','" + txtMobile.Text + "','" + txtMail.Text + "','" + Context.Request.UserHostAddress.ToString() + "','" + txtreceipt.Text.ToString() + "')";
        ...
        protected void linkconcat_Click(object sender, EventArgs e)
        {
            Response.Redirect("ContactScreen.aspx");
        }
