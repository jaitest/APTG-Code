<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmComplaints.aspx.cs" Inherits="HSRP.frmComplaints" %>
                        ...
                        <tr>
                            ...
                            <td width="150">
                                <asp:DropDownList ID="ddlComplaintRegion" runat="server">
                                    ...
                                    <asp:ListItem Value="2">Complaint/Suggestion</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
