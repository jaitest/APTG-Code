...
<body style="background-color: rgb(156, 241, 255)">
    ...
    <div style="height: 100%;">
        ...
        <table width="500" border="0" align="right" cellpadding="0" cellspacing="0" class="x-window-mc">
            <tr>
                <td valign="top">
        ...
        <%--  <div style="vertical-align:bottom;"  id="footerbg">
         ...
         <div style="font: normal 86px tahoma, arial, verdana; color: #AAABAC; margin-left: 40px; margin-top: 38px;"> Welcome Delhi</div>
    </div>
    </form>
</body>
</html>
