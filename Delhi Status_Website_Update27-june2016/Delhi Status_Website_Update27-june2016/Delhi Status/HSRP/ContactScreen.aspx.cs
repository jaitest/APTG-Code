    ...
    public partial class ContactScreen : System.Web.UI.Page
    {
      ...
      DataTable ds = new DataTable();
        ...
        private void Fill()
        {
            ...
            "ContactPersonName,MobileNo,EmailID,Rtocode,EmailID2 From RTOLocation where HSRP_StateID=2 and LocationType='Sub-Urban' and rtocode is not null  and rtolocationname not in ('MAYAPURI','D Surajmal Vihar')";
            ...
            sb.Append("<table width='100%' border='0' align='center' cellpadding='6' cellspacing='0'>");
            sb.Append("<tr align='center'>");
            sb.Append("<td   height='19' valign='top' nowrap='nowrap' align='left' class='midboxtop'>RTO Code</td>");
            sb.Append("<td  valign='top' nowrap='nowrap' width='30px' align='left' class='midboxtop' >Supervisor</td>");
            sb.Append("<td  valign='top' nowrap='nowrap' align='left' class='midboxtop' >RTO Location Name</font></td>");
            sb.Append("<td  valign='top' align='left' width='400px' valign='top' class='midboxtop' >RTO Location Address</td>");
            sb.Append("<td  valign='top' nowrap='nowrap' align='left' class='midboxtop' >Mobile No</td>");
            sb.Append("<td  valign='top' nowrap='nowrap' align='left' class='midboxtop' >Email ID</td>");
           // sb.Append("<td  valign='top' nowrap='nowrap' class='midboxtop' >Email ID</td>");
            ...
            if (PReader.HasRows)
            {
                while (PReader.Read())
                {
                    ...
                    sb.Append("<td nowrap='nowrap' align='left' class='heading1'>" + Rtocode + "</td>");
                    sb.Append("<td nowrap='nowrap' align='left' class='heading1'>" + ContactPersonName + "</td>");
                    sb.Append("<td nowrap='nowrap' align='left' class='heading1'>" + RTOLocationName + "</td>");
                    sb.Append("<td align='left' class='heading1'>" + RTOLocationAddress + "</td>");
                    sb.Append("<td width='120' align='left' class='heading1'>" + MobileNo + "</td>");
                    sb.Append("<td nowrap='nowrap' align='left' class='heading1'>" + EmailID + "</td>");
