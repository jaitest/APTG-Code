...
namespace DataProvider
{
    public class BAL
    {
       ...
       string StringRearPlatePrize, string StringStickerPrize, string StringScrewPrize, ref int isexists)
        ...
        string VAT_Amount, string ServiceTax_Percentage, string ServiceTax_Amount, string TotalAmount, string NetAmount,
        string HSRPStateID, string RTOLocationID, string DeliveryChallan, string StringFixingCharge, string StringFrontPlatePrize,
        string StringRearPlatePrize, string StringStickerPrize, string StringScrewPrize, string Remarks, int UID, string RTOLocationIDd,
            decimal GSTBasicAmount1, decimal UTGSTPer1, decimal UTGSTAmount1,  decimal CGSTPer1, decimal CGSTAmount1,   ref int isexists, ref string HSRPRecordID)
                          
        {
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@GSTBasicAmount", GSTBasicAmount1));
                cmd.Parameters.Add(new SqlParameter("@CGSTPer", CGSTPer1));
                cmd.Parameters.Add(new SqlParameter("@CGSTAmount", CGSTAmount1));
                cmd.Parameters.Add(new SqlParameter("@UTGSTAmount", UTGSTAmount1));
                cmd.Parameters.Add(new SqlParameter("@UTGSTPer", UTGSTPer1));
