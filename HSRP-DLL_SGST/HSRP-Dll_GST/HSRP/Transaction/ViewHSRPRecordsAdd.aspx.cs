...
{
    public partial class ViewHSRPRecordsAdd : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            try
            {
                ...
                SQLString = "SELECT [HSRPRecordID],[HSRP_StateID],InvoiceDateTime,ChassisNo,HSRPRecord_AuthorizationNo,convert(varchar, HSRPRecord_AuthorizationDate, 105) as HSRPRecord_AuthorizationDate,  convert(varchar, OrderEmbossingDate, 105) as OrderEmbossingDate,HSRP_Front_LaserCode, HSRP_Rear_LaserCode,VehicleRegNo,NetAmount,[OwnerName] ,EngineNo,VehicleType,[MobileNo],[EmailID],OrderStatus FROM [HSRPRecords] Where HSRP_StateID=" + intHSRPStateID + " and UserRTOLocationID=" + intRTOLocationID + "  and OrderDate>CONVERT (varchar(20),GETDATE(),101)+' 00:00:01' and OrderStatus!='Closed' order by OrderDate desc";
        ...
        protected void Grid1_ItemCommand(object sender, ComponentArt.Web.UI.GridItemCommandEventArgs e)
        {
            ...
            if (e.Control.ID.ToString() == "LinkButtonCashReceipt")
            {
                ...
                if (obj.FillHSRPRecordDeliveryChallan(HSRPRecordID, ref dataSetFillHSRPDeliveryChallan))
                {
                    ...
                    string getTinNo = Utils.getScalarValue("select GSTIN from hsrpstate where HSRP_StateID='" + HSRPStateID + "' ", CnnString);
