...
namespace HSRP.Transaction
{
    public partial class TransportTracking : System.Web.UI.Page
    {
        ...
        protected void btnblank_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect(String.Format("http://180.151.100.242/HSRPDL01/Report/DailyAuthorityBlankPlateStock.aspx"));
                return;
            }
            catch (Exception ee)
            {
        ...
        protected void dmreport_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect(String.Format("http://180.151.100.242/HSRPDL01/Report/DailyAuthorityRTOLocationWiseOrderClosedGov_damage.aspx"));
                return;
            }
            catch (Exception ee)
            {
