                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:UpdatePanel ID="UpdatePanelVat" UpdateMode="Conditional" ChildrenAsTriggers="true"
                                                        runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="textBoxVat" Visible="false" runat="server" Width="50px" Enabled="false" class="form_textbox11"></asp:TextBox>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click" />
                                                            <asp:AsyncPostBackTrigger ControlID="DropDownListOrderType" EventName="SelectedIndexChanged" />
                                                ...
                                                <td align="left">
                                                    <asp:UpdatePanel ID="UpdatePanelVatAmount" UpdateMode="Conditional" ChildrenAsTriggers="true"
                                                        runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="textBoxVatAmount" runat="server" Width="50px" Visible="false" Enabled="false" class="form_textbox11"></asp:TextBox>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click" />
                                                            <asp:AsyncPostBackTrigger ControlID="DropDownListOrderType" EventName="SelectedIndexChanged" />
