    ...
    public partial class HSRPRecords : System.Web.UI.Page
    {
      ...
      //  msgBox objMsgBox = new msgBox();
        ...
        protected void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            string strGetData = "Select Top 1 hsrp_stateid,rtolocationid,[VehicleType],[OrderStatus] from hsrprecords where [VehicleRegNo]='" + TextBoxVehicleRegNo.Text + "' and orderstatus in('New Order','Embossing Done') order by [HSRPRecord_CreationDate] desc";
        ...
        private void SaveData()
        {
            ...
            try
            {
                ...
                string strtax = " select  UTGSTPer,UTGSTAmount,CGSTPer,CGSTAmount,Roundoff_NetAmount,GSTBasicAmount  from tax where OrderType = '" + StringOrderType.ToString().Trim() + "' and VehicleType ='" + StringVehicleModel.ToString().Trim() + "' and isnull(GSTBasicAmount,0)!=0  and   HSRP_StateID=2";

                DataTable dtgsttax = Utils.GetDataTable(strtax, CnnString);

                if (dtgsttax.Rows.Count > 0)
                {
                    UTGSTPer = decimal.Round(Convert.ToDecimal(dtgsttax.Rows[0]["UTGSTPer"].ToString()), 2);
                    UtGSTPeanmt = decimal.Round(Convert.ToDecimal(dtgsttax.Rows[0]["UTGSTAmount"].ToString()), 2);
                ...
                if (obj.InsertHSRPRecords(MacAddress, AuthorizationNo, dateAuth, StringOrderNo,
                   ...
                   StringStickerPrize, StringScrewPrize, textBoxRemarks.Text, UID, dropDownListRTOLocation.SelectedValue, GSTBasicPeanmt, UTGSTPer, UtGSTPeanmt, CGSTPer, CGSTPeramt, ref Isexists, ref HSRPRecordID))
                {
                    temp++;
                    if (Isexists.Equals(1))
                    {
                    ...
                    else
                    {
                        ...
                        temp++;
                        LknBtnCashReceipts.Visible = false;
                        ...
                        if (StringMobileNo.Length > 0)
                        {
                            ...
                            string SMSText = " Cash Rs." + StringNetTotal.ToString() + " collected against Reg No. " + StringVehicleRegNo + " receipt number " + StringCashReceiptNo + "dated  " + System.DateTime.Now.ToString("dd/MM/yyyy") + ".HSRP TEAM";
                            string sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-delhsrp&password=delhsrp&type=0&dlr=1&destination=" + StringMobileNo.ToString() + "&source=DLHSRP&message=" + SMSText;
                            ...
                            Utils.ExecNonQuery("insert into DLSMSDetail(RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode,smstext,SmsType) values('" + RTOLocationID + "','" + StringVehicleRegNo.Trim().ToUpper() + "'," + StringMobileNo.ToString() + ",'" + result + "','" + SMSText + "','0')", CnnString);
                        }
        ...
        public void EpsionPrint(string HSRPRecordID)
        {
            ...
            else
            {
              ...
              string SQLString = "select hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType,CashReceiptNo , GSTBasicAmount ,UTGSTPer,	CGSTPer	,CGSTAmount,	UTGSTAmount from hsrprecords where hsrprecordid='" + HSRPRecordID + "' order by HSRPRecord_AuthorizationNo,vehicleRegNo desc";
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                PdfPCell cell12 = new PdfPCell(new Phrase("" + GetAddress.Rows[0]["CompanyName"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell12.Colspan = 4;
                cell12.BorderColor = BaseColor.WHITE;
                cell12.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell12);
                ...
                /// for address 
                PdfPCell cell121add = new PdfPCell(new Phrase("" + GetAddress.Rows[0]["address1"].ToString() + " "+ GetAddress.Rows[0]["city"].ToString() +" "+ GetAddress.Rows[0]["pincode"].ToString() ,new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell121add.Colspan = 4;
                cell121add.BorderColor = BaseColor.WHITE;
                cell121add.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell121add);
                ...
                PdfPCell cell11ggods = new PdfPCell(new Phrase("DESCRIPTION OF GOODS", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell11ggods.Colspan = 0;
                cell11ggods.BorderWidthLeft = 0f;
                cell11ggods.BorderWidthRight = 0f;
                cell11ggods.BorderWidthTop = 0f;
                cell11ggods.BorderWidthBottom = 0f;
                cell11ggods.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell11ggods);

                PdfPCell cell115goods = new PdfPCell(new Phrase(": " +"HSRP (HSN8310)", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell115goods.Colspan = 0;
                cell115goods.BorderWidthLeft = 0f;
                cell115goods.BorderWidthRight = 0f;
                cell115goods.BorderWidthTop = 0f;
                cell115goods.BorderWidthBottom = 0f;
                cell115goods.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell115goods);
                ...
                PdfPCell cellNet120 = new PdfPCell(new Phrase("HSRP Fee (Rs.)", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell1205 = new PdfPCell(new Phrase(" " + dataSetFillHSRPDeliveryChallan.Rows[0]["GSTBasicAmount"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell1205.Colspan = 0;
                cell1205.BorderWidthLeft = 0f;
                cell1205.BorderWidthRight = 0f;
                cell1205.BorderWidthTop = 0f;
                ...
                cell1205.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell1205);
                //	GSTBasicAmount ,UTGSTPer,	CGSTPer	,CGSTAmount,	UTGSTAmount
                PdfPCell cell11CGST = new PdfPCell(new Phrase("CGST @"+ Convert.ToInt32(Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["CGSTPer"].ToString()))+"%", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell11CGST.Colspan = 0;
                cell11CGST.BorderWidthLeft = 0f;
                cell11CGST.BorderWidthRight = 0f;
                cell11CGST.BorderWidthTop = 0f;
                cell11CGST.BorderWidthBottom = 0f;
                cell11CGST.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell11CGST);

                PdfPCell cell115cgst= new PdfPCell(new Phrase(": " + dataSetFillHSRPDeliveryChallan.Rows[0]["CGSTAmount"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell115cgst.Colspan = 0;
                cell115cgst.BorderWidthLeft = 0f;
                cell115cgst.BorderWidthRight = 0f;
                cell115cgst.BorderWidthTop = 0f;
                cell115cgst.BorderWidthBottom = 0f;
                cell115cgst.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell115cgst);

                PdfPCell cell11UTGST = new PdfPCell(new Phrase("SGST @"+ Convert.ToInt32(Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["UTGSTPer"].ToString()))+"%", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell11UTGST.Colspan = 0;
                cell11UTGST.BorderWidthLeft = 0f;
                cell11UTGST.BorderWidthRight = 0f;
                cell11UTGST.BorderWidthTop = 0f;
                cell11UTGST.BorderWidthBottom = 0f;
                cell11UTGST.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell11UTGST);

                PdfPCell cell115utgst = new PdfPCell(new Phrase(": " + dataSetFillHSRPDeliveryChallan.Rows[0]["UTGSTAmount"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell115utgst.Colspan = 0;
                cell115utgst.BorderWidthLeft = 0f;
                cell115utgst.BorderWidthRight = 0f;
                cell115utgst.BorderWidthTop = 0f;
                cell115utgst.BorderWidthBottom = 0f;
                cell115utgst.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell115utgst);



                PdfPCell celldupCash401 = new PdfPCell(new Phrase("TOTAL AMOUNT( ROUND OFF)", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
