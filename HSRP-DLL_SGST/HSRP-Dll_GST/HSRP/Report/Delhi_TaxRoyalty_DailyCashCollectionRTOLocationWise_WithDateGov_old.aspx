<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Delhi_TaxRoyalty_DailyCashCollectionRTOLocationWise_WithDateGov_old.aspx.cs" Inherits="HSRP.Report.Delhi_TaxRoyalty_DailyCashCollectionRTOLocationWise_WithDateGov_old" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Daily Cash Collection And Royalty Report</span>
                                    </td>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle" class="form_text">
                                                    <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Label Text="Location:" Visible="false" runat="server" Style="display:none;" ID="labelClient" />&nbsp;&nbsp;
                                                ...
                                                <td style="position: relative; right: -6px; top: -1px;">
