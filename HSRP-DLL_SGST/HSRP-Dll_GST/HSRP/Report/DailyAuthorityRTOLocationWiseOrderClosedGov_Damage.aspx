<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyAuthorityRTOLocationWiseOrderClosedGov_Damage.aspx.cs" Inherits="HSRP.Report.DailyAuthorityRTOLocationWiseOrderClosedGov_Damage" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">HSRP Damage Report</span>
                                    </td>
...
<%--                                     <td valign="middle" class="form_text" nowrap="nowrap">
                                         ...
                                         <asp:Label Text="From:" Visible="true" runat="server" ID="labelDate">
                                          ...
                                          &nbsp;&nbsp;</td>--%>
                                    <td valign="middle" class="form_text" nowrap="nowrap"> &nbsp;&nbsp;<asp:Label Text="From:" Visible="true" runat="server" ID="label1" /> &nbsp;&nbsp;</td>
