<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyAuthorityBlankPlateStock.aspx.cs" Inherits="HSRP.Report.DailyAuthorityBlankPlateStock" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">HSRP Blank Plate Report</span>
                                    </td>
...
<%--                                     <td valign="middle" class="form_text" nowrap="nowrap">
                                         ...
                                         <asp:Label Text="From:" Visible="true" runat="server" ID="labelDate">
                                          ...
                                          &nbsp;&nbsp;</td>--%>
                                    <td valign="middle" class="form_text" nowrap="nowrap"> &nbsp;&nbsp;<asp:Label Text="From:" Visible="false" runat="server" ID="label1" /> &nbsp;&nbsp;</td>
                                    ...
                                    <td valign="top" onmouseup="OrderDate_OnMouseUp()" align="left">
                                                            ...
                                                            <td valign="top" align="left">
                                                                <%--<img id="calendar_from_button" tabindex="3" alt="" onclick="OrderDate_OnClick()"  Visible="false" 
                                                                    onmouseup="OrderDate_OnMouseUp()" class="calendar_button" src="../images/btn_calendar.gif" />--%>
                                                            </td>
                                   <td valign="middle" class="form_text" nowrap="nowrap"> &nbsp;&nbsp;<asp:Label Text="To:" Visible="false" runat="server" ID="labelTO" /> &nbsp;&nbsp;</td>
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()" align="left">
                                    ...
                                    <td style="Position:relative; right:-5px; top: -2px;"> 
                                        
                                        <asp:Button ID="btnExportToExcel" runat="server" Text="Report In PDF" ToolTip="Please Click for Report"
                                            class="button"  
                                    ...
                                    <td>
                                                        ...
                                                        class="button" Visible="false" onclick="btnAllLocationPdf_Click"/>
                                                </td>
                                    <tr>
                                    <td colspan="9">
