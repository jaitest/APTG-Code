...
{
    public partial class DailyAuthorityRTOLocationWiseOrderClosedGov_Damage : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SQLString = "SELECT ROW_NUMBER() Over (Order by Hsrprecord_Creationdate) As SNo, CONVERT(varchar(20), a.HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,convert(varchar,ordercloseddate,103) as ordercloseddate,  CONVERT(varchar(20), a.OrderDate, 103) AS OrderDate, a.HSRPRecordID,a.CashReceiptNo,a.InvoiceNo,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime, VehicleClass,CONVERT(numeric,round(a.RoundOff_NetAmount,0)) as NetAmount, a.HSRPRecord_AuthorizationNo, a.OwnerName, a.VehicleClass, a.VehicleType, a.VehicleRegNo, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.StickerMandatory,  (select P.productCode from Product P Where P.ProductID =a.FrontPlateSize) as FrontPlateCode, (select P.productCode from Product P Where P.ProductID =a.rearPlateSize) as RearPlateCode,a.Ordertype ,'NO*' [Plate Removed and Destructed] FROM HSRPRecords a  where a.HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and a.OrderClosedDate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and a.ordertype in ('DF','DR','DB') and  a.OwnerName is not null and a.OwnerName <> '' order by Hsrprecord_Creationdate desc";

                string filename = DropDownListStateName.SelectedItem.ToString() + "_AffixationReportDamage_" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
        ...
        public void DownLoadPDF(DataTable dt)
        {
            ...
            {
                i = dt.Rows.Count;
                string filename = DropDownListStateName.SelectedItem.ToString() + "_AffixationReportDamage_" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".pdf";
                String StringField = String.Empty;
                String StringAlert = String.Empty;
                ...
                PdfPCell cell120911 = new PdfPCell(new Phrase("HSRP Damage Report", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell120911.Colspan = 16;
                ...
                PdfPCell cell1209101 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell1209101.Colspan = 16;
                cell1209101.BorderWidthLeft = 0f;
                cell1209101.BorderWidthRight = 0f;
                cell1209101.BorderWidthTop = 0f;
                cell1209101.BorderWidthBottom = 0f;

                cell1209101.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell1209101);
                ...
                PdfPCell cell12201 = new PdfPCell(new Phrase("Order Type", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell12201.Colspan = 1;
                cell12201.BorderWidthLeft = 0f;
                cell12201.BorderWidthRight = .8f;
                cell12201.BorderWidthTop = 1f;
                cell12201.BorderWidthBottom = 1f;

                cell12201.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell12201);
                ...
                PdfPCell cell1209309 = new PdfPCell(new Phrase("Plates Removed and Destructed", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell1209309.Colspan = 1;
                cell1209309.BorderWidthLeft = 1f;
                cell1209309.BorderWidthRight = .8f;
                cell1209309.BorderWidthTop = 1f;
                cell1209309.BorderWidthBottom = 1f;

                cell1209309.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right                
                table.AddCell(cell1209309);

                //PdfPCell cell1223 = new PdfPCell(new Phrase("Plates Removed and Destructed", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                //cell1223.Colspan = 1;
                ...
                while (i >= 0)
                {
                    ...
                    PdfPCell cell12202 = new PdfPCell(new Phrase(dt.Rows[i]["OrderType"].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cell12202.Colspan = 1;
                    cell12202.BorderWidthLeft = 0f;
                    cell12202.BorderWidthRight = .8f;
                    cell12202.BorderWidthTop = .5f;
                    cell12202.BorderWidthBottom = .5f;

                    cell12202.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                    table.AddCell(cell12202);
                    ...
                    PdfPCell cell120945 = new PdfPCell(new Phrase(dt.Rows[i]["Plate Removed and Destructed"].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cell120945.Colspan = 1;
                    cell120945.BorderWidthLeft = 0f;
                    cell120945.BorderWidthRight = .8f;
                    cell120945.BorderWidthTop = .5f;
                    cell120945.BorderWidthBottom = .5f;

                    cell120945.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                    table.AddCell(cell120945);
                    i--;
                }
                ...
                PdfPCell cell12090011 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell12090011.Colspan = 16;
                cell12090011.BorderWidthLeft = 0f;
                cell12090011.BorderWidthRight = 0f;
                cell12090011.BorderWidthTop = 0f;
                cell12090011.BorderWidthBottom = 0f;
                cell12090011.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell12090011);

                PdfPCell cell1209011 = new PdfPCell(new Phrase("*No = Vehicle Came without Number Plate", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell1209011.Colspan = 16;
                ...
                cell1209011.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
