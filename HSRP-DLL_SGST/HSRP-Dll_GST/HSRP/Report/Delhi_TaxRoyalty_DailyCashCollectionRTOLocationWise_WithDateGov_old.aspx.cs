...
{
    public partial class Delhi_TaxRoyalty_DailyCashCollectionRTOLocationWise_WithDateGov_old : System.Web.UI.Page
    {
        ...
        //    string TodayDates = "07-01-2016";
        //    string Maxdates = "07-31-2017";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //StringOrderDate = "2017/07/01 00:00:00";
                if (DateTime.Parse(StringOrderDate.ToString()) >= DateTime.Parse("2017/07/01 00:00:00") && DateTime.Parse(StringAuthDate.ToString()) >= DateTime.Parse("2017/07/01 23:59:59"))
                {
                ...
                else if (DateTime.Parse(StringOrderDate.ToString()) <= DateTime.Parse("2017/06/30 00:00:00") && DateTime.Parse(StringAuthDate.ToString()) <= DateTime.Parse("2017/06/30 23:59:59"))
                {
                    SQLString = MakeQueryOnTheBasisOfSeletedOption(StringOrderDate, StringAuthDate, dropDownListClient.SelectedValue.ToString());
                    DataTable dtRecord = Utils.GetDataTable(SQLString, CnnString);
                    if (dtRecord.Rows.Count > 0)
                ...
                {
                    //LabelError.Text = "Please Check Date.";
                }
        ...
        private string MakeQueryOnTheBasisOfSeletedOption(String StringOrderDate, String StringAuthDate, string RTOCode)
        {
            ...
            if (DateTime.Parse(StringOrderDate.ToString()) >= DateTime.Parse("2017/07/01 00:00:00") && DateTime.Parse(StringAuthDate.ToString()) >= DateTime.Parse("2017/07/01 00:00:00"))         
           {
               if (ddlVehicleReference.SelectedItem.Text == "Both" && DropDownListVehicleModel.SelectedItem.Text == "All")
                {
                    SQLString = "SELECT ROW_NUMBER() Over (Order by hsrprecordid) As SNo, HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,CGSTAmount,UTGSTAmount as 'SGSTAmount',GSTBasicAmount,OrderDate,EngineNo,ChassisNo,MobileNo FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and  OwnerName is not null and OwnerName <> '' and  Address1 is not null and Address1 <> '' order by hsrprecordid desc";
                }
                else if (ddlVehicleReference.SelectedItem.Text == "Both")
                {
                    SQLString = "SELECT ROW_NUMBER() Over (Order by hsrprecordid) As SNo,  HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,CGSTAmount,UTGSTAmount as 'SGSTAmount',GSTBasicAmount,OrderDate,EngineNo,ChassisNo,MobileNo FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "'  and VehicleType='" + DropDownListVehicleModel.SelectedItem.ToString() + "'  and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and   OwnerName is not null and OwnerName <> ''  and  Address1 is not null and Address1 <> '' order by hsrprecordid desc";
                }
                ...
                {
                    SQLString = "SELECT ROW_NUMBER() Over (Order by hsrprecordid) As SNo,  HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,CGSTAmount,UTGSTAmount as 'SGSTAmount',GSTBasicAmount,OrderDate,EngineNo,ChassisNo,MobileNo FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and vehicleref='" + ddlVehicleReference.SelectedItem.ToString() + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and  OwnerName is not null and OwnerName <> '' and Address1 is not null and Address1 <> '' order by hsrprecordid desc";
                }
                else
                {
                    SQLString = "SELECT ROW_NUMBER() Over (Order by hsrprecordid) As SNo,  HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,CGSTAmount,UTGSTAmount as 'SGSTAmount',GSTBasicAmount,OrderDate,EngineNo,ChassisNo,MobileNo FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and vehicleref='" + ddlVehicleReference.SelectedItem.ToString() + "' and VehicleType='" + DropDownListVehicleModel.SelectedItem.ToString() + "'  and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and   OwnerName is not null and OwnerName <> '' and Address1 is not null and Address1 <> '' order by hsrprecordid desc";
                }
                return SQLString;
          }
            else
          {
                if (ddlVehicleReference.SelectedItem.Text == "Both" && DropDownListVehicleModel.SelectedItem.Text == "All")
                {
                    SQLString = "SELECT ROW_NUMBER() Over (Order by hsrprecordid) As SNo, HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,vat_amount FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and  OwnerName is not null and OwnerName <> '' and  Address1 is not null and Address1 <> '' order by hsrprecordid desc";
                }
                else if (ddlVehicleReference.SelectedItem.Text == "Both")
                {
                ...
                {
                    SQLString = "SELECT ROW_NUMBER() Over (Order by hsrprecordid) As SNo,  HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,vat_amount FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and vehicleref='" + ddlVehicleReference.SelectedItem.ToString() + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and  OwnerName is not null and OwnerName <> '' and Address1 is not null and Address1 <> '' order by hsrprecordid desc";
                }
                else
                {
        ...
        public void DownLoadPDF_new(DataTable dt)
        {
            String ReportDateFrom = OrderDate.SelectedDate.ToString("yyyy/MM/dd");
            String ReportDateTo = HSRPAuthDate.SelectedDate.ToString("yyyy/MM/dd");
            decimal totalAmount = 0;
            decimal totalAmountgstbasicamt=0;
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                PdfPCell cell120935 = new PdfPCell(new Phrase("CGST Amount", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell120935.Colspan = 1;
                cell120935.BorderWidthLeft = 1f;
                cell120935.BorderWidthRight = .8f;
                cell120935.BorderWidthTop = 1f;
                ...
                PdfPCell cell120936 = new PdfPCell(new Phrase("SGST Amount", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell120936.Colspan = 1;
                cell120936.BorderWidthLeft = 1f;
                cell120936.BorderWidthRight = .8f;
                cell120936.BorderWidthTop = 1f;
                ...
                PdfPCell cell120937 = new PdfPCell(new Phrase("GST Basic Amount", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell120937.Colspan = 1;
                cell120937.BorderWidthLeft = 1f;
                cell120937.BorderWidthRight = .8f;
                cell120937.BorderWidthTop = 1f;
                ...
                while (i >= 0)
                {
                    ...
                    PdfPCell cell120940 = new PdfPCell(new Phrase(dt.Rows[i]["CGSTAmount"].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cell120940.Colspan = 1;
                    cell120940.BorderWidthLeft = 0f;
                    cell120940.BorderWidthRight = .8f;
                    cell120940.BorderWidthTop = .5f;
                    ...
                    totalAmountcgst = totalAmountcgst + decimal.Round(Convert.ToDecimal(dt.Rows[i]["CGSTAmount"].ToString()), 2, MidpointRounding.AwayFromZero);
                        // Math.Round(Convert.ToDecimal(dt.Rows[i]["CGSTAmount"].ToString()));

                    PdfPCell cell120941 = new PdfPCell(new Phrase(dt.Rows[i]["SGSTAmount"].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cell120941.Colspan = 1;
                    cell120941.BorderWidthLeft = 0f;
                    cell120941.BorderWidthRight = .8f;
                    cell120941.BorderWidthTop = .5f;
                    ...
                    totalAmountsgst = totalAmountsgst + decimal.Round(Convert.ToDecimal(dt.Rows[i]["SGSTAmount"].ToString()), 2, MidpointRounding.AwayFromZero);
                        

                    PdfPCell cell120942 = new PdfPCell(new Phrase(dt.Rows[i]["GSTBasicAmount"].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cell120942.Colspan = 1;
                    cell120942.BorderWidthLeft = 0f;
                    cell120942.BorderWidthRight = .8f;
                    cell120942.BorderWidthTop = .5f;
                   ...
                   // Convert.ToString(decimal.Round(Convert.ToDecimal(dt.Rows[i]["CGSTAmount"].ToString()), 2, MidpointRounding.AwayFromZero))

                    totalAmountgstbasicamt = totalAmountgstbasicamt + decimal.Round(Convert.ToDecimal(dt.Rows[i]["GSTBasicAmount"].ToString()), 2, MidpointRounding.AwayFromZero);
                        //Math.Round(Convert.ToDecimal(dt.Rows[i]["GSTBasicAmount"].ToString()));
                ...
                PdfPCell cell12242 = new PdfPCell(new Phrase("CGST Amount :" + (totalAmountcgst).ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell12242.Colspan = 3;
                cell12242.BorderWidthLeft = 1f;
                cell12242.BorderWidthRight = 1f;
                cell12242.BorderWidthTop = 1f;
                ...
                PdfPCell cell12243 = new PdfPCell(new Phrase("SGST Amount :  " + (totalAmountsgst).ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell12243.Colspan = 3;
                cell12243.BorderWidthLeft = 1f;
                cell12243.BorderWidthRight = 1f;
                cell12243.BorderWidthTop = 1f;
                ...
                PdfPCell cell12244 = new PdfPCell(new Phrase("GSTBasicAmount :    " +  (totalAmountgstbasicamt).ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell12244.Colspan = 3;
                cell12244.BorderWidthLeft = 1f;
                cell12244.BorderWidthRight = 1f;
                cell12244.BorderWidthTop = 1f;
