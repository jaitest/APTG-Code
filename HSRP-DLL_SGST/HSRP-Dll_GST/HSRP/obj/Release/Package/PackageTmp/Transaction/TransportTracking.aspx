                ...
                <td>
                    ...
                    <td valign="middle" class="Label_user_batch" style="width: 165px">
                                        ...
                                        <asp:Label ID="lblProductionCenterAddress" runat="server" ForeColor="black" Font-Size="15px"></asp:Label></td>
                                                ...
                                                <tr>
                                                    <td width="20%" class="form_text">
                                                        <asp:Button ID="btnblank" runat="server" Text="Blank Plate Stock" class="button" Font-Bold="true" OnClick="btnblank_Click" />
                                                     </td>
                                                </tr>

                                                 <tr>
                                                    <td width="20%" class="form_text">
                                                        <asp:Button ID="dmreport" runat="server" Text="Damage Report" class="button" Font-Bold="true" OnClick="dmreport_Click" />
                                                     </td>
                                                </tr>
