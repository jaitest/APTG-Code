...
namespace HSRP.EmbossingData
{
    public partial class APChalan : System.Web.UI.Page
    {
        ...
        private DataTable GetRecords(string strRecordId)
        {
            ...
            string SQLString12 = "select row_number() over(order by VehicleClass,VehicleType,VehicleRegNo) as SN,ChallanNo,challandate,convert(varchar,HSRPRecord_CreationDate,103) as HSRPRecord_CreationDate,VehicleType,VehicleClass,convert(varchar,OrderEmbossingDate,103) as OrderEmbossingDate,hsrp_stateid,rtolocationid" +
        ...
        private void ShowGrid( string strFromdate,string strToDate)
        {
            ...
            try
            {
                string SQLString1 = "select distinct dealerid  from delhi_dealermaster a,hsrprecords as h where a.SNO=h.dealerid and H.hsrprecord_creationdate between '" + strFromdate + "' and '" + strToDate + "' and  h.HSRP_StateID=2 and a.[NAME OF THE DEALER]='" + DealerName + "' and h. NAVEMBID='" + ddlemb.SelectedValue.ToString() + "'   and  convert(date,h.OrderEmbossingdate) <= convert(date,'2017-06-30')  ";
        ...
        protected void btnChalan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string filename = "HSRP-INVOICE_" + dealername2.ToString().Trim() + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".pdf";
                ...
                try
                {
                    ...
                    string strSelectEmbStation = "SELECT DISTINCT [NAVEMBID],[EmbCenterName],RTOLocationName,city FROM [vw_RTOLocationWiseEmbosingCenters] WHERE NAVEMBID='" + ddlemb.SelectedValue + "'";
                    ...
                    if (dtEmbData.Rows.Count <= 0)
                    {
                     ...
                     strEmbId = dtEmbData.Rows[0]["NAVEMBID"].ToString();
                      ...
                      strGetInvoiceNo = "select (isnull(prefixtext,'')+right('00000'+ convert(varchar,lastno+1),5)) from [EmbossingCenters] " +
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            GenerateCell(table, 7, 0, 0, 0, 0, 1, 0, "HSRP Order Booking Report", 0, 0);
            ...
            GenerateCell(table, 1, 0, 1, 1, 0, 0, 1, "Vehicle Class", 0, 0);
            ...
            foreach (GridViewRow di in GridView1.Rows)
            {
                ...
                if (chkBx != null && chkBx.Checked)
                {
                    ...
                    if (dtData.Rows.Count > 0)
                    {
                        ...
                        string strvehicleclass = dtData.Rows[0]["VehicleClass"].ToString();
                        ...
                        GenerateCell(table, 1, 0, 1, 1, 1, 0, 1, strvehicleclass, 0, 0);
        ...
        {
            HttpContext context = HttpContext.Current;
            string dealername1=ddlBothDealerHHT.SelectedItem.ToString();
            string filename =  "HSRP-INVOICE_" +dealername1.ToString() + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".pdf";
