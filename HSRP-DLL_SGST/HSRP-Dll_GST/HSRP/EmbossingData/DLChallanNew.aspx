<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DLChallanNew.aspx.cs" Inherits="HSRP.EmbossingData.DLChallanNew" %>
                        ...
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td valign="middle" align="center">
                                             ...
                                             <asp:DropDownList Visible="true" ID="ddlemb" CausesValidation="false" Width="140px" 
                                                    runat="server" DataTextField="EmbCenterName" AutoPostBack="true"
                                                    DataValueField="Emb_Center_Id" OnSelectedIndexChanged="ddlemb_SelectedIndexChanged"
                                                       >
                                                </asp:DropDownList>
                                   ...
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()"   align="left">
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                      ...
                                      <td valign="middle" class="form_text" nowrap="nowrap">
                                         <asp:Label Text="Dealer :" runat="server" Visible="false" ID="labelSelectType" /></td>
                                    <td>
                                       

                                        <asp:DropDownList Visible="false" ID="ddlBothDealerHHT" CausesValidation="false" Width="250px"
                                         DataTextField="NAME OF THE DEALER" DataValueField="NAME OF THE DEALER"  
                                            AutoPostBack="false" runat="server" OnSelectedIndexChanged="ddlBothDealerHHT_SelectedIndexChanged">  
                                        </asp:DropDownList>
                                ...
                                <tr>    <td valign="middle" class="form_text" nowrap="nowrap"> 
                                    &nbsp;&nbsp; </td>
                                    <td valign="top" > &nbsp;   <asp:HiddenField ID="hdnfldinvoiceno" runat="server" />  </td>
                                   ...
                                   <asp:Label Text="Lorry No:" runat="server" ID="label6" Font-Size="11pt" 
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                    <asp:Label Text="Location:" Visible="true" runat="server" ID="label1" /> 
                                    </td>
                                    <td valign="middle" align="center">
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                              ...
                              <asp:GridView ID="GridView1" runat="server" BackColor="White" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                   ...
                                   <tr>
                        <td align="center" style="padding-top: 10px" class="auto-style1">
                            <asp:Label ID="LblMessage" runat="server" Text=""></asp:Label>
                            <asp:Button ID="btnChalan" runat="server" ClientIDMode="Static" Text="1. Generate and Download Challan/Invoice" 
                                CssClass="button-success"  Visible="false"  OnClick="btnChalan_Click" OnClientClick="return HideShow();" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
