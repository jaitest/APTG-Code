...
{
    public partial class BiharCollection : System.Web.UI.Page
    {
        ...
        protected void Biharservice()
        {
            try
            {
                ...
                WebReferenceNewBR.SalesRequestWS_Service service = new WebReferenceNewBR.SalesRequestWS_Service();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        Cust = new WebReferenceNewBR.SalesRequestWS();
                        Cust.AddRecordBy = dt.Rows[i]["RTO/DealerLocationType"].ToString();

                        if (dt.Rows[i]["vehicleSubType"].ToString() == "1")
                            Cust.Vehicle_Sub_Type = WebReferenceNewBR.Vehicle_Sub_Type.Two_Wheeler;
                        else if (dt.Rows[i]["vehicleSubType"].ToString() == "2")
                            Cust.Vehicle_Sub_Type = WebReferenceNewBR.Vehicle_Sub_Type.Three_Wheeler;
                        else if (dt.Rows[i]["vehicleSubType"].ToString() == "3")
                            Cust.Vehicle_Sub_Type = WebReferenceNewBR.Vehicle_Sub_Type.Four_Wheeler;
                        else if (dt.Rows[i]["vehicleSubType"].ToString() == "4")
                            Cust.Vehicle_Sub_Type = WebReferenceNewBR.Vehicle_Sub_Type.Tractor;
                        ...
                        if (dt.Rows[i]["ORDERType"].ToString() == "DB")
                            Cust.Order_Type = WebReferenceNewBR.Order_Type.DB;
                        else if (dt.Rows[i]["ORDERType"].ToString() == "OB")
                            Cust.Order_Type = WebReferenceNewBR.Order_Type.OB;
                        else if (dt.Rows[i]["ORDERType"].ToString() == "NB")
                            Cust.Order_Type = WebReferenceNewBR.Order_Type.NB;
                        else if (dt.Rows[i]["ORDERType"].ToString() == "OS")
                            Cust.Order_Type = WebReferenceNewBR.Order_Type.OS;
                        else if (dt.Rows[i]["ORDERType"].ToString() == "DR")
                            Cust.Order_Type = WebReferenceNewBR.Order_Type.DR;
                        else if (dt.Rows[i]["ORDERType"].ToString() == "DF")
                            Cust.Order_Type = WebReferenceNewBR.Order_Type.DF;
                        ...
                        if (dealername == "2")
                        {
                            Cust.RTO_Dealer_Location_Type = WebReferenceNewBR.RTO_Dealer_Location_Type.Dealer;
                        ...
                        {
                            Cust.RTO_Dealer_Location_Type = WebReferenceNewBR.RTO_Dealer_Location_Type.RTO;
                            Cust.Embosssing_Center_Code = dt.Rows[i]["EmbosssingCenterCode"].ToString();
                            Cust.Affixation_Center_Code = dt.Rows[i]["AffixationCenterCode"].ToString();
                        ...
                        if (dt.Rows[i]["VehicleClass"].ToString() == "TRANSPORT")
                            Cust.Vehicle_Class = WebReferenceNewBR.Vehicle_Class.TRANSPORT;
                        else
                            Cust.Vehicle_Class = WebReferenceNewBR.Vehicle_Class.NON_TRANSPORT;
                        ...
                        if (dt.Rows[i]["VehicleType"].ToString() == "LMV")
                            Cust.Vehicle_Type = WebReferenceNewBR.Vehicle_Type.LMV;
                        else if (dt.Rows[i]["VehicleType"].ToString() == "LMV(CLASS)")
                            Cust.Vehicle_Type = WebReferenceNewBR.Vehicle_Type.LMV_CLASS;
                        else if (dt.Rows[i]["VehicleType"].ToString() == "MCV/HCV/TRAILERS")
                            Cust.Vehicle_Type = WebReferenceNewBR.Vehicle_Type.MCV_HCV_TRAILERS;
                        else if (dt.Rows[i]["VehicleType"].ToString() == "MOTOR CYCLE")
                            Cust.Vehicle_Type = WebReferenceNewBR.Vehicle_Type.MOTOR_CYCLE;
                        else if (dt.Rows[i]["VehicleType"].ToString() == "SCOOTER")
                            Cust.Vehicle_Type = WebReferenceNewBR.Vehicle_Type.SCOOTER;
                        else if (dt.Rows[i]["VehicleType"].ToString() == "THREE WHEELER")
                            Cust.Vehicle_Type = WebReferenceNewBR.Vehicle_Type.THREE_WHEELER;
                        else if (dt.Rows[i]["VehicleType"].ToString() == "TRACTOR")
                            Cust.Vehicle_Type = WebReferenceNewBR.Vehicle_Type.TRACTOR;
