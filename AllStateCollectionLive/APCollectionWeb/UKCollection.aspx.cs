...
{
    public partial class UKCollection : System.Web.UI.Page
    {
        ...
        protected void UKservice()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    Cust = new WebReference_UK.SalesRequestWS();

                    Cust.AddRecordBy = dt.Rows[i]["RTO/DealerLocationType"].ToString();

                    if (dt.Rows[i]["vehicleSubType"].ToString() == "1")
                        Cust.Vehicle_Sub_Type = WebReference_UK.Vehicle_Sub_Type.Two_Wheeler;
                    else if (dt.Rows[i]["vehicleSubType"].ToString() == "2")
                        Cust.Vehicle_Sub_Type = WebReference_UK.Vehicle_Sub_Type.Three_Wheeler;
                    else if (dt.Rows[i]["vehicleSubType"].ToString() == "3")
                        Cust.Vehicle_Sub_Type = WebReference_UK.Vehicle_Sub_Type.Four_Wheeler;
                    else if (dt.Rows[i]["vehicleSubType"].ToString() == "4")
                        Cust.Vehicle_Sub_Type = WebReference_UK.Vehicle_Sub_Type.Tractor;
                     else if (dt.Rows[i]["vehicleSubType"].ToString() == "4")
                        Cust.Vehicle_Sub_Type = WebReference_UK.Vehicle_Sub_Type.Tractor;
                    ...
                    if (dt.Rows[i]["ORDERType"].ToString() == "DB")
                        Cust.Order_Type = WebReference_UK.Order_Type.DB;
                    else if (dt.Rows[i]["ORDERType"].ToString() == "OB")
                        Cust.Order_Type = WebReference_UK.Order_Type.OB;
                    else if (dt.Rows[i]["ORDERType"].ToString() == "NB")
                        Cust.Order_Type = WebReference_UK.Order_Type.NB;
                    else if (dt.Rows[i]["ORDERType"].ToString() == "OS")
                        Cust.Order_Type = WebReference_UK.Order_Type.OS;
                    else if (dt.Rows[i]["ORDERType"].ToString() == "DR")
                        Cust.Order_Type = WebReference_UK.Order_Type.DR;
                    else if (dt.Rows[i]["ORDERType"].ToString() == "DF")
                        Cust.Order_Type = WebReference_UK.Order_Type.DF;
                    ...
                    Cust.Responsibility_Center = "UTTR";
                    ...
                    if (dealername == "2")
                    {
                        Cust.RTO_Dealer_Location_Type = WebReference_UK.RTO_Dealer_Location_Type.Dealer;
                    ...
                    {
                        Cust.RTO_Dealer_Location_Type = WebReference_UK.RTO_Dealer_Location_Type.RTO;
                        Cust.Embosssing_Center_Code = dt.Rows[i]["EmbosssingCenterCode"].ToString();
                        Cust.Affixation_Center_Code = dt.Rows[i]["AffixationCenterCode"].ToString();
                    ...
                    if (dt.Rows[i]["VehicleClass"].ToString() == "TRANSPORT")
                        Cust.Vehicle_Class = WebReference_UK.Vehicle_Class.TRANSPORT;
                    else
                        Cust.Vehicle_Class = WebReference_UK.Vehicle_Class.NON_TRANSPORT;
                    ...
                    if (dt.Rows[i]["VehicleType"].ToString() == "LMV")
                        Cust.Vehicle_Type = WebReference_UK.Vehicle_Type.LMV;
                    else if (dt.Rows[i]["VehicleType"].ToString() == "LMV(CLASS)")
                        Cust.Vehicle_Type = WebReference_UK.Vehicle_Type.LMV_CLASS;
                    else if (dt.Rows[i]["VehicleType"].ToString() == "MCV/HCV/TRAILERS")
                        Cust.Vehicle_Type = WebReference_UK.Vehicle_Type.MCV_HCV_TRAILERS;
                    else if (dt.Rows[i]["VehicleType"].ToString() == "MOTOR CYCLE")
                        Cust.Vehicle_Type = WebReference_UK.Vehicle_Type.MOTOR_CYCLE;
                    else if (dt.Rows[i]["VehicleType"].ToString() == "SCOOTER")
                        Cust.Vehicle_Type = WebReference_UK.Vehicle_Type.SCOOTER;
                    else if (dt.Rows[i]["VehicleType"].ToString() == "THREE WHEELER")
                        Cust.Vehicle_Type = WebReference_UK.Vehicle_Type.THREE_WHEELER;
                    else if (dt.Rows[i]["VehicleType"].ToString() == "TRACTOR")
                        Cust.Vehicle_Type = WebReference_UK.Vehicle_Type.TRACTOR;
                    else if (dt.Rows[i]["VehicleType"].ToString() == "E-RICKSHAW")
                        Cust.Vehicle_Type = WebReference_UK.Vehicle_Type.E_RICKSHAW;

                    Cust.Vehicle_TypeSpecified = true;
                    Cust.Zone_Code = dt.Rows[i]["ZoneCode"].ToString();
                    string hid1 = dt.Rows[i]["hsrprecordid"].ToString();
                    ...
                    catch (Exception ex)
                    {
                        ...
                        //utils.ExecNonQuery("update hsrprecords set sendtoerp =NULL where  hsrprecordid ='" + dt.Rows[i]["hsrprecordid"].ToString() + "' and isnull(sendtoerp,'')=1 and hsrp_stateid=6", cnnLocal);
                        continue;
        ...
        {
            string filename = "UKCollection-" + System.DateTime.Now.Day.ToString() + "-" + System.DateTime.Now.Month.ToString() + "-" + System.DateTime.Now.Year.ToString() + ".log";
            ...
            //string pathx = "e:\\ERPHSRPLog\\UKCollection-" + System.DateTime.Now.Day.ToString() + "-" + System.DateTime.Now.Month.ToString() + "-" + System.DateTime.Now.Year.ToString() + ".log";
