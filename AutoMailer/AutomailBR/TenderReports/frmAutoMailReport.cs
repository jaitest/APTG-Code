...
namespace TenderReports
{
    public partial class frmAutoMailReport : Form
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["HSRPBRConnectionString"].ConnectionString);
        ...
        private void GetState()
        {
            try
            {
                ...
                string strState = "select distinct rc.StateID as HSRP_StateID,hs.HSRPStateName as HSRPStateName from tblReportCollection_SP rc join [HSRPState] hs on rc.StateID=hs.HSRP_StateID where rc.StateID=1";
               // string strState = "SELECT distinct [HSRP_StateID],[HSRPStateName] from  [dbo].[HSRPState] order by [HSRPStateName]";
        ...
        private void Export()
        {
            try
            {
                ...
                string SQLStrings = "exec usp_collectionreport_BR";
