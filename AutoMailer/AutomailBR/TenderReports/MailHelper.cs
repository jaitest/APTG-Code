...
namespace SendMail
{
    ...
    public class MailHelper
    {
        ...
        static SqlConnection strcon = new SqlConnection(ConfigurationManager.ConnectionStrings["HSRPBRConnectionString"].ToString());
       ...
       // MailMessage mail = new MailMessage();
        ...
        private static DataTable GetDataInDT()
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand("select * from SendReportEmail where StateID=1", strcon);
        ...
        public static void SendMailMessage(string from, string directoryPath, string strPath)
        {
           ...
           smtp.EnableSsl = true;
            ...
            msg.Subject = "Daily Report BR " + ""+ " Date: " + ss + ".";

            string x = "Dear Sir <br /> <br /> Please Find Attachements Business Reports. <br />  <br /> <br /> <br /> Regard <br /> <br /> IT Support Team";
           // string x = "Dear Sir <br /> <br /> I am Sending You mail of Acumulative Collection and Production till Date Report <br />  <br />  <br />as you get the Attachment the same. <br /> Regard <br />  Please Find the Aattachment.<br /> IT Support Team";
            ...
            //msg.To.Add("testerrtl2016@gmail.com");
            //msg.To.Add("sushil.kumar@hsrpbr.com");
            //msg.To.Add("rajeev.jha@hsrpbr.com");
            //msg.To.Add("rohit.kumar@linkutsav.com");
            //msg.To.Add("kumar.ashutosh@hsrpbr.com");
            //msg.To.Add("poonish.dubey@linkutsav.com");
            //msg.To.Add("info@linkutsav.com");
