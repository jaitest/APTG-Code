       ...
       // MailMessage mail = new MailMessage();
        ...
        private static DataTable GetDataInDT()
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand("select Distinct EmailID,SPName from SendTenderreport where StateID=4 and spName='report_Affixation_FaridabadRTA'", strcon);
        ...
        public static void SendMailMessage(string from, string directoryPath, string strPath)
        {
            ...
            msg.Subject = "HSRP Affixation FaridabadRTA Report " + "" + " Date: " + ss + ".";
