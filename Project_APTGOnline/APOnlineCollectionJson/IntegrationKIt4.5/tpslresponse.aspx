<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tpslresponse.aspx.cs" Inherits="IntegrationKIt4._5.tpslresponse" %>
                ...
                <tr>
                    <td colspan="2" class="maininnertextheading">
                        <h3>Your Payment Order Status is 
                                 <asp:Label ID="LBL_DisplayResult" runat="server" Text="Label"></asp:Label>
    <asp:Label ID="lblResponseDecrypted" runat="server" Text="Label"></asp:Label>
    <asp:Label ID="lblValidate" runat="server" Text="Label"></asp:Label>
