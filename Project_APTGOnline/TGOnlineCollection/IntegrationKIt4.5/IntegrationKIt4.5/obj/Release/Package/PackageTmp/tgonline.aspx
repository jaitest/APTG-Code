<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tgonline.aspx.cs" Inherits="IntegrationKIt4._5.tgonline" %>
    ...
    <form id="TT"  runat="server">
        ...
        <table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
               ...
               <asp:HiddenField ID="hdnRtoLocationCode" runat="server"  /> 
                <asp:HiddenField ID="hdnRtoName" runat="server"  /> 
            ...
            <tr>
                <td colspan="4" class="maininnertextheading">
                    ...
                    <b>5. Customer Care Number :</b><b style="color: #0000FF">9100026696,9100026691,040-69999712/040-69999772/040-69999773</b> <br />
                </td>
