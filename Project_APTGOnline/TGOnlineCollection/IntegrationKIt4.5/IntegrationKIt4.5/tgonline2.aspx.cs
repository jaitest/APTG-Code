...
{
    public partial class tgonline2 : System.Web.UI.Page
    {
        ...
        {
            string strQuery = "Update TGOnlinePayment set BtnInitiatedFrom='ICICI',[PaymentMobile]='" + Request.Form["txtMobileNo"].ToString() + "',[PaymentEmail]='" + Request.Form["txtEmail"].ToString() + "' where [OnlinePaymentID]='" + Request.Form["order_id"].ToString() + "'";
