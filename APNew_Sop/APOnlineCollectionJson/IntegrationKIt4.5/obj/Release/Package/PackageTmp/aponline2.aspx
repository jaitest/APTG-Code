<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aponline2.aspx.cs" Inherits="IntegrationKIt4._5.aponline2" %>
        ...
        <table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="maininnertextheading">
                    ...
                    <input type="hidden" name="merchant_id" id="merchant_id" value="81609" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" class="maininnertextheading">
                    ...
                    <input type="hidden" name="redirect_url" value="https://hsrpap.com/hsrponline/ccavResponseHandler.aspx" />
                    <input type="hidden" name="cancel_url" value="https://hsrpap.com/hsrponline/PaymentTransactionFaliure.aspx" />
                    ...
                    <input type="Hidden" name="billing_state" id="billing_state" runat="server" value="AP" />
...
<input type="hidden" id="txtLAPLReturnurl" name="txtLAPLReturnurl" value="https://hsrpap.com/hsrponline/LAPLResponseHandler.aspx" runat="server" />
                  ...
                  <img src="../images/new.gif"/>  <input type="button" value="Pay Direct-LAPL" class="btnLAPL" onclick="javascript: return ValidateLAPLForm();" /><br />
                    ...
                    <br />
                  <br />   <asp:Button ID="payICICI" runat="server" Text="ICICI Corporate Banking" class="btnICICI" OnClick="payICICI_Click"/>
                </td>
            </tr>
             </table>
              </form>
...
<INPUT type="hidden" name="PID" id="PID" value="000000004658">
<INPUT type="hidden" name="ITC" id="ITC"  runat="server">
<INPUT type="hidden" name="PRN" id="PRN"  runat="server">
<INPUT type="hidden" name="RU" value="https://www.hsrpap.com/hsrponline/axisresponse.aspx">
...
<INPUT  name="pay" type="submit" value="Axis i-Connect" class="btnAxis" onclick="javascript: return ValidateFormAxis();">
    ...
    <FORM action="https://corporate.hdfcbank.com/CTPRoute.html" method="get" style="margin-left: 51px">
	 <input type="Hidden" name="ClientCode"	 id="ClientCode"	value="APHSRP" runat="server"/>
<input type="Hidden" name="MerchantCode" id="MerchantCode" value="APHSRP" runat="server"/>
...
<!--<INPUT  name="pay" type="submit" value="HDFC Corporate Banking" class="btnHDFC">-->
</FORM>
                    </td>
                </tr> 
