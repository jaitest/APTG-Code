       ...
       // MailMessage mail = new MailMessage();
        ...
        private static DataTable GetDataInDT()
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand("select Distinct Report_Name,EmailID from SendTenderreport a, TenderReport_SP b where a.StateID=b.StateID and spName=sp_name and a.StateID=4 and SP_Name='usp_Authority_C_Report'", strcon);
        ...
        public static void SendMailMessage(string from, string directoryPath, string strPath)
        {
            ...
            msg.Subject = "Schedule C HREmbossing Tender Report " + "" + " Date: " + ss + ".";
