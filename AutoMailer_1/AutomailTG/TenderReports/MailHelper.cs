...
namespace SendMail
{
    ...
    public class MailHelper
    {
       ...
       // MailMessage mail = new MailMessage();
        static SqlConnection strcon = new SqlConnection(ConfigurationManager.ConnectionStrings["hsrpAPConfiguration"].ToString());
        ...
        private static DataTable GetDataInDT()
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand("select * from SendReportEmail where StateID=11", strcon);
        ...
        public static void SendMailMessage(string from, string directoryPath, string strPath)
        {
           ...
           smtp.EnableSsl = true;
            ...
            msg.Subject = "Daily Report TG " + ""+ " Date: " + ss + ".";
