...
namespace SendMail
{
    ...
    {
        static SqlConnection strcon = new SqlConnection(ConfigurationManager.ConnectionStrings["HSRPUKConnectionString"].ToString());
        /// <summary>
       ...
       // MailMessage mail = new MailMessage();
        ...
        private static DataTable GetDataInDT()
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand("select * from SendReportEmail where StateID=6", strcon);
        ...
        public static void SendMailMessage(string from, string directoryPath, string strPath)
        {
           ...
           smtp.EnableSsl = true;
            ...
            msg.Subject = "Daily Report UK " + ""+ " Date: " + ss + ".";
           ...
           // string x = "Dear Sir <br /> <br /> I am Sending You mail of Acumulative Collection and Production till Date Report <br />  <br />  <br />as you get the Attachment the same. <br /> Regard <br />  Please Find the Aattachment.<br /> IT Support Team";
            ...
            //msg.To.Add("ankit.tyagi@hsrpuk.com");
            //msg.To.Add("sanjeev.kumar@hsrpuk.com");
            //msg.To.Add("mahabeer.singh@hsrpuk.com");
            //msg.To.Add("hsrpuk@gmail.com");
