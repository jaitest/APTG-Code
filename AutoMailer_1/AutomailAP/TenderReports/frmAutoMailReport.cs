...
namespace TenderReports
{
    public partial class frmAutoMailReport : Form
    {
        ...
        private void GetState()
        {
            try
            {
               // string strState = "SELECT distinct [HSRP_StateID],[HSRPStateName] from  [dbo].[HSRPState] order by [HSRPStateName]";
                string strState = "select distinct rc.StateID as HSRP_StateID,hs.HSRPStateName as HSRPStateName from tblReportCollection_SP rc join [HSRPState] hs on rc.StateID=hs.HSRP_StateID where rc.StateID=9";
        ...
        public void timer1_Tick(object sender, EventArgs e)
        {
            ...
            string strTime1 = "08:00 AM";
            // string strTime1 = "10:53 AM"; 
