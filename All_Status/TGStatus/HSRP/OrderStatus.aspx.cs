    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
      ...
      DataTable ds = new DataTable();
        ...
        protected void ButtonGo_Click(object sender, EventArgs e)
        {
            ...
            if (strCheck != "TS" && strCheck != "ts" && strCheck != "AP" && strCheck != "ap")
            {
        ...
        private void Fill()
        {
            ...
            "ContactPersonName,MobileNo,EmailID,Rtocode From RTOLocation where HSRP_StateID=11 and LocationType='Sub-Urban' and rtocode is not null  and rtolocationname not in ('MAYAPURI','D Surajmal Vihar')";
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect(String.Format("http://103.241.136.136/hsrp/login.aspx"));                
            }
            catch(Exception ee)
            {
            }
