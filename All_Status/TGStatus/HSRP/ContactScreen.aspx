                                                                ...
                                                                <tr>
                                                                    <td valign="top">
                                                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td>
                                                                                  <table width="100%" border="0" cellpadding="3" cellspacing="2" style="border:1px black solid;">
                                                                                  <tr>
                                                                                    <td class="hrtcname">Registered Office:</td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                    <td nowrap="nowrap" class="maininnertext"><strong>Link Autotech Pvt. Ltd. </strong></td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                    <td class="maininnertext"><strong>C-61, Maya Puri, Industrial Area Phase - II, Maya Puri</strong></td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                    <td nowrap="nowrap" class="maininnertext"><strong>New Delhi 110064 INDIA </strong></td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                    <td nowrap="nowrap" class="maininnertext"><strong>Contact No.:- 040- 69999772</strong></td>
                                                                                  </tr>
                                                                                  </table>
