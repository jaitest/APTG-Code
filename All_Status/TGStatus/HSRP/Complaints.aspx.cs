       ...
       // string SQLString = String.Empty;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string strSel = "select RIGHT('0000000'+CAST(ISNULL(count(complaintno),0) AS VARCHAR),7) from complaint where stateid=11 and complaintno like 'TS-%' and convert(date,complaintdate)=convert(date,'"+System.DateTime.Now.ToShortDateString()+"')";
