...
namespace HSRP
{
    public partial class ViewOrderStatus : System.Web.UI.Page
    {
        ...
        public void Search()
        {
            ...
            {
                GetHostAddress();
                SQLString = "SELECT Top(1)  REPLACE(REPLACE(REPLACE([VehicleRegNo],' ',''),'-',''),'/','') as [VehicleRegNo],[OrderStatus],Rtolocationid,ordercloseddate FROM hsrprecords where HSRP_StateID=11 and [VehicleRegNo] ='" + vehicalRegNo + "'";
                ...
                else
                {
                    ...
                    //SQLString = "SELECT Top(1)  * FROM [dbo].[HSRPRecordsStaggingArea] where HSRP_StateID=11 and [VehicleRegNo] ='" + vehicalRegNo.Replace(" ", "") + "'";
                    ...
                    //}
                    SQLString = " SELECT Top(1) * FROM [rtolocation] where HSRP_StateID=11 and  RTOLOCATIONCODE = '" + vehicalRegNo.Substring(0, 4) + "'";
        ...
        private void Fill()
        {
            ...
            "ContactPersonName,MobileNo,EmailID,Rtocode From RTOLocation where HSRP_StateID=11 and LocationType='Sub-Urban' and rtocode is not null";
        ...
        {
            SQLString = "select RTOLocationName,LandlineNo,RTOLocationCode,rtocode,RTOLocationAddress,ContactPersonName,MobileNo,EmailID from RTOLocation where RTOLocationid='" + strRtolocationid + "' and HSRP_StateID=11";
