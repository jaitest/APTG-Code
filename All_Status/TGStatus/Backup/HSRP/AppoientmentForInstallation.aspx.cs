...
namespace HSRP
{
    public partial class AppoientmentForInstallation : System.Web.UI.Page
    {
       ...
       // string SQLString = String.Empty;
        ...
        {
            RtoLocation = "select rtolocationid,upper(RTOLocationName) as RTOLocationName from rtolocation where hsrp_stateid=11 and ActiveStatus='y' order by rtolocationname";
