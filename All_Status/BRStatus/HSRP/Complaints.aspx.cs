       ...
       // string SQLString = String.Empty;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string strSel = "select right(isnull(max(complaintno),0000000),7) from complaint where stateid=1";
                ...
                {
                    strComNo = "BR-" + string.Format("{0:0000000}", Convert.ToInt32(strCom) + 1);
                }
        ...
        private void GenerateIdsAndSendMail(string strCompNo)
        {
            ...
            lst.Add("rajeev0372@gmail.com");
            string EmailSubject = "BR Complain";
