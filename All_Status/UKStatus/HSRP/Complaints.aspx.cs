       ...
       // string SQLString = String.Empty;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string strSel = "select right(isnull(max(complaintno),0000000),7) from complaint where ComplaintNo like '%uk%'";
                ...
                {
                    strComNo = "UK-" + string.Format("{0:0000000}", Convert.ToInt32(strCom) + 1);
                }
        ...
        private void GenerateIdsAndSendMail(string strCompNo)
        {
          ...
          //// ukhead// lst.Add("utsavrakesh@gmail.com");
          ...
          //  lst.Add("maheshmmalhotra@gmail.com");
            ...
            string EmailSubject = "UK Complaint";
