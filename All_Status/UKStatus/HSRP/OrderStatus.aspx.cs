    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
      ...
      DataTable ds = new DataTable();
        ...
        private void Fill()
        {
            ...
            "ContactPersonName,MobileNo,EmailID,Rtocode From RTOLocation where HSRP_StateID=6 and LocationType='Sub-Urban' and rtocode is not null  and rtolocationname not in ('MAYAPURI','D Surajmal Vihar')";
