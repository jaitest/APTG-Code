...
namespace HSRP
{
    public partial class AppoientmentForInstallation : System.Web.UI.Page
    {
       ...
       // string SQLString = String.Empty;
        ...
        {
            RtoLocation = "select rtolocationid,upper(RTOLocationName) as RTOLocationName from rtolocation where hsrp_stateid=6 and ActiveStatus='y' order by rtolocationname";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string stateid = "6";
                    string strQuery = "insert into AppointmentForInstallation_UK(HSRP_StateId, RTOLocationId, VehicleRegNo, Address, VehicleType,ChassisNo,EngineNo,CashReceiptNo,Email,MobileNo)" +
