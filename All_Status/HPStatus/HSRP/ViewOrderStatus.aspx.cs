    ...
    public partial class ViewOrderStatus : System.Web.UI.Page
    {
        ...
        public void Search()
        {
            ...
            try
            {
                ...
                {
                    GetHostAddress();
                    SQLString = "SELECT Top(1)  REPLACE(REPLACE(REPLACE([VehicleRegNo],' ',''),'-',''),'/','') as [VehicleRegNo],[OrderStatus],Rtolocationid,ordercloseddate FROM hsrprecords where HSRP_StateID=3 and [VehicleRegNo] ='" + vehicalRegNo + "'";
        ...
        private void Fill()
        {
            ...
            "ContactPersonName,MobileNo,EmailID,Rtocode From RTOLocation where HSRP_StateID=3 and LocationType='Sub-Urban' and rtocode is not null";
        ...
        {
            SQLString = "select RTOLocationName,LandlineNo,RTOLocationCode,rtocode,RTOLocationAddress,ContactPersonName,MobileNo,EmailID from RTOLocation where RTOLocationid='" + strRtolocationid + "' and HSRP_StateID=3 ";
