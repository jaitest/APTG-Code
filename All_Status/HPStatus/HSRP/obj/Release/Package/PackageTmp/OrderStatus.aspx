                                                                                        ...
                                                                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                                ...
                                                                                                <%--<asp:LinkButton ID="lnkComplaint" runat="server" CausesValidation="False"
                                                                                                    ...
                                                                                                    Font-Bold="False" Enabled="False" Visible="False">Complaint</asp:LinkButton>--%>
                                                                                                    </span>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td valign="top">
                                                                                                                            <table width="510" border="0" align="right" cellpadding="3" cellspacing="3">
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td nowrap="nowrap" class="headingmain">
                                                                                                                                        ...
                                                                                                                                        <div id="t2" runat="server">
                                                                                                                                            User Name :
                                                                                                                                            <asp:TextBox ID="txtUserName" runat="server" Width="111px"></asp:TextBox>
                                                                                                                                            <br />
                                                                                                                                            Password :&nbsp;&nbsp; 
                                                                                                                                            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="110px"></asp:TextBox>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="ButtonGo" runat="server" Text="Search" OnClick="ButtonGo_Click"
                                                                                                                                        CssClass="button_h" />
                                                                                                                                    </td>
                                                                                                                                    <td>&nbsp;
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top">
                                                                                                                        <table width="510" border="0" align="right" cellpadding="3" cellspacing="3">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td nowrap="nowrap" class="headingmain" align="right" valign="bottom">
                                                                                                                                    &nbsp;
                                                                                                                                    Ex : </td>
                                                                                                                                <td nowrap="nowrap" class="headingmain">
                                                                                                                                    <label for="test">
                                                                                                                                    </label>
                                                                                                                                    <input id="TextBoxfirsttwo" runat="server" style="text-transform: uppercase; width: 43px;"
                                                                                                                                        maxlength="2" name="test" value="HP" autocomplete="off" onkeyup="autotab(this,document.form1.TextBoxsecondtwo)" type="text" 
                                                                                                                                        class="form_textboxn" />
                                                                                                                                         &nbsp;
                                                                                                                                         <input id="TextBoxsecondtwo" runat="server" style="text-transform: uppercase;width: 30px;"
                                                                                                                                        maxlength="2" width="10px" name="test" autocomplete="off" onkeyup="autotab(this,document.form1.TextBoxthirdtwo)" type="text" class="form_textboxn" />
                                                                                                                                        &nbsp;
                                                                                                                                        <input id="TextBoxthirdtwo" runat="server" style="text-transform: uppercase;width: 30px;"
                                                                                                                                        maxlength="2" name="test" autocomplete="off" onkeyup="autotab(this,document.form1.TextBoxlastfour)" type="text" class="form_textboxn" />
                                                                                                                                        &nbsp;
                                                                                                                                        <input id="TextBoxlastfour" runat="server" style="text-transform: uppercase;width: 60px;"
                                                                                                                                        maxlength="4" name="test" autocomplete="off" onkeyup="autotab(this,document.form1.ButtonGo)" type="text" class="form_textboxn" />
                                                                                                                                    <br />
                                                                                                                                    HP&nbsp;&nbsp;&nbsp;&nbsp; 39&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; A&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1690
                                                                                                                                </td>
                                                                                                                            </tr>
