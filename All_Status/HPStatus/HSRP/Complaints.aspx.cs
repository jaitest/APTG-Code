       ...
       // string SQLString = String.Empty;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               string strSel = "select right(isnull(max(complaintno),0000000),7) from complaint where stateid=3";
                ...
                {
                    strComNo = "HP-" + string.Format("{0:0000000}", Convert.ToInt32(strCom) + 1);
                }
                ...
                string strQuery = "INSERT INTO [dbo].[Complaint] ([Region],ComplaintNo,[StateId],[OwnerName]" +
                        ...
                        "','" + txtRemarks.Text + "','" + txtMobile.Text + "','" + txtMail.Text + "','" +
        ...
        private void GenerateIdsAndSendMail(string strCompNo)
        {
            ...
            lst.Add("hsrpuk@gmail.com");
            string EmailSubject = "HP Complain";
