...
namespace DataProvider
{
    public class BAL
    {
       ...
       string StringRearPlatePrize, string StringStickerPrize, string StringScrewPrize, ref int isexists)
        ...
        //public bool InsertHSRPMessageNote(string MessageText, string UserID, string HSRP_StateID, string RTOLocationID, DateTime CreatedDateTime, ref int ISExists)
        //{
        //    using (SqlConnection con = new SqlConnection(ConnectionString))
        //    {
        //        SqlCommand cmd = new SqlCommand("[Master_InsertMessageNote]", con);
        //        cmd.CommandType = CommandType.StoredProcedure;

        //        cmd.Parameters.Add(new SqlParameter("@MessageText", MessageText.ToString()));
        //        cmd.Parameters.Add(new SqlParameter("@UserID",UserID.ToString()));
        //        cmd.Parameters.Add(new SqlParameter("@HSRP_StateID", HSRP_StateID.ToString()));
        //        cmd.Parameters.Add(new SqlParameter("@RTOLocationID", RTOLocationID.ToString()));
        //        cmd.Parameters.Add(new SqlParameter("@CreatedDateTime", CreatedDateTime));
        //        //cmd.Parameters.Add(new SqlParameter("@ActiveStatus", ActiveStatus));
        //        SqlParameter isexists = new SqlParameter("@ISExists", SqlDbType.Int);
        //        isexists.Direction = ParameterDirection.Output;
