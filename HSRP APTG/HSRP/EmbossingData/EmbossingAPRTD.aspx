<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EmbossingAPRTD.aspx.cs" Inherits="HSRP.EmbossingData.EmbossingAPRTD" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                   ...
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()"   align="left">
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        ...
                                        <asp:Button ID="btnGO"  Width="58px"  runat="server" 
                                            ...
                                            class="button"  OnClientClick=" return validate()"  BackColor="Orange" ForeColor="#000000"
                                            onclick="btnGO_Click"  /> &nbsp;&nbsp;&nbsp;  
                    ...
                    <tr>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtFLaserCode" runat="server" Text='<%#Eval("hsrp_front_lasercode") %>' ReadOnly="true"></asp:TextBox>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtRlaserCode" runat="server" Text='<%#Eval("hsrp_rear_lasercode") %>' ReadOnly="true"></asp:TextBox>
                        ...
                        <td align="center" style="padding-top: 10px">
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="Mark Embossing Done" CssClass="button" Visible="false"
