...
{
    public partial class ReprintChalan : System.Web.UI.Page
    {
        ...
        protected void btnChalan_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (true)
                {
                    ...
                    GenerateCell(table, 4, 0, 1, 0, 0, 0, 1, "Date", 0, 0);
                    ...
                    if (HSRPStateID == "9")
                    {
                        GenerateCell(table, 3, 0, 1, 0, 0, 1, 1, strInvoiceNo + "\r\n\r\n" + "Way Bill No" + "\r\n" + waybillno, 0, 0);
                        //GenerateCell(table, 3, 0, 1, 0, 0, 1, 0, "Way Bill No" , 0, 0);
                        //GenerateCell(table, 3, 0, 1, 0, 0, 1, 1, waybillno, 0, 0);
                    }
                    ...
                    if (!strEmbStationName.Equals("Chintal"))
                    {
                        GenerateCell(table, 3, 1, 1, 0, 0, 0, 1, strEmbStationName + "," + strEmbAddress, 20, 0);
                    }
                    else
                    {
                        GenerateCell(table, 3, 1, 1, 0, 0, 0, 1, strEmbStationName + "," + strEmbAddress, 20, 0);
                    ...
                    GenerateCell(table, 1, 1, 0, 1, 0, 1, 0, "S.No.", 0, 0);
                    ...
                    GenerateCell(table, 1, 1, 1, 0, 0, 1, 1, "", 0, 0);
                    GenerateCell(table, 1, 0, 1, 0, 0, 1, 1, "", 0, 0);
                    GenerateCell(table, 1, 0, 1, 1, 0, 2, 1, "", 0, 0);
                    ...
                    GenerateCell(table, 5, 1, 0, 0, 0, 0, 0, "Net Weight + Packing Weight = Gross Weight(in grams)", 0, 0);
                    GenerateCell(table, 4, 0, 0, 0, 0, 0, 1, TotalWeight.ToString() + "+" + pckweight + "=" + (Convert.ToInt32(TotalWeight.ToString()) + Convert.ToInt32(pckweight)).ToString(), 0, 0);
                    GenerateCell(table, 1, 1, 1, 1, 0, 0, 1, "", 0, 0);
                    #endregion
