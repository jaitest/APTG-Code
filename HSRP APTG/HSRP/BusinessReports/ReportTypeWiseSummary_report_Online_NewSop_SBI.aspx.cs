...
namespace HSRP.BusinessReports
{
    public partial class ReportTypeWiseSummary_report_Online_NewSop_SBI : System.Web.UI.Page
    {
        ...
        {
            ///string sqlstring = "[Business_ReportTypewisesummary_report_NewSop] '" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','DB','11','0','0','0' ";
            string sqlstring = "[Business_ReportTypewisesummary_report_AP_NewSOP_SBI] '" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','DB'";
            dt11 = new DataTable();
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                book.Properties.Title = "APTG Report Online Report";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    WorksheetCell cell = row.Cells.Add("APTG Report Online Report");
