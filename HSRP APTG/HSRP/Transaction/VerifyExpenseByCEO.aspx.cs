...
{
    public partial class VerifyExpenseByCEO : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "ByPass")
            {
                try
                {
                    ...
                    SQLString = "UPDATE ExpenseSave SET CEOExpenseStatus='Approve',VerifiedByCEO='" + UserID + "' ,VerifiedAmountByCEO=VerifiedAmount ,VerifiedRemarksByCEO='ByPassAmount' , VerifiedByDateCEO=getdate(),Remarks='OH Amount ByPass'  where ExpenseSaveID='" + Expenseid + "'";
        ...
        protected void btnReject(object sender, EventArgs e)
        {
            ...
            if (TransactionID != "")
            {
                ...
                string sqlquery1 = "update ExpenseSave set CEOExpenseStatus='Rejected' , VerifiedByCEO='" + Session["UID"].ToString() + "' , VerifiedByDateCEO=getdate(),VerifiedRemarksByCEO='" + txtRemarks.Text + "' where ExpenseSaveID='" + TransactionID + "'";
