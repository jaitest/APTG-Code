<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankTransactionUpdate_old.aspx.cs"
    Inherits="HSRP.Master.BankTransactionUpdate" %>
        ...
        <fieldset>
            ...
            <table  border="0" align="right"  style="height: 348px; width:85%;">
               <tr>
                ...
                <tr>
                    <td class="style4">
                       <asp:Label ID="lblapprovestatus" runat="server" Text="Approve Status"></asp:Label>
                            
                    </td>
                    <td>                  
                        <asp:TextBox ID="txtapprovestatus" class="form_textbox12" runat="server" 
                            MaxLength="30" TabIndex="15" ></asp:TextBox>
                    </td>
                </tr>

               <%-- <tr>
                    <td class="style4">
                        Entry Date <span class="alert">* </span>
                    </td>
                    <td>
                        <table id="Table2" runat="server" style="margin-left: 8px;" align="left" cellspacing="0"
                            cellpadding="0" border="0">
                            <tr>
                                <td valign="top" onmouseup="DepositDate_OnMouseUp()">
                                    <ComponentArt:Calendar ID="Calendar2" runat="server" PickerFormat="Custom" 
                                        PickerCustomFormat="dd/MM/yyyy"  TabIndex="1"
                                        ControlType="Picker" PickerCssClass="picker" Visible="true" >
                                        <ClientEvents>
                                            <SelectionChanged EventHandler="DepositDate_OnDateChange" />
                ...
                <%--<tr>
                    <td class="style4">
                       <asp:Label ID="lblvoid" runat="server" Text="VoidStatus"></asp:Label>
                            
                    </td>
                    <td>                  
                        <asp:TextBox ID="txtvoid" class="form_textbox12" runat="server" 
           ...
           <table>
             <tr>
                  ...
                  <td>  <ComponentArt:Calendar runat="server" ID="CalendarDepositDate1" AllowMultipleSelection="false"
                            AllowWeekSelection="false" AllowMonthSelection="false" ControlType="Calendar"
