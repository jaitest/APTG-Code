...
namespace HSRP.Master
{
    public partial class LaserQuickClosed : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //txtClosedDate_CalendarExtender.StartDate = DateTime.Now;
            //txtClosedDate_CalendarExtender.SelectedDate = DateTime.Now.Date;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        SelectDate = Convert.ToDateTime(txtClosedDate.Text);
                    }
                    else
                    {
                        lblErrMess.Text = "Please Select Date";
                        return;
                    }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (Exists != "0")
                                {
                                    ...
                                    {
                                        SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and orderstatus = 'Embossing Done' and RecievedAffixationStatus='Y' and HSRPRecord_CreationDate >= '2015-01-01' ";
                                        hsrpid = Utils.getDataSingleValue(SQLString, CnnString, "hsrprecordid");
                                        if (hsrpid == "0")
                                        {
                                            lblErrMess.Text = "Plate not recieved at center please make entry in software of plate recieveing first.";
                                            return;
                                        }
                                    }
                                    else
            ...
            {
                lblErrMess.Text = "Please select Vehicle No";
                throw ex;
            }
        }
        ...
        protected void btnGO_Click(object sender, EventArgs e)
        {
            ...
            //SQLStringall = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus in('New Order','Embossing Done')";
            ...
            #region haryana
            if (HSRPStateID == "4" || HSRPStateID == "3" || HSRPStateID == "1" || HSRPStateID == "6")
            {
                SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus ='Embossing Done' and RecievedAffixationStatus='Y' and recievedatAffixationDatetime is not null";
                DataTable dtcount1 = Utils.GetDataTable(SQLString.ToString(), CnnString);
                if (dtcount1.Rows.Count > 0)
                {
                    OrderClosedfun(dtcount1);
                    btnDownloadInvoice.Visible = false;
                    btnSave.Visible = true;
                    lblFrontLaserPlate.Visible = true;
                    lblRearLaserPlate.Visible = true;
                    lbltestfront.Visible = true;
                    lbltestrear.Visible = true;
                }
                else
                {
                    SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus ='Embossing Done' and RecievedAffixationStatus='N' and isnull(recievedatAffixationDatetime,'')!=''";
                    DataTable dtcount123 = Utils.GetDataTable(SQLString.ToString(), CnnString);
                    if (dtcount123.Rows.Count > 0)
                    {
                        lblErrMess.Text = "Please do stock inward entry";
                        lblSucMess.Visible = false;
                        lblClosedDate.Visible = false;
                        txtClosedDate.Visible = false;
                        lbltestrear.Visible = false;
                        lbltestfront.Visible = false;
                        btnSave.Visible = false;
                        return;
                    }
                    SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus ='Embossing Done' and RecievedAffixationStatus='N' and isnull(recievedatAffixationDatetime,'')=''";
                    DataTable dtcount1234 = Utils.GetDataTable(SQLString.ToString(), CnnString);
                    if (dtcount1234.Rows.Count > 0)
                    {
                        lblErrMess.Text = "Please do stock inward entry";
                        lblSucMess.Visible = false;
                        btnSave.Visible = false;
                    ...
                    else
                    {
                        ...
                        if (dtcount2.Rows.Count > 0)
                        {
                            ...
                            lblErrMess.Text = "Embossing entry not done";
                            lblSucMess.Visible = false;
                            btnAssignLaser.Visible = false;
                            lblFrontLaserPlate.Visible = false;
                            lblRearLaserPlate.Visible = false;
                            lblClosedDate.Visible = false;
                            txtClosedDate.Visible = false;
                            btnSave.Visible = false;
                            lbltestrear.Visible = false;
            ...
            else if(HSRPStateID == "5")
            {
                ...
                {
                    // SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus='New Order' and HSRP_Front_LaserCode  is not null and HSRP_Rear_LaserCode is not null";
                    //SQLString = "select VehicleRegNo,hsrp_stateid,case when convert(date,orderdate) > '2014-04-23' then 'Y' else 'N' End as 'Status' from hsrprecords  where hsrp_stateid='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text + "'AND orderstatus='New Order' and HSRP_Front_LaserCode  is not null and HSRP_Rear_LaserCode is not null";
                }

                else if (HSRPStateID == "3")
                {
                    // SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus='New Order' and HSRP_Front_LaserCode  is not null and HSRP_Rear_LaserCode is not null";
                    // SQLString = "select VehicleRegNo,hsrp_stateid,case when convert(date,orderdate) > '2014-04-23' then 'Y' else 'N' End as 'Status' from hsrprecords  where hsrp_stateid='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text + "'AND orderstatus='New Order' and HSRP_Front_LaserCode  is not null and HSRP_Rear_LaserCode is not null";
                }
                ...
                {
                    //SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus='New Order' and HSRP_Front_LaserCode  is not null and HSRP_Rear_LaserCode is not null";
                    //SQLString = "select hsrpRecordID,hsrp_stateid,hsrp_Front_Lasercode,hsrp_rear_Lasercode,OrderStatus,case when Remarks='ERP' then 'Y' else 'N' end as [Status]  from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus='New Order' and HSRP_Front_LaserCode  is not null and HSRP_Rear_LaserCode is not null";
                }

                else
                {
                    SQLString = "select VehicleRegNo,hsrp_stateid from hsrprecords where  HSRP_STATEID='" + HSRPStateID + "' AND  VehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus='New Order' and HSRP_Front_LaserCode  is not null and HSRP_Rear_LaserCode is not null";
                }
                ...
                if (dtRecords5.Rows.Count > 0)
                {
                    ...
                    if (dtRecords5.Rows[0]["hsrp_stateid"].ToString().Equals("1") && dtRecords5.Rows[0]["Status"].ToString().Equals("Y") || dtRecords5.Rows[0]["hsrp_stateid"].ToString().Equals("5") || dtRecords5.Rows[0]["hsrp_stateid"].ToString().Equals("6"))
                    {
                        ...
                        SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,OrderStatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and OrderStatus in ('New Order','Embossing Done','Closed')";
