<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerifyAmountByCEO.aspx.cs" Inherits="HSRP.Transaction.VerifyAmountByCEO" %>
                    ...
                    <td></td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtVerifyAmount" runat="server" onkeyup="checkDec(this);"></asp:TextBox>
