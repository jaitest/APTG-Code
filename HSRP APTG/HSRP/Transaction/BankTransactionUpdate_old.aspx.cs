    ...
    public partial class BankTransactionUpdate : System.Web.UI.Page
    {
        ...
        private void EditBankTransaction(string TransactionID)
        {
            SQLString = "SELECT [TransactionID],[DepositDate],[BankName],[BranchName],[DepositAmount],[DepositBy],[StateID],[RTOLocation],[UserID],[CurrentDate],[BankSlipNo],[Remarks],[AccountNo],[ETAProcess],[depositelocationid],[EntryType],[oldTransactionID],[EntryDate],[DealerID],[chq_no],[chq_date],[ApprovedStatus],[VoidStatus] FROM [BankTransaction] where TransactionID=" + TransactionID;
                   ...
                   // txtBankName.Text = ds.Rows[0]["BankName"].ToString();
                    ...
                    //txtvoid.Text = ds.Rows[0]["oldTransactionID"].ToString();
                    ...
                    txtapprovestatus.Text = ds.Rows[0]["ApprovedStatus"].ToString();
                    //txtvoid.Text = ds.Rows[0]["VoidStatus"].ToString();
        ...
        protected void buttonUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String[] StringOrderDate1 = DepositDate1.SelectedDate.ToString().Split('/');
                String entryFrom = StringOrderDate1[0] + "/" + StringOrderDate1[1] + "/" + StringOrderDate1[2].Split(' ')[0];
                OrderDate2 = new DateTime(Convert.ToInt32(StringOrderDate1[2].Split(' ')[0]), Convert.ToInt32(StringOrderDate1[0]), Convert.ToInt32(StringOrderDate1[1]));
                ...
                if (int.Parse(TextBoxDepositAmount.Text) >= 1)
                {
                    ...
                    //lst.Add(txtetaprocess.Text.ToString());
                   // lst.Add(txtentrytype.Text.ToString());
                    lst.Add(txtoldtrnid.Text.ToString());
                    lst.Add(OrderDate2.ToString()); 
                   // lst.Add(txtdealer.Text.ToString());
                   // lst.Add(txtchqno.Text.ToString());                   
                    lst.Add(txtapprovestatus.Text.ToString());
                   // lst.Add(txtvoid.Text);
