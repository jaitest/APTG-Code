               ...
               if (StrTransactonType2 == "DF" || StrTransactonType2 == "DR")
                ...
                if (ddlVehicleClass.Text == "NON-TRANSPORT")
                {
                    ...
                    if (StrNICVehicleType == "Motor Cycle/Scooter(2WN)" || StrNICVehicleType == "M-Cycle/Scooter(2WN)")
                    {
                        // FillVehicleType();
                        ddlVehicleType.Visible = true;
                        if (ddlVehicleType.SelectedItem.ToString() != "")
                        {
                            if (ddlVehicleType.SelectedItem.ToString() == "--Select Vehicle Type--")
                            {
                                lblErrMess.Visible = true;
                                lblErrMess.Text = "";
                            ...
                            {
                                VehicleType = ddlVehicleType.SelectedItem.ToString();
                            }
                        }
                    ...
                    string sql = "exec [getPlatesData] '" + HSRPStateID + "','" + VehicleType + "','" + ddlVehicleClass.SelectedItem.ToString() + "', '" + lblTransactionType.Text + "'";
