                   ...
                   // getDataQry = "SELECT b.NICVehicleRegNo,b.ChassisNo,b.EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount, replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN HSRPRecordsStaggingArea b ON a.VehicleRegNo = b.VehicleRegNo where a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null and  b.filename = '" + dropDownListFilenameforlocation.SelectedItem.Text + "'";
                    if (Session["UserHSRPStateID"].ToString() == "2" || Session["UserHSRPStateID"].ToString() == "4" || Session["UserHSRPStateID"].ToString() == "1")
                    {
                       ...
                       
                        {
                            ...
                            //getDataQry = "SELECT b.NICVehicleRegNo,b.ChassisNo,b.EngineNo,b.OrderType,b.nicvehicletype+'*NOT AVAILABLE*NOT AVAILABLE',b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount, replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN HSRPRecordsStaggingArea b ON a.VehicleRegNo = b.VehicleRegNo where a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null and  b.filename = '" + dropDownListFilenameforlocation.SelectedItem.Text + "'";
                            //getDataQry = "SELECT  case when len(b.nicvehicleRegNo)<=9 then left(b.NicVehicleRegNo,5)+' '+(right(b.nicvehicleRegNo,4)) else b.nicvehicleRegNo end as nicvehicleRegNo,replace(b.ChassisNo,'*','') as chassisNo,b.EngineNo,b.OrderType,case when len(b.nicvehicletype)<=10 then '*NOT AVAILABLE*NOT AVAILABLE' else b.nicvehicletype end,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount, replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN HSRPRecordsStaggingArea b ON a.VehicleRegNo = b.VehicleRegNo and a.rtolocationid=b.RTOLocationID where a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null and a.rtolocationID='138' and a.hsrp_StateID='2'";
                            //remove cashreceiptdatetime colum for delhi only
                            //  getDataQry = "SELECT  case when len(b.nicvehicleRegNo)<=9 then left(b.NicVehicleRegNo,5)+' '+(right(b.nicvehicleRegNo,4)) else b.nicvehicleRegNo end as nicvehicleRegNo,replace(b.ChassisNo,'*','') as chassisNo,b.EngineNo,b.OrderType,case when len(b.nicvehicletype)<=10 then '*NOT AVAILABLE*NOT AVAILABLE' else b.nicvehicletype end,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount FROM  HSRPRecords a INNER JOIN HSRPRecordsStaggingArea b ON a.VehicleRegNo = b.VehicleRegNo where a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null  and  b.filename = '" + dropDownListFilenameforlocation.SelectedItem.Text + "'";
                         //   getDataQry = "SELECT  b.nicvehicleRegNo,upper(a.HSRP_Front_LaserCode),upper(a.HSRP_Rear_LaserCode),(select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate,convert(varchar(50), a.netamount) as netamount,convert(varchar(50), a.netamount) as netamount,upper(replace(b.ChassisNo,'*','')) as chassisNo,upper(b.EngineNo) as EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,'',b.Manufacturer,b.hsrpRecord_AuthorizationNo as cashrecpNo FROM  HSRPRecords a INNER JOIN [View_Delhi_HSRPRecordsStagging] b  ON a.VehicleRegNo = b.VehicleRegNo  where a.hsrp_StateID='2'  and b.rtolocationid = '135'  and a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null  and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null ";
                             
                            //getDataQry = "SELECT  b.nicvehicleRegNo,replace(b.ChassisNo,'*','') as chassisNo,b.EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount,replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN [View_Delhi_HSRPRecordsStagging] b  ON a.VehicleRegNo = b.VehicleRegNo  where a.hsrp_StateID = '" + Session["UserHSRPStateID"].ToString() + "' and b.rtolocationid = '" + RTOLocationID + "' and a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null  and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null "; //23rd oct
                           // getDataQry = "SELECT  b.nicvehicleRegNo,replace(b.ChassisNo,'*','') as chassisNo,b.EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount,replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN [View_Delhi_HSRPRecordsStagging] b  ON a.VehicleRegNo = b.VehicleRegNo  where a.hsrp_StateID = '" + Session["UserHSRPStateID"].ToString() + "' and b.rtolocationid = '" + dropDownListClient.SelectedValue + "' and a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null  and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null ";

                            //getDataQry = "select VehicleRegNo,ChassisNo,EngineNo,OrderType,VehicleType,OwnerName,Manufacturer,HSRPRecord_AuthorizationNo,HSRP_Front_LaserCode,HSRP_Rear_LaserCode,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS AffixationDate,a.TotalAmount,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS CashReceiptDateTime from HSRPRecords a where  a.vehicleregno in('DL11CA4084','DL11CA4082','DL11CA4081','DL11CA4078','DL11CA4076','DL11CA4075','DL11CA4070','DL11CA4068','DL11CA4066','DL11CA4065','DL11CA4064','DL11CA4063','DL11CA4061','DL11CA4055','DL11CA4052','DL11CA4134','DL11CA4184','DL11CA4480') and a.HSRP_StateID='2' and a.RTOLocationID='137' and a.OrderStatus='Closed'";
                            //getDataQry = "SELECT  b.nicvehicleRegNo,replace(b.ChassisNo,'*','') as chassisNo,b.EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount,replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN [View_Delhi_HSRPRecordsStagging] b  ON a.VehicleRegNo = b.VehicleRegNo  where a.hsrp_StateID = '" + Session["UserHSRPStateID"].ToString() + "' and b.rtolocationid = '" + dropDownListClient.SelectedValue + "' and a.orderstatus='Closed' and a.SendRecordToNic='Y' and a.ownername is not null and a.netamount is not null  and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null ";
                            //01/10/2015
                        ...
                        {
                       //getDataQry = "SELECT  b.nicvehicleRegNo,replace(b.ChassisNo,'*','') as chassisNo,b.EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount,replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN [View_Delhi_HSRPRecordsStagging] b  ON a.VehicleRegNo = b.VehicleRegNo  where a.hsrp_StateID = '" + Session["UserHSRPStateID"].ToString() + "' and b.rtolocationid = '" + dropDownListClient.SelectedValue + "' and a.orderstatus='Closed' and a.SendRecordToNic='Y' and OrderClosedDate >='2014-08-01' and  a.ownername is not null and a.netamount is not null  and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null ";
                            //01/10/2015
                            getDataQry = "select b.HSRPRecord_AuthorizationNo,b.NICVehicleRegNo,b.OrderType,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode,CONVERT(VARCHAR(10), a.OrderClosedDate, 105) AS AffixationDate,a.NetAmount,CONVERT(VARCHAR(10), a.hsrprecord_creationdate, 105) AS hsrprecord_creationdate from HSRPRecords a,HSRPRecordsStaggingArea b where a.VehicleRegNo=b.VehicleRegNo and  b.HSRP_StateID='2' and b.rtolocationid='" + dropDownListClient.SelectedValue.ToString() + "' and a.OrderStatus='Closed' and a.SendRecordToNic='N'";
                       // use for flat file 10june     getDataQry = "SELECT  b.nicvehicleRegNo,replace(b.ChassisNo,'*','') as chassisNo,b.EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount,replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN [View_Delhi_HSRPRecordsStagging] b  ON a.VehicleRegNo = b.VehicleRegNo  where a.hsrp_StateID = '2' and b.rtolocationid = '143' and a.orderstatus='Closed' and OrderClosedDate >='2014-02-01' and  a.ownername is not null and a.netamount is not null  and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null";
                             // getDataQry = @"SELECT  b.nicvehicleRegNo,upper(a.HSRP_Front_LaserCode),upper(a.HSRP_Rear_LaserCode),(select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate,
//                                           convert(varchar(50), a.netamount) as netamount,upper(replace(b.ChassisNo,'*','')) as chassisNo,upper(b.EngineNo) as EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo as cashrecpNo FROM  HSRPRecords a INNER JOIN [View_Delhi_HSRPRecordsStagging] b  ON a.VehicleRegNo = b.VehicleRegNo  
//                                           where a.hsrp_StateID='" + Session["UserHSRPStateID"].ToString() + "' and b.rtolocationid = '" + dropDownListClient.SelectedValue + "'   and a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null  and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null";

                            //getDataQry = "SELECT  b.nicvehicleRegNo,upper(a.HSRP_Front_LaserCode),upper(a.HSRP_Rear_LaserCode),(select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate,convert(varchar(50), a.netamount) as netamount,convert(varchar(50), a.netamount) as netamount,upper(replace(b.ChassisNo,'*','')) as chassisNo,upper(b.EngineNo) as EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,'',b.Manufacturer,b.hsrpRecord_AuthorizationNo as cashrecpNo FROM  HSRPRecords a INNER JOIN [View_Delhi_HSRPRecordsStagging] b  ON a.VehicleRegNo = b.VehicleRegNo  where a.hsrp_StateID= '" + Session["UserHSRPStateID"].ToString() + "'  and b.rtolocationid = '" + dropDownListClient.SelectedValue + "'  and a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null  and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null ";  //23rd oct
                            //getDataQry = "SELECT  case when len(b.nicvehicleRegNo)<=9 then left(b.NicVehicleRegNo,5)+' '+(right(b.nicvehicleRegNo,4)) else b.nicvehicleRegNo end as nicvehicleRegNo,replace(b.ChassisNo,'*','') as chassisNo,b.EngineNo,b.OrderType,case when len(b.nicvehicletype)<=10 then '*NOT AVAILABLE*NOT AVAILABLE' else b.nicvehicletype end,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount, replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN HSRPRecordsStaggingArea b ON a.VehicleRegNo = b.VehicleRegNo where a.orderstatus='Closed' and a.ownername is not null and a.netamount is not null and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null  and  b.filename = '" + dropDownListFilenameforlocation.SelectedItem.Text + "'";
                            //getDataQry = "SELECT  b.nicvehicleRegNo,replace(b.ChassisNo,'*','') as chassisNo,b.EngineNo,b.OrderType,b.nicvehicletype,b.OwnerName,b.Manufacturer,b.hsrpRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode, (select CASE WHEN datediff(DAY, a.HSRPRecord_CreationDate, a.OrderClosedDate ) <5  THEN replace (convert(varchar, a.HSRPRecord_CreationDate+5,106),' ','-')  ELSE replace (convert(varchar, a.OrderClosedDate,106),' ','-')  END) as OrderCloseDate, convert(varchar(50), a.netamount) as netamount,replace (convert(varchar, a.HSRPRecord_CreationDate,106),' ','-') AS CashReceiptDateTime FROM  HSRPRecords a INNER JOIN [View_Delhi_HSRPRecordsStagging] b  ON a.VehicleRegNo = b.VehicleRegNo  where a.hsrp_StateID = '2' and  b.rtolocationid = '134' and a.Vehicleregno ='DL5CE5685' and a.orderstatus='Closed' and a.SendRecordToNic='Y' and OrderClosedDate >='2014-03-01' and  a.ownername is not null and a.netamount is not null  and a.HSRP_Front_LaserCode is not null and a.HSRP_Rear_LaserCode is not null ";
                        }

                    }
                    else
                    {
                        //getDataQry = "select b.NICVehicleRegNo,b.ChassisNo,b.EngineNo,b.OrderType,b.NICVehicleType,b.OwnerName,b.Manufacturer,b.HSRPRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS AffixationDate,a.TotalAmount,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS CashReceiptDateTime from HSRPRecords a,HSRPRecordsStaggingArea b where a.VehicleRegNo=b.VehicleRegNo and a.vehicleregno in ('UK04G3207',"+
                        //             "'UK04F5057','UK04R0408','UK04J7105','UA04C6524','UK04Q7762','UK04Q7589','UK04Q8095','UK04Q7762','UK04G1379','UK04Q9688','UK04R2139','UK04R2367','UA04D9530','UK04R5265','UK04H4509','UK04K1512','UK04TA6066','UA049228',"+
                        //             "'UA04D0747','UK04L8726','UK04L3906','UK04G2102','UK04Q8511','UK04Q7741')and b.HSRP_StateID='" + dropDownListOrg.SelectedValue + "' and b.RTOLocationID='" + dropDownListClient.SelectedValue + "' and a.OrderStatus='Closed' and a.SendRecordToNic='N'";

                       // getDataQry = "select b.NICVehicleRegNo,b.ChassisNo,b.EngineNo,b.OrderType,b.NICVehicleType,b.OwnerName,b.Manufacturer,b.HSRPRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS AffixationDate,a.TotalAmount,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS CashReceiptDateTime from HSRPRecords a,HSRPRecordsStaggingArea b where a.VehicleRegNo=b.VehicleRegNo and a.vehicleregno in ('UK04G3207'," +
                                    // "'UK04F5057','UK04R0408','UK04J7105','UA04C6524','UK04Q7762','UK04Q7589','UK04Q8095','UK04Q7762','UK04G1379','UK04Q9688','UK04R2139','UK04R2367','UA04D9530','UK04R5265','UK04H4509','UK04K1512','UK04TA6066','UA049228'," +
                                   //  "'UA04D0747','UK04L8726','UK04L3906','UK04G2102','UK04Q8511','UK04Q7741') and b.HSRP_StateID='6' and a.OrderStatus='Closed' and a.SendRecordToNic='N'";


                         //getDataQry = "select b.NICVehicleRegNo,b.ChassisNo,b.EngineNo,b.OrderType,b.NICVehicleType,b.OwnerName,b.Manufacturer,b.HSRPRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS AffixationDate,a.TotalAmount,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS CashReceiptDateTime from HSRPRecords a,HSRPRecordsStaggingArea b where a.VehicleRegNo=b.VehicleRegNo and  b.HSRP_StateID='6' and b.rtolocationid='"+dropDownListClient.SelectedValue.ToString()+"' and a.OrderStatus='Closed' and a.SendRecordToNic='N'";
                        //getDataQry = "select b.NICVehicleRegNo,b.ChassisNo,b.EngineNo,b.OrderType,b.NICVehicleType,b.OwnerName,b.Manufacturer,b.HSRPRecord_AuthorizationNo,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS AffixationDate,a.TotalAmount,CONVERT(VARCHAR(10), a.OrderClosedDate, 103) AS CashReceiptDateTime from HSRPRecords a,HSRPRecordsStaggingArea b where a.VehicleRegNo=b.VehicleRegNo and a.VehicleRegNo='ua07t5550' and  b.HSRP_StateID='6' and b.rtolocationid='" + dropDownListClient.SelectedValue.ToString() + "' and a.OrderStatus='Closed' and a.SendRecordToNic='Y'";
                        getDataQry = "select b.HSRPRecord_AuthorizationNo,b.NICVehicleRegNo,b.OrderType,a.HSRP_Front_LaserCode,a.HSRP_Rear_LaserCode,CONVERT(VARCHAR(10), a.OrderClosedDate, 105) AS AffixationDate,a.NetAmount,CONVERT(VARCHAR(10), a.hsrprecord_creationdate, 105) AS hsrprecord_creationdate from HSRPRecords a,HSRPRecordsStaggingArea b where a.VehicleRegNo=b.VehicleRegNo and  b.HSRP_StateID='6' and b.rtolocationid='" + dropDownListClient.SelectedValue.ToString() + "' and a.OrderStatus='Closed' and a.SendRecordToNic='N'";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            fileName = ConfigurationManager.AppSettings["DataFolder"].ToString() + dropDownListFilenameforlocation.SelectedItem.Text;
                        }
                        else
                        {
