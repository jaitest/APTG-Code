<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewImperest.aspx.cs" Inherits="HSRP.Transaction.ViewImperest" %>
...
<script type="text/javascript">
    ...
    function edit(i) { // Define This function of Send Assign Laser ID 
        ...
        googlewin = dhtmlwindow.open("googlebox", "iframe", "ImperestDetails.aspx?Mode=Edit&ImperestID=" + i, "Edit Imprest Details", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
    ...
    function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
        ...
        googlewin = dhtmlwindow.open("googlebox", "iframe", "ImperestDetails.aspx?Mode=New", "Add New Imprest Details", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
        googlewin.onclose = function () {
                ...
                <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">View Imprest </span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New HSRP State" class="button">Add Imprest</a>
                                    </td>
                        ...
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                       ...
                                       <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional">
                                            <ContentTemplate> 
                                             <asp:DropDownList AutoPostBack="true" Visible="true" ID="dropDownListClient" 
                                                    ...
                                                    runat="server" DataTextField="RTOLocationName" 
                                                    DataValueField="distRelation" onselectedindexchanged="dropDownListClient_SelectedIndexChanged1" 
                                                    >
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                            <Triggers>
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap"> <asp:Label Text="User" Visible="true" runat="server" ID="labelOrderStatus" />&nbsp;&nbsp; </td>
                     ...
                     <tr>
                                    <td>
                                        <ComponentArt:Grid ID="Grid1" RTOLocationIDMode="AutoID" runat="server" ImagesBaseUrl="~/images"
                                            ...
                                            SearchOnKeyPress="true" SearchTextCssClass="GridHeaderText" ShowSearchBox="false"
                                            ...
                                            Height="300px">
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="ImperestID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                    <Columns>
                                                       <ComponentArt:GridColumn DataField="ImperestID" Visible="False" />
                                                        <ComponentArt:GridColumn DataField="SNo" HeadingText="S.No" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />
                                                            
                                                        <ComponentArt:GridColumn DataField="DateOfIssue" HeadingText="Date Of Issue" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />
                                                            
                                                            <ComponentArt:GridColumn DataField="ImperestAmt" FormatString="" HeadingText="Amount"
                                                        ...
                                                        <ComponentArt:GridColumn DataCellCssClass="maintext" DataCellClientTemplateId="Assign"  HeadingText="Edit" SortedDataCellCssClass="SortedDataCell" Width="80" />
                                            ...
                                            <ClientTemplates>
                                                   ...
                                                   <ComponentArt:ClientTemplate ID="Assign">
                                                    <a style="color: Blue" onclick="javascript:edit(## DataItem.GetMember('ImperestID').Value ##);" >
                                                        Edit</a>
