    ...
    public partial class UploadHSRPBooking : System.Web.UI.Page
    {
        ...
        private void InsertionOfRecords(DataTable dt)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
               ...
               // string SQLString1 = "select vehicleRegNo from HSRPRecords where vehicleRegNo='" + VehicleRegNo.ToString() + "'";
               // DataTable dtcount = Utils.GetDataTable(SQLString1, CnnStringupload);
