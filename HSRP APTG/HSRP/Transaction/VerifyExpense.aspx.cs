    ...
    public partial class VerifyExpense : System.Web.UI.Page
    {
        ...
        protected void btnReject(object sender, EventArgs e)
        {
            ...
            if (TransactionID != "")
            {
                ...
                string sqlquery1 = "update ExpenseSave set ExpenseStatus='Rejected' , VerifiedBy='" + Session["UID"].ToString() + "' , VerifiedDate=getdate(),VerifiedRemarks='" + txtRemarks.Text + "' where ExpenseSaveID='" + TransactionID + "'";
