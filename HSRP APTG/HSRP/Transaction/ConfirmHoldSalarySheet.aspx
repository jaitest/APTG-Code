                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                                 <td> 
                        <asp:Label Text="State:"  runat="server" ID="Label1" 
                            ForeColor="Black" />&nbsp;&nbsp;
                    </td>
                                       ...
                                       <td valign="middle" class="form_text" nowrap="nowrap">
                                                      ...
                                                      <asp:DropDownList ID="DDlState"                                                    
                                                                runat="server" >
                                                         <asp:ListItem Text="--Select State Name --" Value="--Select State Name --" />
                                                         <asp:ListItem Text="Andhra Pradesh" Value="9" />
                                                         <asp:ListItem Text="Telangana" Value="11" />
