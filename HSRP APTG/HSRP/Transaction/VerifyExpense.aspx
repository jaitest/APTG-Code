...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function VerifyAmount(i) {
            ...
            {
                window.location = "VerifyExpense.aspx";
                return true;
            }
        }
    </script>
                        ...
                        <td style="padding-top: 1px;">
                            <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" CellPadding="4" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="false" ShowHeader="true" Width="100%" BackColor="White" BorderColor="#FFCC99" BorderStyle="Solid" BorderWidth="1px" OnRowCommand="GridView1_RowCommand">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="ExpenseStatus" DataField="ExpenseStatus" />
                                    ...
                                    <asp:TemplateField HeaderText="Reject">
                                        <ItemTemplate>
                                            ...
                                            <%--<a href="javascript:Voids();">
                                                <asp:Label runat="server" ID="lblReject" Text="Reject"></asp:Label></a>--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
