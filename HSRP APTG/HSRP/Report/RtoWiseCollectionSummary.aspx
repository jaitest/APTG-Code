<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RtoWiseCollectionSummary.aspx.cs" Inherits="HSRP.Report.RtoWiseCollectionSummary" %>
    ...
    <table style="height: 51px;" width="80%">
        <tr>
            ...
            <td style="width: 50px; height: 40px;">               
                    <asp:Label ID="label2" runat="server" Font-Bold="True" ForeColor="Black" Text="Order Type:" Width="100px" />
            </td>
            <td style="height: 40px;" width="80">               
                    <asp:DropDownList ID="DropDownListOrderType" runat="server" 
                        ...
                        <asp:ListItem Value="D">Center</asp:ListItem>
