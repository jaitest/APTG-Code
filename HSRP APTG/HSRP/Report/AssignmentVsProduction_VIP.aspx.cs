...
{
    public partial class AssignmentVsProduction_VIP : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            string filename = "PIP VS ASSIGNMENT" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";

            string strOrderType = string.Empty;

            Export(strOrderType, book, 1, "Business_report_RTOwiseembossing_Summary");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                WorksheetCell cell = row.Cells.Add("PIP VS ASSIGNMENT");
        ...
        private void SaveAndDownloadFileAssignment()
        {
            ...
            ExportAssignment(strOrderType, book, 1, "Business_report_AssignmentVSProduction_Summary_VIP");
            ...
            try
            {
                ...
                for (int j = 0; j < dt.Rows.Count; j++)
                {
                    ...
                    for (int i = 0; i < dt.Columns.Count; i++)
                    {
                        ...
                        if (dt.Rows[j]["ZonalManager"].ToString().Trim().ToUpper().Equals("ZZ") && i.Equals(0))
                        {
                            AddNewCell(row, " ", "HeaderStyle6", 1);
                        }
                        else
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("Business_report_AssignmentVSProduction_Summary_VIP", con);
        ...
        protected void grdid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day1")
            {
                ...
                strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate)=dateadd(day,0,'" + ReportDate2 + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') and sendrecordtonic='Y'   order by 1");
            }
            if (e.CommandName == "Day2")
            {
                ...
                strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate)=dateadd(day,-1,'" + day1date + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') and sendrecordtonic='Y'  order by 1");
            }
            if (e.CommandName == "Day3")
            {
                ...
                strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate)=dateadd(day,-1,'" + day2date + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') and sendrecordtonic='Y'   order by 1");
            }
            if (e.CommandName == "Day4")
            {
                ...
                Label Day4 = (Label)grdid.Rows[RowIndex].FindControl("lblDay4Date");
                day4date = Day4.Text.ToString();
                strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate, convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate)=dateadd(day,-1,'" + day3date + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') and sendrecordtonic='Y'   order by 1");
        ...
        private void PIPVSProduction()
        {
            Workbook book = new Workbook();
            string filename = "PIP VS PRODUCTION" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";

            string strOrderType = string.Empty;

            Exportpip(strOrderType, book, 1, "Business_report_PIPVSProduction_Summary_VIP");
        ...
        private void Exportpip(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                SqlConnection con = new SqlConnection(CnnString1);
                ...
                row.Index = iIndex++;
                row.Cells.Add(new WorksheetCell("Report :", "HeaderStyle2"));
                WorksheetCell cell = row.Cells.Add("PIP VS PRODUCTION");
                cell.MergeAcross = 4; // Merge two cells together
                cell.StyleID = "HeaderStyle2";
        ...
        protected void btndetail_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("Business_report_PIPVSProduction_Summary_VIP", con);
            ...
            if (dt.Rows.Count > 0)
            {
                gridpip.DataSource = dt;
                gridpip.DataBind();
                gridpip.Visible = true;
                grdid.Visible = false;
            }

        }
        
        protected void gridpip_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            string embcentername = string.Empty;
            string TodayDate = System.DateTime.Now.Year.ToString() + "-" + System.DateTime.Now.Month.ToString() + "-" + System.DateTime.Now.Day.ToString();
            StringBuilder strSQL = new StringBuilder();
            ...
            if (e.CommandName == "Day5orMore")
            {
                ...
                GridViewRow oItem = (GridViewRow)((LinkButton)e.CommandSource).NamingContainer;
                int RowIndex = oItem.RowIndex;
                Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                ...
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate)<=dateadd(day,-4,'" + ReportDate2 + "')  and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') and sendrecordtonic='Y' order by 1");
            ...
            if (e.CommandName == "Day1")
            {
                ...
                Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate)=dateadd(day,0,'" + ReportDate2 + "') and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') and sendrecordtonic='Y'  order by 1");
            }
            if (e.CommandName == "Day2")
            {
                ...
                Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate)=dateadd(day,-1,'" + ReportDate2 + "') and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  and sendrecordtonic='Y' order by 1");
            }
            if (e.CommandName == "Day3")
            {
                ...
                Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate)=dateadd(day,-2,'" + ReportDate2 + "') and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') and sendrecordtonic='Y'  order by 1");
            }
            if (e.CommandName == "Day4")
            {
            ...
            if (state == "4" || state == "6" || state == "1" || state == "3")
            {
                string hsrprecord_creationdate = string.Empty;
                ...
                if (e.CommandName == "Day1")
                {
                    ...
                    Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                    embcentername = embcenter.Text.ToString();
                    strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,HSRPRecord_CreationDate)=dateadd(day,0,'" + ReportDate2 + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
                }
                if (e.CommandName == "Day2")
                {
                    ...
                    Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                    embcentername = embcenter.Text.ToString();
                    strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,HSRPRecord_CreationDate)=dateadd(day,-1,'" + ReportDate2 + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
                }
                if (e.CommandName == "Day3")
                {
                    ...
                    Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                    embcentername = embcenter.Text.ToString();
                    strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,HSRPRecord_CreationDate)=dateadd(day,-2,'" + ReportDate2 + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
                }
                if (e.CommandName == "Day4")
                {
                    ...
                    Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                    embcentername = embcenter.Text.ToString();
                    strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,HSRPRecord_CreationDate)=dateadd(day,-3,'" + ReportDate2 + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
        ...
        protected void gridpip_SelectedIndexChanged(object sender, EventArgs e)
        {
            string embcenterindex = grdid.SelectedRow.RowIndex.ToString();
        
        }

        protected void btnPvA_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(CnnString1);
            #region Fetch Data
            DataSet ds = new DataSet();
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("Business_report_RTOwiseembossing_Summary", con);
            ...
            if (dt.Rows.Count > 0)
            {
                grdPvA.DataSource = dt;
                grdPvA.DataBind();
                grdPvA.Visible = true;
               // grdPvA.Visible = false;
            }
        }

        protected void grdPvA_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            string embcentername = string.Empty;
            string TodayDate = System.DateTime.Now.Year.ToString() + "-" + System.DateTime.Now.Month.ToString() + "-" + System.DateTime.Now.Day.ToString();
            StringBuilder strSQL = new StringBuilder();
            ...
            if (e.CommandName == "OpeningwithoutRegnoB")
            {

                GridViewRow oItem = (GridViewRow)((LinkButton)e.CommandSource).NamingContainer;
                int RowIndex = oItem.RowIndex;
                Label embcenter = (Label)grdPvA.Rows[RowIndex].FindControl("lblembnameEC");
                embcentername = embcenter.Text.ToString();
            ...
            if (e.CommandName == "TodayOrderswithRegNoC")
            {
                ...
                Label lblembnameEC = (Label)grdPvA.Rows[RowIndex].FindControl("lblembnameEC");
                embcentername = lblembnameEC.Text.ToString();
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "'  and convert(date,HSRPRecord_CreationDate,103)='" + ReportDate2 + "' and hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (isnull(vehicleregno,'')!='') ");
            }
            if (e.CommandName == "TodayOrderswithoutRegNoD")
            {
        ...
        protected void grdPvA_SelectedIndexChanged(object sender, EventArgs e)
        {
            string embcenterindex = grdPvA.SelectedRow.RowIndex.ToString();
        }
