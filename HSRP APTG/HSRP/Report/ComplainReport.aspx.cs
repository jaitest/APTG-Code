    ...
    public partial class ComplainReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (DropDownListStateName_test != "")
                {
                    DuplicateMethodForBindGridView();
                }
        ...
        public static string DropDownListStateName_test="";
        public static string fromdate_test="";
        public static string ToDate_test="";
       ...
       { 
        ...
        private void InitialSetting()
        {
            ...
            HSRPAuthDate.VisibleDate = (DateTime.Parse(TodayDate)).AddDays(0.00);
        ...
        public void DuplicateMethodForBindGridView()
        {
            // ClearGrid();
            ...
            //DropDownListStateName.SelectedValue = DropDownListStateName_test;
            //OrderDate.SelectedDate = Convert.ToDateTime(fromdate_test);
            //HSRPAuthDate.SelectedDate = Convert.ToDateTime(ToDate_test);
            ...
            // SQLString = "select * from Complaint where StateId='" + DropDownListStateName.SelectedValue + "' and Status='Closed' and ComplaintDate between '" + fromdate + "' and  '" + ToDate + "'";
            // DataTable dt = new DataTable();            
            SQLString = "SELECT [id],[ComplaintNo],[Region],[StateId],[OwnerName],[MobileNo],[Email],[Regno],[EngineNo],[ChasisNo],left([Remarks],50) as Remarks,[IPAddress],[ComplaintDate],[Status],[Solution],[SolutionDate] FROM [Complaint] where StateId='" + DropDownListStateName_test + "' and convert(date,ComplaintDate) between convert(date,'" + fromdate_test + "') and  convert(date,'" + ToDate_test + "')";
            dt = Utils.GetDataTable(SQLString, CnnString);
