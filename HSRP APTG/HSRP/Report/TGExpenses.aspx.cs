...
{
    public partial class TGExpenses : System.Web.UI.Page
    {
        int UserType1;
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //change sp Name
                cmd = new SqlCommand("GetExpenses", con);//Business_ReportTypewisesummary_report

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@hsrp_stateid", DropDownListStateName.SelectedValue));
                cmd.Parameters.Add(new SqlParameter("@reportfromdate", Datefrom.SelectedDate));
                cmd.Parameters.Add(new SqlParameter("@reporttodate", Dateto.SelectedDate));
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "GetExpenses");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                string filename = "Expenses" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "Expenses";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    WorksheetCell cell = row.Cells.Add("LINK AUTOTECH PRIVATE LIMITED");
                    ...
                    row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                    WorksheetCell cell1 = row.Cells.Add("# 192, Chandra Nagar, Chintal, Hyderabd-500 054");
                    ...
                    row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                    WorksheetCell cell2 = row.Cells.Add("e-mail : info@linkutsav.com");
