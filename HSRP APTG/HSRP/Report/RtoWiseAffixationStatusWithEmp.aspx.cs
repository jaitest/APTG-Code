...
{
    public partial class RtoWiseAffixationStatusWithEmp : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "report_RTOwiseaffixation_SummarywithEmp");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
               ...
               // cmd.Parameters.Add(new SqlParameter("@flag", DropDownListOrderType.SelectedValue));
                ...
                WorksheetCell cell = row.Cells.Add("Rto Wise Affixation Status");
