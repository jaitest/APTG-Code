...
{
    public partial class TgGovReport : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            try
            {
                ...
                string filename = "TgGovReports" + System.DateTime.Now.Day.ToString() + "-"+ System.DateTime.Now.Month.ToString() +"-"+ System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "Tg Report";
                ...
                WorksheetCell cell = row.Cells.Add("Telangana Assignment Report");
                ...
                com.Parameters.AddWithValue("@StateId",Convert.ToInt32(11));
