...
namespace HSRP.Report
{
    public partial class RtoWiseEmbossingProductionVSDispatch_Summary : System.Web.UI.Page
    {
        ...
        protected void grdid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            // string ReportDate2 = Convert.ToDateTime(OrderDatefrom.SelectedDate).ToString("yyyy/mm/dd");
             DateTime ReportDate2 = OrderDatefrom.SelectedDate;
             string strdatetime = ReportDate2.ToShortDateString() + " 00:00:00";
           ...
           //Field Added on State Table 
            ...
            if (e.CommandName == "Day5orMore")
            {
                ...
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103)<=dateadd(day,-4,'" + ReportDate2 + "') and  hsrprecord_creationdate>'" + BusinessReportStartDate + "' and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103) = dateadd(day,-4,'" + strdatetime + "') and (convert(date,ChallanDate)>'" + strdatetime + "' or isnull(ChallanDate,'')='')");
            ...
            if (e.CommandName == "Day1")
            {
                ...
                Label embcenter = (Label)grdid.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,0,'" + ReportDate2 + "') and  hsrprecord_creationdate>'" + BusinessReportStartDate + "'  and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,0,'" + strdatetime + "') and (convert(date,ChallanDate)>'" + strdatetime + "' or isnull(ChallanDate,'')='')");
            }
            if (e.CommandName == "Day2")
            {
                ...
                Label embcenter = (Label)grdid.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103) = dateadd(day,-1,'" + strdatetime + "') and (convert(date,ChallanDate)>'" + strdatetime + "' or isnull(ChallanDate,'')='')");
                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,-1,'" + ReportDate2 + "') and  hsrprecord_creationdate>'" + BusinessReportStartDate + "'  and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
            }
            if (e.CommandName == "Day3")
            {
                ...
                Label embcenter = (Label)grdid.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,-2,'" + ReportDate2 + "')  and  hsrprecord_creationdate>'" + BusinessReportStartDate + "' and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103) =dateadd(day,-2,'" + strdatetime + "') and (convert(date,ChallanDate)>'" + strdatetime + "' or isnull(ChallanDate,'')='')");
            }
            if (e.CommandName == "Day4")
            {
                ...
                Label embcenter = (Label)grdid.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,-3,'" + ReportDate2 + "') and  hsrprecord_creationdate>'" + BusinessReportStartDate + "'  and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),aptgvehrecdate,103) as aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103) = dateadd(day,-3,'" + strdatetime + "') and (convert(date,ChallanDate)>'" + strdatetime + "' or isnull(ChallanDate,'')='')");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            string TodayDate = System.DateTime.Now.Year.ToString() + "-" + System.DateTime.Now.Month.ToString() + "-" + System.DateTime.Now.Day.ToString();
            StringBuilder strSQL = new StringBuilder();
            DateTime strdatetime = OrderDatefrom.SelectedDate;
            string ReportDate2 = strdatetime.ToShortDateString() + " 00:00:00";
            string ReportDate3 = Convert.ToString(ReportDate2);
            ...
            if (e.CommandName == "Day1")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,0,'" + ReportDate2 + "') and erpassigndate is not null and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
            }
            if (e.CommandName == "Day2")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,-1,'" + ReportDate2 + "') and erpassigndate is not null and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
            }
            if (e.CommandName == "Day3")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,-2,'" + ReportDate2 + "') and erpassigndate is not null and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
            }
            if (e.CommandName == "Day4")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,-3,'" + ReportDate2 + "') and erpassigndate is not null and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
