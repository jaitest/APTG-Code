<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CreateInvoice.aspx.cs" Inherits="HSRP.EmbossingData.CreateInvoice" %>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="midtable">
        <tr>
            ...
            <%--<td dir="ltr" valign="middle" class="form_text">
                                   <asp:Label Text="Vehicle No." runat="server" ID="label1" Font-Size="11pt" 
                                            ForeColor="Black" />
                                    </td>
                                    <td>
        ...
        <%--<tr>    <td valign="middle" class="form_text" nowrap="nowrap"> 
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap" align="left">
                                        <asp:Label ID="lblSNAPLOCK19" runat="server" Text="SNAP LOCK 19"></asp:Label>
                                        <asp:HiddenField ID="hdnSNAPLOCK19" runat="server" />
                                    </td>
                                    <td valign="middle" class="form_text" nowrap="nowrap" align="left"> 
                                    Snap Lock Quantity: 
                                    </td>
                                    <td valign="middle" class="form_text" nowrap="nowrap" align="left">
                                        <asp:TextBox ID="txtSnapLockQuantity19" onkeypress="return isNumber(event)" runat="server"></asp:TextBox>
                                    </td>
                                        <td dir="ltr" valign="middle" class="form_text"> </td>
                                </tr>--%>
        <%--<tr>    <td valign="middle" class="form_text" nowrap="nowrap"> 
        ...
        <%--<tr>    <td valign="middle" class="form_text" nowrap="nowrap"> 
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap" align="left">
                                        <asp:Label ID="lblSNAPLOCK25" runat="server" Text="SNAP LOCK 25"></asp:Label>
                                        <asp:HiddenField ID="hdnSNAPLOCK25" runat="server" />
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap" align="left">
                                        <asp:TextBox ID="txtSnapLockQuantity25" onkeypress="return isNumber(event)" runat="server"></asp:TextBox>
                                    </td>
                                        <td dir="ltr" valign="middle" class="form_text"> </td>
                                </tr>--%>
        <tr>
