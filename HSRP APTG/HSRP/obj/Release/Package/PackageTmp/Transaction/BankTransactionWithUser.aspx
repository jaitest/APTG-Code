<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="BankTransactionWithUser.aspx.cs" Inherits="HSRP.Master.BankTransactionWithUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DepositDate1_OnChange(sender, eventArgs) {
            var fromDate = Calendar2.getSelectedDate();
        ...
        function DepositDate1_OnClick() {
            if (Calendar2.get_popUpShowing()) {
                ...
                Calendar2.setSelectedDate(DepositDate1.getSelectedDate());
                Calendar2.show();
            }
        }
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("<%=ddlBothDealerHHT1.ClientID%>").value == "0") {
                alert("Please Select  Dealer Name ");
                document.getElementById("<%=ddlBothDealerHHT1.ClientID%>").focus();
                return false;
            }
            ...
            if (document.getElementById("<%=txtChequeBankName.ClientID%>").value == "") {
                alert("Please Provide Cheque Bank Name");
                document.getElementById("<%=txtChequeBankName.ClientID%>").focus();
                return false;
            }
            ...
            if (invalidChar(document.getElementById("txtChequeBankName"))) {
                alert("Special Characters Not Allowed in Cheque Bank Name");
                document.getElementById("txtChequeBankName").focus();
                return false;
            }
               ...
               <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="ddl_user" runat="server" 
                            DataTextField="UserLoginname" DataValueField="UserID" Height="20px" 
                            style="margin-left: 10px" Width="163px" 
                            onselectedindexchanged="ddl_user_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtcheckno" class="form_textbox12" runat="server" 
                            Width="160px" Height="18px" TabIndex="5"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style4">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp;
                      <td valign="top" onmouseup="DepositDate1_OnMouseUp()">
                                    ...
                                    <ComponentArt:Calendar ID="DepositDate1" runat="server" PickerFormat="Custom" 
                                     ...
                                     <img id="calendar_from_button1" TabIndex="2" alt="" onclick="DepositDate1_OnClick()"
                 ...
                 <tr>
                    ...
                    <td>
                        <%--<asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="163px"
                                         DataTextField="NAME OF THE DEALER" DataValueField="SNO" Height="20px" style="margin-left: 10px" 
                                            AutoPostBack="false" runat="server" >  
                                        </asp:DropDownList> --%>

                                        <asp:DropDownList Visible="true" ID="ddlBothDealerHHT1" CausesValidation="false" Width="163px" 
                                         DataTextField="dealername" DataValueField="dealername"  style="margin-left: 10px"
                                            AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlBothDealerHHT1_SelectedIndexChanged">  
                                        </asp:DropDownList>
                    </td>
                   ...
                   <asp:TextBox ID="txtBranchName" runat="server" class="form_textbox12" MaxLength="30" ></asp:TextBox>
                       ...
                       <td>
                           <asp:Label ID="lblDepositedLocation" class="style4" runat="server" Text="" ForeColor="Black"></asp:Label>
                           <br />
                           <asp:HiddenField ID="hdnrtolocation" runat="server" />
                       </td>
...
<%--                     <td class="style4">
                ...
                <tr>
                    ...
                    <td class="style4">
                        Cheque Bank Name <span class="alert">* </span>
                    </td>
                    <td>
                        <asp:TextBox ID="txtChequeBankName" class="form_textbox12" runat="server" 
                            onkeypress="return ischarKey(event)" MaxLength="30" TabIndex="6"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style4">
           ...
           <table>
             <tr>
                  ...
                  <tr>
                  <td>  <ComponentArt:Calendar runat="server" ID="Calendar2" AllowMultipleSelection="false"
                            AllowWeekSelection="false" AllowMonthSelection="false" ControlType="Calendar"
                        ...
                        <td>
                        <ComponentArt:Calendar runat="server" ID="Calendar3" AllowMultipleSelection="false"
                            AllowWeekSelection="false" AllowMonthSelection="false" ControlType="Calendar"
                            PopUp="Custom" PopUpExpandControlId="calendar_from_button1" CalendarTitleCssClass="title"
                            DayHoverCssClass="dayhover" DisabledDayCssClass="disabledday" DisabledDayHoverCssClass="disabledday"
                            OtherMonthDayCssClass="othermonthday" DayHeaderCssClass="dayheader" DayCssClass="day"
