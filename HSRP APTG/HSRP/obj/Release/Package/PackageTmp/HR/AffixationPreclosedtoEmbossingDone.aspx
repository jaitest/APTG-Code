<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AffixationPreclosedtoEmbossingDone.aspx.cs" Inherits="HSRP.HR.AffixationPreclosedtoEmbossingDone" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                              ...
                              <asp:GridView ID="GridView1" runat="server" BackColor="White" AutoGenerateColumns="false" OnPageIndexChanging="GridView1_PageIndexChanging"
                                PageSize="20" AllowPaging="true" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"  CellPadding="3" >
                        ...
                        <td align="center" style="padding-top: 10px">
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="PreClosed To Embossed Done" CssClass="button" Visible="false"
