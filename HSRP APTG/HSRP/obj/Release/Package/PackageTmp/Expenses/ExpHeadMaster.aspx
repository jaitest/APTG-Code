...
<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ExpHeadMaster.aspx.cs" Inherits="HSRP.Expenses.ExpHeadMaster" %>
                        ...
                        <tr>
                            <td height="30" background="../images/midtablebg.jpg">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <span class="headingmain">Exp Head</span>
                                        </td>
        ...
        <table width="100%">
            ...
            <tr>
                <td colspan="8" align="center" id="gridTD" runat="server">
                    <asp:Panel runat="server" ID="Panel1" ScrollBars="Vertical" Font-Bold="True" BorderColor="#FF9966" Height="500px" BorderStyle="Groove" BorderWidth="0px">
