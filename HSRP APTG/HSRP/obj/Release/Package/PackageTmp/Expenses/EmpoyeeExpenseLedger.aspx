<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EmpoyeeExpenseLedger.aspx.cs" Inherits="HSRP.Expenses.EmpoyeeExpenseLedger" %>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <td valign="middle" visible="true" class="form_text" nowrap="nowrap">
                                        <asp:Label Text="Employee:" runat="server" ID="lbldealer" Visible="true" />
                                        <br />
                                        &nbsp;&nbsp;
                                    </td>
                                    <td valign="middle" visible="true" class="form_text" nowrap="nowrap">
                                        &nbsp;&nbsp;
                                        <asp:DropDownList ID="ddlBothDealerHHT" CausesValidation="false" Width="250px" OnSelectedIndexChanged="ddlBothDealerHHT_SelectedIndexChanged" AutoPostBack="true" runat="server">
                                        </asp:DropDownList><br />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="ddlBothDealerHHT" InitialValue="--Select--" runat="server" ErrorMessage="Please Select Employee"></asp:RequiredFieldValidator>
                                    </td>
                                    <td valign="middle" visible="true" class="form_text" nowrap="nowrap">
                                        &nbsp;&nbsp;
                                    ...
                                    <td valign="middle" onmouseup="StartDate_OnMouseUp()" visible="true" class="form_text" nowrap="nowrap">
                                    ...
                                    <td valign="middle" onmouseup="EndDate_OnMouseUp()" visible="true" class="form_text" nowrap="nowrap">
                                    ...
                                    <td valign="middle" visible="true" class="form_text" nowrap="nowrap">
                                        <asp:Button ID="btnGO" Width="58px" runat="server" Visible="true" Text="GO" ToolTip="Please Click for Report" class="button" OnClick="btnGO_Click" />
                                        &nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="btnExportExcel" class="button" Visible="false" runat="server" ToolTip="Download for Grid Report" Text="Download" OnClick="btnExportExcel_Click" /></td>
            ...
            <tr>
                <td align="left" style="font-family: Verdana,tahoma, arial; font-size: medium;">
                    ...
                    <br />
                                ...
                                <tr>
                                    <td>
                                         <asp:GridView ID="grdid" runat="server" align="center" CellPadding="4" ForeColor="#333333" GridLines="None" ShowHeaderWhenEmpty="True" EmptyDataText="No records Found" AutoGenerateColumns="true">
