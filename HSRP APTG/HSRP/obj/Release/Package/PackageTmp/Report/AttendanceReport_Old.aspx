<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AttendanceReport_Old.aspx.cs" Inherits="HSRP.Report.AttendanceReport_Old" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <table style="width: 85%; height: 51px; left: 50px;">
        <tr>
            ...
            <td width="80">
                <asp:Label Text="HSRP State:" runat="server" ID="labelOrganization1" ForeColor="Black"
                    Font-Bold="True" />
            </td>
            <td style="width: 3px">
                <contenttemplate>
                        ...
                        CausesValidation="false" DataTextField="HSRPStateName" DataValueField="HSRP_StateID" Height="25px" Width="148px">
                        </asp:DropDownList>
                    </contenttemplate>
            </td>
            <td>
                <asp:Label Text="EmpName:" runat="server" ID="label2" ForeColor="Black" Font-Bold="True" Width="80px" />
            </td>
            <td style="width:110px">
                <asp:DropDownList ID="ddlUserAccount" runat="server" Style="margin-left: 5px" TabIndex="3" Width="165px" AutoPostBack="true">                                             
                </asp:DropDownList>
            </td>
            <%--   <td width="80">
                <asp:Label Text="Dealer:" runat="server" ID="labelSelectType" Visible="false" ForeColor="Black" Font-Bold="True" />
            </td>
            <td style="width: 80px; ">
                
                    <ContentTemplate>
                        <asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="140px" runat="server">
            ...
            <td style="width: 40px;">
                <asp:Label Text="From:" runat="server" ID="labelDate" Font-Bold="True" ForeColor="Black" />
            </td>
            <td style="width: 80px;">
            ...
            <td style="width: 20px;">
                <asp:Label Text="To:" runat="server" ID="labelTO" Font-Bold="True" ForeColor="Black" />
            </td>
            <td style="width: 80px;">
