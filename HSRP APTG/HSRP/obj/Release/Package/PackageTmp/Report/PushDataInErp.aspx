<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="PushDataInErp.aspx.cs" Inherits="HSRP.Report.PushDataInErp" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                              &nbsp;<span class="headingmain">Push Data In ERP </span>&nbsp;</td>
                    </tr>
                            ...
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button ID="btnUpdate" runat="server" Text="Update" class="button"  Width="100px" onclick="btnUpdate_Click" Visible="false"></asp:Button>
                                    ...
                                    <td>
                                    <asp:Button ID="btnhsrperp" runat="server" Text="HSRP TO ERP" class="button"  Width="100px" OnClick="btnhsrperp_Click" Visible="false"></asp:Button>
                                    </td>
                    ...
                    <tr>
                        <td>
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <asp:TextBox ID="txtvehicleno" runat="server" TextMode="MultiLine"></asp:TextBox>
                                ...
                                <td>
                                <asp:Button ID="Button1" runat="server" class=button Text="Save" Width="100px" 
                                ...
                                <tr>
                                    <td>
                                    <asp:Button ID="btnupdaterecord" runat="server" class=button Text="Update" Width="100px" OnClick="btnupdaterecord_Click"></asp:Button>
                                        </td>
                                    <td>
                                    <asp:Button ID="btndownload" runat="server" class=button Text="Download Report" Width="200px" OnClick="btndownload_Click"></asp:Button>
                                    </td>
                                ...
                                <tr>
                                     ...
                                     <td align="left" style="width: 191px"><br />
                                            ...
                                            <asp:GridView ID="grdcount" runat="server" CellPadding="4" ForeColor="#333333" 
                                    ...
                                    <AlternatingRowStyle BackColor="White" />
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Count" DataField="Column1" />
                                                </Columns>
                   ...
                   <asp:Label Text="PFA:Pending For Assignment FLA:Front Laser Assigned RLA:Rear Laser Assigned" Visible="true" Font-Bold="true" ForeColor="#333333" runat="server" ID="label3" />
                    ...
                    <tr>
                                     ...
                                     <td align="left" style="width: 191px"><br />
                                            ...
                                            <asp:GridView ID="grdshow" runat="server" CellPadding="4" ForeColor="#333333" 
                                        GridLines="None" style="margin-left: 10px" AutoGenerateColumns="False">
                                    <AlternatingRowStyle BackColor="White" />
                                                <Columns>
                                                    <asp:BoundField HeaderText="VehicleRegNo" DataField="VehicleRegNo" />
                                                    <asp:BoundField HeaderText="orderdate" DataField="orderdate" />
                                                    <asp:BoundField HeaderText="aptgvehrecdate" DataField="aptgvehrecdate" />
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap" style="width: 114px">
                                          ...
                                          <td valign="top" colspan="1">
                   <asp:Label Text="PFA:Pending For Assignment FLA:Front Laser Assigned RLA:Rear Laser Assigned" Visible="true" Font-Bold="true" ForeColor="#333333" runat="server" ID="label4" />
                                         
                                <asp:GridView ID="GridView2" runat="server" CellPadding="5" ForeColor="#333333"  AutoGenerateColumns="false"
                                        GridLines="None" Width="350px">
                                    <AlternatingRowStyle BackColor="White" />
                                    <Columns>
                                                    <asp:BoundField HeaderText="STATENAME" DataField="HSRPStateName"  />
