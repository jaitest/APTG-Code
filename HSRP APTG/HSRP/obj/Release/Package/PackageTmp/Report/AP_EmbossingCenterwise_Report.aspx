<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AP_EmbossingCenterwise_Report.aspx.cs" Inherits="HSRP.Report.AP_EmbossingCenterwise_Report" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Daily Production Report</span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                ...
                                <td></td>
                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                    ...
                                    <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 70px;";> 
                                        <asp:Label Text="Select Date:" Visible="true" runat="server" ID="labelDate" /> </td>
