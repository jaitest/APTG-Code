<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewExpenseMaster.aspx.cs" Inherits="HSRP.Master.ViewExpenseMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "ExpenseMaster.aspx?Mode=Edit&ExpenceID=" + i, "Update Expense Head", "width=523px,height=231px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location.href = "ViewExpenseMaster.aspx";
                return true;
            }
        }
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "ExpenseMaster.aspx?Mode=New", "Add Expense Head", "width=523px,height=231px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location = 'ViewExpenseMaster.aspx';
                return true;
            }
        }
    </script>
        ...
        <tr>
            <td valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" style="background-image: url(../images/midtablebg.jpg)">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">HSRP Expense Master </span>
                                    </td>
                    ...
                    <tr>
                        <td height="35" align="right" valign="middle" class="footer" style="padding-right: 145px;">
                            <a onclick="AddNewPop(); return false;" title="Add Expense Head"  class="button_go">Add Expense Head</a>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ComponentArt:Grid ID="Grid1" RTOLocationIDMode="AutoID" runat="server" ImagesBaseUrl="~/images"
                                            Width="100%" GroupingNotificationText=""
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="ExpenceID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                    <Columns>
                                                        <ComponentArt:GridColumn DataCellCssClass="maintext" DataField="ExpenceID" Visible="False" />
                                                        <ComponentArt:GridColumn DataCellCssClass="maintext" DataField="ExpenseName" HeadingText="Expense Name"
                                                            SortedDataCellCssClass="SortedDataCell" Width="170" />
                                                        <ComponentArt:GridColumn DataCellCssClass="maintext" DataField="ActiveStatus" Visible="true"
                                                            HeadingText="Active Status" Width="100" />
                                            ...
                                            <ClientTemplates>
                                                <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:editpage(## DataItem.GetMember('ExpenceID').Value ##);">
