                                        ...
                                        <td height="26" bgcolor="#FFFFFF" class="maintext">
                                            <table width="98%" border="0" align="center" cellpadding="3" cellspacing="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtpassword" runat="server" MaxLength="50" TextMode="Password" CssClass="form_textbox"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="form_text">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox CssClass="form_textbox" ID="txtCpassword" runat="server" MaxLength="50"
