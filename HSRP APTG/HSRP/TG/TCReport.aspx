<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TCReport.aspx.cs" Inherits="HSRP.TG.TCReport" %>
                        ...
                        <tr>
                            <td colspan="10" align="center">
                                <table border="1" cellpadding="0" cellspacing="0">
                                    <tr>
                                         <td align="left">
                                            <asp:Label Text="Location:" runat="server" ID="label4" ForeColor="Black" Font-Bold="True" Width="83px" />
                                        </td>
                                        <td align="left">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>                                                
                                            <asp:DropDownList ID="ddlRtoLocation" runat="server" AutoPostBack="True" DataTextField="RTOLocationName" DataValueField="RTOLocationID" CausesValidation="false" Height="22px" Width="120px">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlRtoLocation" ErrorMessage="Select Location" InitialValue="--Select Location--" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                        <td>
                                        ...
                                        <td align="center">
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                <ContentTemplate>
                                                    <ComponentArt:Calendar ID="Datefrom" runat="server" PickerFormat="Custom" PickerCustomFormat="dd/MM/yyyy" ControlType="Picker" PickerCssClass="picker">
                                                        <ClientEvents>
                                        ...
                                        <td align="center">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <ComponentArt:Calendar ID="Dateto" runat="server" PickerFormat="Custom" PickerCustomFormat="dd/MM/yyyy" ControlType="Picker" PickerCssClass="picker">
                                                        <ClientEvents>
                                                            <SelectionChanged EventHandler="Dateto_OnDateChange" />
                                                        </ClientEvents>
                                                    </ComponentArt:Calendar>
                                                    <img id="calendar_to_button" alt="" onclick="Dateto_OnClick()" onmouseup="Dateto_OnMouseUp()" class="calendar_button" src="../images/btn_calendar.gif" />
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>                                        
                                        <td>
                                            <asp:Button ID="btn" runat="server" Text="Preview" Font-Bold="True" ForeColor="#3333FF" OnClick="btn_Click" />
                                            <asp:Button ID="btn_download" runat="server" Text="Export Excel" Font-Bold="True" ForeColor="#3333FF" OnClick="btndownloadDetail_Click"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <%--<asp:Button ID="Button1" runat="server" Text="SendSMS" OnClick="Button1_Click" />--%>
                                        </td>
                                    </tr>
                                </table>
                            </td>
