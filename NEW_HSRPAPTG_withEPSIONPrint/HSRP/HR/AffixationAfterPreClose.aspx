<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AffixationAfterPreClose.aspx.cs" Inherits="HSRP.HR.AffixationAfterPreClose" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function validate() {
            ...
            if (document.getElementById("<%=ddlFilter.ClientID%>").value == "--Select Filter--") {
                alert("Please Select Filter");
                document.getElementById("<%=ddlFilter.ClientID%>").focus();
                return false;
            }
        }
                        ...
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr id="TR1" runat="server">
                                    <td > 
                                          <asp:Label ID="Label4" class="headingmain" runat="server"  >Mark Production Embossing Done</asp:Label> 
                                   ...
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()"   align="left">
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:DropDownList ID="ddlFilter" runat="server">
                                            ...
                                            <asp:ListItem>PreClosed</asp:ListItem>
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        ...
                                        <asp:Button ID="btnGO"  Width="58px"  runat="server" 
                                            ...
                                            onclick="btnGO_Click" BackColor="Orange" ForeColor="#000000" /> &nbsp;&nbsp;&nbsp;  
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                                  ...
                                                  <asp:Button ID="btnpdf" runat="server" Text="Download" ToolTip="Print PreClosedtoClosed PDF" class="button_pdf" onclick="btnpdf_Click" Visible="true"/>
                                                   &nbsp;&nbsp;&nbsp;
                                                </td>
                                         <td valign="middle" class="form_text" nowrap="nowrap">
                                                  <asp:Button ID="btnExcel" runat="server" Text="Download" ToolTip="Print PreClosedtoClosed Excel" class="button_exl" Visible="true" OnClick="btnexport_Click"/>
                                                   
                                                </td>
                                     
                                </tr>
                                <tr>    <td valign="middle" class="form_text" nowrap="nowrap"> 
                                   <asp:Label Text="Production Sheet" Visible="false" runat="server" ID="labelOrderStatus" />&nbsp;&nbsp; </td>
                                    <td valign="middle" > <asp:DropDownList   DataTextField ="pdffilename" style=" margin-top:10px;"
                                            DataValueField="pdffilename" Visible="false" AutoPostBack="true"
                    ...
                    <tr>
                        <td>
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                              ...
                              <asp:GridView ID="GridView1" runat="server" BackColor="White" AutoGenerateColumns="false" OnPageIndexChanging="GridView1_PageIndexChanging"
                                PageSize="50" AllowPaging="true" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"  CellPadding="3" >
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            Select
                                            <asp:CheckBox ID="CHKSelect1" runat="server" AutoPostBack="true" OnCheckedChanged="CHKSelect1_CheckedChanged" Visible="false" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtFLaserCode" runat="server" ReadOnly="true" Text='<%#Eval("hsrp_front_lasercode") %>'></asp:TextBox>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtRlaserCode" runat="server" ReadOnly="true" Text='<%#Eval("hsrp_rear_lasercode") %>'></asp:TextBox>
                                    ...
                                    <asp:TemplateField Visible="false">
                                     ...
                                     <asp:TemplateField Visible="false">
                                      ...
                                      <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                             <asp:TextBox ID="txtOS" runat="server" ReadOnly="true" Text='<%#Eval("orderstatus") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                        ...
                        <td align="center" style="padding-top: 10px">
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="Mark Closing Done" CssClass="button" Visible="false"
                               OnClick="btnSave_Click" BackColor="Orange" />
                        </td>
                        <td align="center" style="padding-top: 10px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <asp:Button ID="btnexport" runat="server" BackColor="Orange" Text="Export To Excel" Font-Bold="True" ForeColor="#3333FF" onclientclick="validate()" vis OnClick="btnexport_Click" Visible="false" />
                                    </td>
                                </tr>
                            </table>
                        </td>
