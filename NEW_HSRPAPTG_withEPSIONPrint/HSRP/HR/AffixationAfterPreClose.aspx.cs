    ...
    public partial class AffixationAfterPreClose : System.Web.UI.Page
    {
        ...
        private void ShowGrid()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (GridViewRow gvr in GridView1.Rows)
                {
                    ...
                    TextBox txtOS = (TextBox)gvr.Cells[7].FindControl("txtOS");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < GridView1.Rows.Count; i++)
                {
                    ...
                    chk = GridView1.Rows[i].Cells[0].FindControl("CHKSelect") as CheckBox;
                    Label lblVehicleRegNo = GridView1.Rows[i].Cells[2].FindControl("lblVehicleRegNo") as Label;
                    Label lblvehicletype = GridView1.Rows[i].Cells[3].FindControl("lblvehicletype") as Label;
                    TextBox RearLaserCode = GridView1.Rows[i].Cells[4].FindControl("txtFLaserCode") as TextBox;
                    TextBox FLasercode = GridView1.Rows[i].Cells[5].FindControl("txtRLaserCode") as TextBox;
                    Label id = GridView1.Rows[i].Cells[6].FindControl("id") as Label;
                    if (chk.Checked == true)
                    {
                ...
                if (DropDownListStateName.SelectedValue.ToString() == "9")
                {
                    ...
                    for (int i = 0; i < GridView1.Rows.Count; i++)
                    {
                        ...
                        if (chk.Checked == true)
                        {
                            ...
                            TextBox FLasercode = GridView1.Rows[i].Cells[5].FindControl("txtRLaserCode") as TextBox;
                            Label id = GridView1.Rows[i].Cells[6].FindControl("id") as Label;
                            Label lblAuthNo = GridView1.Rows[i].Cells[7].FindControl("AuthNo") as Label;
        ...
        private void Export()
        {
            try
            {
                ...
                SQLString = "select ROW_NUMBER() Over (Order by PreCloserDateTime) As SNo, vehicleregno as 'Vehicle Reg No',Vehicletype as 'Vehicle Type',CONVERT(VARCHAR(10), Hsrprecord_Creationdate, 103) as 'Affix Date',CONVERT(VARCHAR(10),ordercloseddate, 103) as 'Order Date',orderstatus as 'Order Status' from hsrprecords  where hsrp_stateid ='" + HSRPStateID + "'  and Rtolocationid='" + dropDownListClient.SelectedValue.ToString() + "'  and PreCloserDateTime between '" + AuthorizationDate + "' and '" + ToDate + "'  and orderstatus in ('closed')   order by PreCloserDateTime ";
        ...
        public void EpsionPrint()
        {
            ...
            string SQLString = "select ROW_NUMBER() Over (Order by PreCloserDateTime) As SNo, vehicleregno,Vehicletype,Hsrprecord_Creationdate,ordercloseddate,orderstatus from hsrprecords  where hsrp_stateid ='" + HSRPStateID + "'  and Rtolocationid='" + dropDownListClient.SelectedValue.ToString() + "'  and PreCloserDateTime between '" + StringOrderDate + "' and '" + StringAuthDate + "'  and orderstatus in ('closed')   order by PreCloserDateTime";
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dataSetFillHSRPDeliveryChallan.Rows.Count; i++)
                {
                    ...
                    PdfPCell cell26 = new PdfPCell(new Phrase("Order Status", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cell26.Colspan = 0;
                    ...
                    PdfPCell cell256 = new PdfPCell(new Phrase(": " + dataSetFillHSRPDeliveryChallan.Rows[i]["orderstatus"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cell256.Colspan = 0;

                    cell256.BorderWidthLeft = 0f;
                    cell256.BorderWidthRight = 0f;
                    cell256.BorderWidthTop = 0f;
                    cell256.BorderWidthBottom = 0f;
                    cell256.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                    table.AddCell(cell256);         
