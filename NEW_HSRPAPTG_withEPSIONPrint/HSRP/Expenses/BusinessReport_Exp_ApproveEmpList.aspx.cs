...
{
    public partial class BusinessReport_Exp_ApproveEmpList : System.Web.UI.Page
    {
        ...
        {
            string sqlstring = "[BusinessReport_Expense_Approve_Emp_list] '" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','','Report'," + HSRP_StateID1 + " ," + strUserID1 + " ";
            dt11 = new DataTable();
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //change sp Name
                cmd = new SqlCommand("BusinessReport_Expense_Approve_Emp_list", con);
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "BusinessReport_Expense_Approve_Emp_list");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    WorksheetCell cell = row.Cells.Add("Employee List");
