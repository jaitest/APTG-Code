...
{
    public partial class ExpHeadMaster : System.Web.UI.Page
    {
        ...
        {
            string sqlstring = "[BusinessReport_ExpenseMaster] 'ExpHeadMaster','" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','','Report'," + HSRP_StateID1 + " ";
            dt11 = new DataTable();
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //change sp Name
                cmd = new SqlCommand("BusinessReport_ExpenseMaster", con);//Business_ReportTypewisesummary_report
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@pagename", "ExpHeadMaster")); 
        ...
        private void SaveAndDownloadFile()
        {
            ...
            filename = "Exp Head" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";

            string strOrderType = string.Empty;

            Export(strOrderType, book, 1, "BusinessReport_ExpenseMaster");           
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                book.Properties.Title = "Exp Head";
            ...
            // cmd.Parameters.Add(new SqlParameter("@dealername", DropDown_Dealer.SelectedValue));              
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    WorksheetCell cell = row.Cells.Add("Employee Report");
        ...
        {
            if (DdlReportType.SelectedItem.ToString() == "Search")
            {
