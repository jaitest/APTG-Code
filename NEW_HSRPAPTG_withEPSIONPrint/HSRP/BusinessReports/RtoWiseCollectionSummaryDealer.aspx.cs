...
{
    public partial class RtoWiseCollectionSummaryDealer : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            string filename = "Collection V/S Deposit" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";

            string strOrderType = string.Empty;

            Export(strOrderType, book, 1, "Business_DateYearMonthWise_Collection_SummaryDealer");
               ...
               cell1.StyleID = "HeaderStyle6";
                ...
                for (int j = 0; j < dt.Rows.Count; j++)
                {
                    ...
                    for (int i = 0; i < dt.Columns.Count; i++)
                    {
                        ...
                        if (dt.Rows[j]["Zone"].ToString().Equals("ZZTotal") && i.Equals(0))
                        {
                            AddNewCell(row, "Total", "HeaderStyle6", 1);
                        }
                        else if (dt.Rows[j]["Zone"].ToString().Equals("ZZZTG Police Today") && i.Equals(0))
                        {
                            AddNewCell(row, "TG Police Today", "HeaderStyle6", 1);
                        }

                        else if (dt.Rows[j]["Zone"].ToString().Equals("ZZZAP Police Today") && i.Equals(0))
                        {
                            AddNewCell(row, "AP Police Today", "HeaderStyle6", 1);
                        }
                        else
                        {
