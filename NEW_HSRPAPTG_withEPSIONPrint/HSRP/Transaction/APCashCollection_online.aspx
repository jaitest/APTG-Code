<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="APCashCollection_online.aspx.cs" Inherits="HSRP.Transaction.APCashCollection_online" %>
...
<marquee class="mar1" direction="left" >Please Ensure Customer Data On Screen Matches With Authorization Slip Before Save. Penalty Will Be Imposed On Generation Of Wrong Cash Receipt. We are not out sourcing any of our HSRP activity to anyone. Be alert of fake calls/Misleading Information.Company will not be responsible for such Transactions/Dealings.</marquee>
        ...
        <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td width="900"><table id="Table1" width="100%" align="center" style="font-size: 16px; color:Black; font-family:@Batang; background-color:#fff" >
                  ...
                  <tr>
                    ...
                    <td><asp:Button ID="Button3" runat="server" CssClass="button-success" 
                            onclick="Button3_Click" OnClientClick="return Hidebuttonapcashcollection()" ClientIDMode="Static" TabIndex="12" Text="Epson Print" Visible="false"  />                
                      <asp:Button ID="btnDownload" runat="server" Text="Download Receipt"  ClientIDMode="Static" OnClientClick="return Hidedownloadbuttonapcashcollection()"
                ...
                <td valign="top"><table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="auto-style1">Today Booking Count:</td>
                    <td class="auto-style2"><asp:Label ID="lblCount" runat="server">0</asp:Label></td>
                  </tr>
                  <tr>
