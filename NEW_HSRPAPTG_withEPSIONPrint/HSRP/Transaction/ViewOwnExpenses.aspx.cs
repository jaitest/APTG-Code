...
namespace HSRP.Transaction
{
    public partial class ViewOwnExpenses : System.Web.UI.Page
    {
        ...
        //        string cell_1_Value = GridView1.Rows[gr.RowIndex].Cells[5].Text;
        //        if (cell_1_Value != "Pending")
        //        {
        //            if (gr.RowType == DataControlRowType.DataRow)
        //            {
        //                lnkRejected = gr.FindControl("lnkReject") as LinkButton;
        ...
        //            return;
        //        }
        //        string sqlquery1 = "update ExpenseSave set ExpenseStatus='Rejected' , VerifiedBy='" + Session["UID"].ToString() + "' , VerifiedDate=getdate(),VerifiedRemarks='" + txtRemarks.Text + "',RejectedDate=getdate() where ExpenseSaveID='" + TransactionID + "'";
