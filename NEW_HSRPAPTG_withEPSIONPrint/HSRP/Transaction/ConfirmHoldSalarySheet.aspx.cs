...
namespace HSRP.Transaction
{
    public partial class ConfirmHoldSalarySheet : System.Web.UI.Page
    {
        ...
        private void ShowGrid()
        {
            ...
            com.Parameters.AddWithValue("@stateid", Convert.ToInt32(DDlState.SelectedValue.ToString()));
        ...
        protected void btnHold_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = " Update  SalarySheet set  status = 'N' , SalayConfirmBy =" + Convert.ToInt32(strUserID) + " , salaryConfirmDate = getDate() where Month_Name = " + Convert.ToInt32(DDLMonth.SelectedValue.ToString()) + " and year=" + Convert.ToInt32(ddlyear.SelectedValue.ToString()) + " and EmpCode='" + txtepcode.Text.Trim().ToString() + "' and Companyid =" + Convert.ToInt32(DDlCompany_Name.SelectedValue.ToString()) + " ";
