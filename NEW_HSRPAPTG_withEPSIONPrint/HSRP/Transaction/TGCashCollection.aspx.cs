...
{
    public partial class TGCashCollection : System.Web.UI.Page
    {
        ...
        protected void btnDownloadReceipt_Click(object sender, EventArgs e)
        {
            ...
            decimal sgstno = Convert.ToDecimal(GetAddress.Rows[0]["SGSTPer"].ToString());
            decimal cgstno = Convert.ToDecimal(GetAddress.Rows[0]["CGSTPer"].ToString());


            string SQLString = "select hsrprecordID, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType,CashReceiptNo,SGSTPer,SGSTAmount,CGSTPer,CGSTAmount,GSTBasicAmount from hsrprecords where  HSRP_StateID=11 and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'";
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                PdfPCell cell2 = new PdfPCell(new Phrase("GST (PROV ID NO.)", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell2.Colspan = 1;
                ...
                decimal roundoffvalue = decimal.Round(Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["CGSTAmount"].ToString()), 2);
                ...
                celldupRouCash402.HorizontalAlignment = 1;
                ...
                cell1202SGST.HorizontalAlignment = 1;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string TGonlineQuery = "Select top 1 * from tgonlinepayment where HSRP_StateID=11 and hsrprecord_Authorizationno='" + lblAuthNo.Text + "' order by ID desc";
                DataTable dtTGonlineQuery = Utils.GetDataTable(TGonlineQuery.ToString(), ConnectionString);
                if (dtTGonlineQuery.Rows.Count > 0)
                {
                    string onlinepaymentstatus = dtTGonlineQuery.Rows[0]["onlinepaymentstatus"].ToString();
                    if (onlinepaymentstatus == "Y")
                    {
                        lblSucMess.Visible = false;
                        lblErrMess.Visible = true;
                        lblErrMess.Text = "Your online payment has been received with tracking number- " + dtTGonlineQuery.Rows[0]["OnlinePaymenttrackingno"].ToString();
                        return;
                    }
                    else if (onlinepaymentstatus == "N")
                    {
                        lblSucMess.Visible = false;
                        lblErrMess.Visible = true;
                        lblErrMess.Text = "Your online payment has been initiated please set it void from tech support with online payment id- " + dtTGonlineQuery.Rows[0]["Onlinepaymentid"].ToString();
                        return;
                    }
                }
                ...
                if (co > 0)
                {
                    lblSucMess.Visible = false;
                    lblErrMess.Visible = true;
                    lblErrMess.Text = "Order already booked with this authorization no.";
                    return;
                }
                else
                {
                   ...
                   // Invoice = Utils.getScalarValue(Invoice, ConnectionString);
                    ...
                    string strtax = " select  SGSTPer,SGSTAmount,CGSTPer,CGSTAmount,Roundoff_NetAmount,GSTBasicAmount,roundoff_value from tax where OrderType = '" + lblTransactionType.Text.ToString() + "' and VehicleType ='" + lblVehicleType.Text.ToString() + "' and isnull(GSTBasicAmount,0)!=0 and   HSRP_StateID=11";
                    ...
                    string strQuery = "insert into hsrprecords (SaveMacAddress,DeliveryChallanNo,ISFrontPlateSize,ISRearPlateSize, address1,manufacturername," +
                           ...
                           "VAT_Amount,RoundOff_NetAmount,VAT_Percentage,remarks,affix_id,PlateAffixationDate,SGSTPer,SGSTAmount,CGSTPer,CGSTAmount,GSTBasicAmount,roundoff_value) " +
                           ...
                           RTOLocationID + "','" + date1 + "','" + SGSTPer + "','" + SGSTPeanmt + "','" + CGSTPer + "','" + CGSTPeramt + "','" + GSTBasicPeanmt + "','" + roundoffvalue + "')";
                    ...
                    if (i > 0)
                    {
                       ...
                       // u = Utils.ExecNonQuery(Query, ConnectionString);
                        ...
                        string AuthData = objTgService.UpdateHSRPCharges(txtAuthNo.Text, Math.Round(Convert.ToDecimal(lblAmount.Text), 0), serverdate);
                        string currentdate = DateTime.Now.ToString("dd/MM/yyyy");
                        Query = "update hsrprecords set APwebserviceresp = '" + AuthData + "', APwebservicerespdate=getdate() where HSRP_StateID=11 and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'";
                        u = Utils.ExecNonQuery(Query, ConnectionString);
                        ...
                        if (lblMobileNo.Text.Length > 0)
                        {
                            ...
                            Utils.ExecNonQuery("insert into TSSMSDetail(RtoLocationID,AuthorizationNumber,VehicleRegNo,MobileNo,SentResponseCode,smstext) values('" + RTOLocationID + "','" + lblAuthNo.Text + "','" + lblRegNo.Text.Trim().ToUpper() + "'," + lblMobileNo.Text.ToString() + ",'" + result + "','" + SMSText + "')", ConnectionString);
                        }
        ...
        public void EpsionPrint()
        {
            ...
            string getTinNo = string.Empty;
            string getExciseNo = string.Empty;
            ...
            getExciseNo = GetAddress.Rows[0]["ExciseNo"].ToString();
            getTinNo = GetAddress.Rows[0]["GSTIN"].ToString();
            ...
            string SQLString = "select hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType,SGSTPer,SGSTAmount,CGSTPer,CGSTAmount,GSTBasicAmount from hsrprecords where hsrp_stateid=11 and HSRPRecord_AuthorizationNo ='" + txtAuthNo.Text.Replace(" ", "") + "'";
            DataTable dataSetFillHSRPDeliveryChallan = Utils.GetDataTable(SQLString, ConnectionString);
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                //Creates an instance of the iTextSharp.text.Document-object:
                Document document = new Document();
                float imageWidth = 226;
                float imageHeight = 425;
                document.SetMargins(0, 0, 6, 0);
                ...
                PdfPCell cell1 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell1.Colspan = 2;
                cell1.BorderWidthLeft = 0f;
                cell1.BorderWidthRight = 0f;
                cell1.BorderWidthTop = 0f;
                ...
                PdfPCell cell001 = new PdfPCell(new Phrase(" ", new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell001.Colspan = 2;
                cell001.BorderWidthLeft = 0f;
                cell001.BorderWidthRight = 0f;
                cell001.BorderWidthTop = 0f;
                cell001.BorderWidthBottom = 0f;

                cell001.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
               ...
               // decimal roundvalue = decimal.Round(Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["roundoff_value"].ToString()), 2);
                ...
                PdfPCell cellkLk1 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 9f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cellkLk1.Colspan = 2;
                ...
                {
                    //PdfPCell cellk1 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 9f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    //cellk1.Colspan = 2;
                    ...
                    PdfPCell cellkk1 = new PdfPCell(new Phrase(" ", new iTextSharp.text.Font(bfTimes, 9f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cellkk1.Colspan = 2;
                ...
                PdfPCell cellkLk211 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 9f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cellkLk211.Colspan = 2;
                cellkLk211.BorderWidthLeft = 0f;
                cellkLk211.BorderWidthRight = 0f;
                cellkLk211.BorderWidthTop = 0f;
                cellkLk211.BorderWidthBottom = 0f;
                cellkLk211.HorizontalAlignment = 0;
                table.AddCell(cellkLk211);
                ...
                //if (strvehno.ToString().Trim() != "")
                {
                    ...
                    //PdfPCell cellkLk0211 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 9f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    ...
                    //PdfPCell cellkLk1201 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 9f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
