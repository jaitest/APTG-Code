    ...
    public partial class ViewLedgerBankTransactions : System.Web.UI.Page
    {
        ...
        public void ShowGrid()
        {
            try
            {
                ...
                DataTable dt = Utils.GetDataTable("DealerLedgerBankTransaction 'Y'," + strUserID + "," + HSRPStateID + ",'" + Convert.ToDateTime(StartDate.SelectedDate).ToShortDateString() + "','" + Convert.ToDateTime(EndDate.SelectedDate).ToShortDateString() + "'", CnnString); //objUtils.GetRecords("DealerLedgerBankTransaction", sqlParameter, con);
