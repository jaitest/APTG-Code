    ...
    int Hsrp_stateid = 0;
            ...
            {	   	
                ...
                Net_Salary = Convert.ToInt64(dr["NetSalary"].ToString().Trim());
                 ...
                 if (dr["State"].ToString().Trim() == "AP")
                 {
                     Hsrp_stateid = 9;
                 }
                 if (dr["State"].ToString().Trim() == "TG")
                 {
                     Hsrp_stateid = 11;
                 }
                ...
                else
                {
                 ...
                 sb.Append("Insert into dbo.SalarySheet (EmpCode,Name ,AccountNo ,Net_Salary,Pay_Mode,UploadedDatatime,UploadedBy,CompanyId,Month_Name ,Year,ExcelSheetName, Hsrp_stateid) values('" + EmpCode + "','" + Name + "','" + ACountNo + "'," + Net_Salary + ",'" + Pay_Mode + "', getdate()," + UploadedBy + ",'" + CompanyName + "','" + Month_Name + "'," + Year + " ,'" + ExcelSheetName + "', "+Hsrp_stateid+");"); 
