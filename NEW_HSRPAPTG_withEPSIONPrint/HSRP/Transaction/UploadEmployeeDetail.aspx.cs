    ...
    public partial class UploadEmployeeDetail : System.Web.UI.Page
    {
        ...
        private void InsertionOfRecords(DataTable dt)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
               ...
               // DOJ = dr["DOJ"].ToString();
                if (double.TryParse(dr["DOJ"].ToString(), out dResult))
                {
                ...
                if (Iresult > 0)
                {
                    ...
                    //llbMSGError.Text = "";
                    sb.Append(" Update employeemaster set ESINumber= '" + ESICNo + "', 	PFNumber =  '" + EPFNo + "',UANNumber ='" + UANNo + "'  ,BankName  =  '" + BankName + "', BankAccountNo = '" + ACountNo + "',  BranchName ='" + BranchName + "' , IFSCCode ='" + IFSCode + "',	Emp_Name= '" + Name + "', EmpJoiningDate = '" + dojdate + "',	DepartmentName  = '" + Department + "', Designation = '" + Designation + "', District =   '" + District + "' ,Location = '" + Location + "',CTC =  " + CTC + "   ,ActualSalary =" + ActualSalary + ",  Monthly_Basic = " + Monthly_Basic + ",Monthly_HRA =" + Monthly_HRA + ", Monthly_Conveyance =" + Monthly_Conveyance + ", Monthly_Medical_Allowance= " + Monthly_Medical_Allowance + ", Monthly_CCA =" + Monthly_CCA + ", Monthly_Total=" + Monthly_Total + ", Gross_Basic = " + Gross_Basic + ", Gross_HRA = " + Gross_HRA + "  ,Gross_Conveyance=" + Gross_Conveyance + " ,Gross_MedicalAllowance=" + Gross_MedicalAllowance + " ,Gross_CCA=" + Gross_CCA + ",Gross_Total=" + Gross_Total + ",EE_ESI=" + EE_ESI + ",EE_PF=" + EE_PF + ", ER_ESI=" + ER_ESI + ",Admin=" + Admin + ",ER_PF=" + ER_PF + ",TDS=" + TDS + ",CUG_HSRP_DED_OTH =" + CUG_HSRP_DED_OTH + ",SCN_DED=" + SCN_DED + ",Deduction1 =" + deduction + " , Incentive =" + Incentives + " ,CompanyId = '" + CompanyName + "', EntryDate = getdate(), UploadedBy= " + UploadedBy + " ,  ActiveStatus = 'Y' , hsrp_stateid= " + state_id + " where Emp_id = '" + EmpCode + "'   ;");              
                ...
                {
                    sb.Append("Insert into dbo.employeemaster (Emp_id, ESINumber,	PFNumber ,	UANNumber ,BankName ,BankAccountNo  , BranchName  , IFSCCode ,Emp_Name ,	EmpJoiningDate ,	DepartmentName ,Designation ,District ,Location ,CTC,ActualSalary ,Monthly_Basic,Monthly_HRA,Monthly_Conveyance,Monthly_Medical_Allowance,Monthly_CCA ,Monthly_Total,Gross_Basic,Gross_HRA ,Gross_Conveyance ,Gross_MedicalAllowance,Gross_CCA,Gross_Total,EE_ESI,EE_PF,ER_ESI,Admin,ER_PF,TDS,CUG_HSRP_DED_OTH,SCN_DED,Deduction1 ,Incentive ,CompanyId, EntryDate, UploadedBy,ActiveStatus,hsrp_stateid  ) values('" + EmpCode + "','" + ESICNo + "','" + EPFNo + "','" + UANNo + "','" + BankName + "','" + ACountNo + "','" + BranchName + "','" + IFSCode + "','" + Name + "','" + dojdate + "','" + Department + "','" + Designation + "','" + District + "','" + Location + "'," + CTC + "," + ActualSalary + ", " + Monthly_Basic + "," + Monthly_HRA + "," + Monthly_Conveyance + "," + Monthly_Medical_Allowance + "," + Monthly_CCA + "," + Monthly_Total + "," + Gross_Basic + "," + Gross_HRA + "," + Gross_Conveyance + "," + Gross_MedicalAllowance + "," + Gross_CCA + "," + Gross_Total + "," + EE_ESI + "," + EE_PF + "," + ER_ESI + "," + Admin + ", " + ER_PF + "," + TDS + "," + CUG_HSRP_DED_OTH + "," + SCN_DED + "," + deduction + "," + Incentives + ",'" + CompanyName + "',getdate(),  " + UploadedBy + " ,  'Y', " + state_id + ");");
