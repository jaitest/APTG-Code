...
{
    public partial class Third_Plate : System.Web.UI.Page
{
    int UserType1;
   ...
   // HSRPAuthDate    OrderDate.MaxDate = DateTime.Parse(MaxDate);
    ...
    private void Export()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("[Business_report_AssignmentVS3rdplateProduction_Summary]", con);
           ...
           row.Cells.Add(new WorksheetCell("3rdPlate Report", "HeaderStyle3"));
            ...
            AddNewCell(row, HSRPAuthDate.SelectedDate.ToString("dd/MM/yyyy"), "HeaderStyle2", 1);
    ...
    protected void btndetails_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           // SqlConnection con = new SqlConnection(TempStringConnection);
            ...
            cmd = new SqlCommand("[Business_report_AssignmentVS3rdplateProduction_Summary]", con);
    ...
    protected void grdthirdplate_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
           ...
           // DateTime ReportDate2 = OrderDate.SelectedDate;
            ...
            if (state == "9" || state == "11")
            {
                hsrprecord_creationdate = "08-oct-2015";
                ...
                if (e.CommandName == "Day1")
                {
                    ...
                    Label embcenter = (Label)oItem.Cells[1].FindControl("lblembname");
                    embcentername = embcenter.Text.ToString();
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode, OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo, PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate, RecievedAtAffixationDateTime from hsrprecords a ,rtolocation b where a.HSRP_StateID='" + state + "' and a.rtolocationid=b.rtolocationid and convert(date,erpassigndate,103)='" + ReportDate3 + "' and a.rtolocationid=b.rtolocationid	 and embcentername='" + embcentername + "' and vehicletype in ('LMV','MCV/HCV/TRAILERS','THREE WHEELER','LMV(Class)') and StickerMandatory='Y'  and hsrprecordid not in(select distinct HSRPRecordID from StickerLog where convert(date,SaveDate)<'" + ReportDate3 + "') and hsrprecord_creationdate >'" + hsrprecord_creationdate + "'");
                }
                ...
                else if (e.CommandName == "Day2")
                {
                    ...
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode,hsrp_rear_lasercode, OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate, RecievedAtAffixationDateTime  from hsrprecords a ,rtolocation b where a.HSRP_StateID='" + state + "' and a.rtolocationid=b.rtolocationid	 and convert(date,erpassigndate,103)=dateadd(day,-1,'" + ReportDate3 + "') and embcentername='" + embcentername + "' and vehicletype in ('LMV','MCV/HCV/TRAILERS','THREE WHEELER','LMV(Class)') and  StickerMandatory='Y' and hsrprecordid not in(select distinct HSRPRecordID from StickerLog where convert(date,SaveDate)<'" + ReportDate3 + "') and hsrprecord_creationdate >'" + hsrprecord_creationdate + "'");
                }
                ...
                else if (e.CommandName == "Day4")
                {
                    ...
                    Label embcenter = (Label)oItem.Cells[1].FindControl("lblembname");
                    embcentername = embcenter.Text.ToString();
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode, OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo, PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate, RecievedAtAffixationDateTime from hsrprecords a ,rtolocation b  where a.HSRP_StateID='" + state + "'and a.rtolocationid=b.rtolocationid and convert(date,erpassigndate,103)=dateadd(day,-3,'" + ReportDate3 + "') and embcentername='" + embcentername + "' and vehicletype in ('LMV','MCV/HCV/TRAILERS','THREE WHEELER','LMV(Class)') and StickerMandatory='Y' and hsrprecordid not in(select distinct HSRPRecordID from StickerLog where convert(date,SaveDate)<'" + ReportDate3 + "') and hsrprecord_creationdate >'" + hsrprecord_creationdate + "'");
                }
            ...
            else
            {
                ...
                if (e.CommandName == "Day1")
                {
                    ...
                    Label embcenter = (Label)oItem.Cells[1].FindControl("lblembname");
                    embcentername = embcenter.Text.ToString();
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode, OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo, PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate, RecievedAtAffixationDateTime from hsrprecords a ,rtolocation b where a.HSRP_StateID='" + state + "' and a.rtolocationid=b.rtolocationid and convert(date,erpassigndate,103)='" + ReportDate3 + "' and a.rtolocationid=b.rtolocationid	 and embcentername='" + embcentername + "' and vehicletype in ('LMV','MCV/HCV/TRAILERS','THREE WHEELER','LMV(Class)') and StickerMandatory='Y'  and hsrprecordid not in(select distinct HSRPRecordID from StickerLog where convert(date,SaveDate)<='" + ReportDate3 + "')");
                }
