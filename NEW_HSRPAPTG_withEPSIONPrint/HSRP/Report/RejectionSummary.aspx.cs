...
{
    public partial class RejectionSummary : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "Rejection Summary" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
               ...
               // row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                ...
                //row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
               // row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                row.Cells.Add(new WorksheetCell("Report From Date :", "HeaderStyle2"));                
                row.Cells.Add(new WorksheetCell(OrderDate.SelectedDate.ToString("dd/MM/yyyy"), "HeaderStyle2"));

                row.Cells.Add(new WorksheetCell("Report To Date :", "HeaderStyle2"));
                row.Cells.Add(new WorksheetCell(HSRPAuthDate.SelectedDate.ToString("dd/MM/yyyy"), "HeaderStyle2"));
                ...
                row.Cells.Add(new WorksheetCell("Orders", "HeaderStyle"));
               // row = sheet.Table.Rows.Add();
                ...
                SQLString = "select rtolocationname,count(*) as Orders  from [rejectplatEntry] b,RTOLocation c  where b.rtolocationid=c.RTOLocationID and b.hsrp_stateid='" + DropDownListStateName.SelectedValue.ToString() + "' and EntryDate between '" + FromDate + "' and '" + ToDate + "' group by rtolocationname order by 1";
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count;i++) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["rtolocationname"].ToString(), DataType.String, "HeaderStyle1"));
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["Orders"].ToString(), DataType.String, "HeaderStyle1"));
        ...
        protected void btnSummary_Click(object sender, EventArgs e)
        {
               try
            {
                ...
                row.Cells.Add(new WorksheetCell("Reject Front Laser Code ", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Reject Rear Laser Code", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Vehicle Reg No", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Remarks", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Rejection Mode", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("New Front Laser Code", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("New Rear Laser Code", "HeaderStyle"));
               ...
               // row = sheet.Table.Rows.Add();
                ...
                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dtrows["RejectionStatus"].ToString(), DataType.String, "HeaderStyle1"));
