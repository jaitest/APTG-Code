<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PIPVSReceived.aspx.cs" Inherits="HSRP.Report.PIPVSReceived" %>
...
<script type="text/javascript">
    ...
    <table style="height: 51px;" width="90%">
        <tr>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  ControlToValidate="DropDownListStateName" ErrorMessage="Please Select State" InitialValue="--Select State--"></asp:RequiredFieldValidator>  
             <td style="width: 50px; height: 40px;"> 
                  <asp:Label ID="label2" runat="server" Font-Bold="True" ForeColor="Black"  Visible="true"
         ...
         &nbsp;&nbsp;
                                                <td style="height: 40px; width:20px; padding:8px;"> <asp:Label Text="From:" runat="server" 
                                                        ID="labelDate" Font-Bold="True" 
                                                        ForeColor="Black" /> </td>
                                                <td style="height: 40px; width: 195px;" valign="middle">
                                                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                    <ContentTemplate>
                                                                        <ComponentArt:Calendar ID="OrderDatefrom" runat="server" PickerFormat="Custom" PickerCustomFormat="dd/MM/yyyy"
                                                                        ControlType="Picker" PickerCssClass="picker" Height="22px" Width="120px">
                                                                            <ClientEvents>
                                                                                <SelectionChanged EventHandler="OrderDatefrom_OnDateChange" />
                                                                            </ClientEvents>
                                                                        </ComponentArt:Calendar>&nbsp;&nbsp;
                                                                        <img id="calendar_from_button"  alt="" onclick="OrderDatefrom_OnClick()" onmouseup="OrderDatefrom_OnMouseUp()" class="calendar_button" src="../images/btn_calendar.gif" style="margin:-6px;" />
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </td>
                                                <td style="height: 40px" width="30">
                                                    <asp:Button ID="btnexport" runat="server" onclick="btnexport_Click" Text="PIPVSReceived" 
                                                        Font-Bold="True" ForeColor="#3333FF" Height="21px" Width="180px"/>
                                                </td>
                                                 <td style="height: 40px">
                                                    <asp:Button ID="btnDetail" runat="server" Text="Detail" 
                                                        Font-Bold="True" ForeColor="#3333FF" Height="21px" Width="65px" OnClick="btnDetail_Click" />
                                                </td>
                                           
                                               <td style="height: 40px" width="30">
                                                    <asp:Button ID="btnproctiondispatch" runat="server"  Text="PIPVSReceived(Detail)"  Visible="True"
                                                        Font-Bold="True" ForeColor="#3333FF" Height="21px" Width="180px" OnClick="btnproctiondispatch_Click"/>
                                                </td>
                                              
                                                 <td style="height: 40px" width="50">
                                                    <asp:Button ID="btnnDetails" runat="server"  Text="Detail"  Visible="True"
                                                        Font-Bold="True" ForeColor="#3333FF" Height="21px" Width="65px" OnClick="btnnDetails_Click"/>
                                                </td>
                 ...
                 <Columns>
                                ...
                                <%--     <asp:BoundField HeaderText="Embossing Center" DataField="Embossing Center" />
                                                    ...
                                                    <asp:BoundField HeaderText="Day3" DataField="Day3" />
                                                     <asp:BoundField HeaderText="Day4" DataField="Day4" />--%>
                                                   <%-- <asp:BoundField HeaderText="Day5orMore" DataField="Day5 or More" />--%>
                                       <asp:TemplateField HeaderText="Zonal Manager" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Embossing Center" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="Day2Date" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblDay2Date" runat="server" Text=<%#Eval("Day2Date")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>

                      <asp:TemplateField HeaderText="Day3Date" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblDay3Date" runat="server" Text=<%#Eval("Day3Date")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>

                      <asp:TemplateField HeaderText="Day4Date" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblDay4Date" runat="server" Text=<%#Eval("Day4Date")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>

                                           <asp:TemplateField HeaderText="Opening" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblopening" runat="server" Text=<%#Eval("Opening")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>

                                       <asp:TemplateField HeaderText="Today Dispatch" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblTodayDispatch" runat="server" Text=<%#Eval("TodayDispatch")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                           <asp:TemplateField HeaderText="Today Received" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblTodayReceived" runat="server" Text=<%#Eval("TodayReceived")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                       <asp:TemplateField HeaderText="PendingforReceiving" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblPFD" runat="server" Text=<%#Eval("PendingforReceiving")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                           

                                   <asp:TemplateField HeaderText="Day1" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Day2" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="Day3" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Day4" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Day5orMore" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                ...
                <AlternatingRowStyle BackColor="White" />
                 <Columns>
                                ...
                                <%--     <asp:BoundField HeaderText="Embossing Center" DataField="Embossing Center" />
                                      ...
                                      <asp:TemplateField HeaderText="RTOLocation" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                       ...
                                       <asp:TemplateField HeaderText="Today Dispatch" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblToDayProd" runat="server" Text=<%#Eval("TodayDispatch")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                           <asp:TemplateField HeaderText="TodayReceivved" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblTodayReceivved" runat="server" Text=<%#Eval("TodayReceived")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                              <asp:TemplateField HeaderText="PendingforReceiving" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <asp:Label ID="lblPendingforReceiving" runat="server" Text=<%#Eval("PendingforReceiving")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                   ...
                                   <asp:TemplateField HeaderText="Day1" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <%--<asp:Label ID="lblDay1" runat="server" Text=<%#Eval("Day1")%>></asp:Label>--%>
                                                 <asp:LinkButton ID="lblDay1" CommandName="Day1" runat="server" Text=<%#Eval("Day1") %>>LinkButton</asp:LinkButton>
                                                <asp:Label ID="lblDay1Date" runat="server" Text=<%#Eval("Day1Date")%> style="display:none;"></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Day2" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                              <%-- <asp:Label ID="lblDay2" runat="server" Text=<%#Eval("Day2")%>></asp:Label>--%>
                                                 <asp:LinkButton ID="lblDay2" CommandName="Day2" runat="server" Text=<%#Eval("Day2") %>>LinkButton</asp:LinkButton>
                                                <asp:Label ID="lblDay2date" runat="server" Text=<%#Eval("Day2date")%> style="display:none;"></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                               <asp:TemplateField HeaderText="Day3" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                               <%--<asp:Label ID="lblDay3" runat="server" Text=<%#Eval("Day3")%>></asp:Label>--%>
                                                 <asp:LinkButton ID="lblDay3" CommandName="Day3" runat="server" Text=<%#Eval("Day3") %>>LinkButton</asp:LinkButton>
                                                <asp:Label ID="lblDay3Date" runat="server" Text=<%#Eval("Day3Date")%> style="display:none;"></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                             <asp:TemplateField HeaderText="Day4" HeaderStyle-ForeColor="white">
                                            <ItemTemplate>
                                            <%--   <asp:Label ID="lblDay4" runat="server" Text=<%#Eval("Day4")%>></asp:Label>--%>
                                                 <asp:LinkButton ID="lblDay4" CommandName="Day4" runat="server" Text=<%#Eval("Day4") %>>LinkButton</asp:LinkButton>
                                                <asp:Label ID="lblDay4Date" runat="server" Text=<%#Eval("Day4Date")%> style="display:none;"></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                               <asp:LinkButton ID="lbnDay5orMore" CommandName="Day5orMore" runat="server" Text=<%#Eval("Day5orMore") %>>LinkButton</asp:LinkButton>
                                                <asp:Label ID="lblDay5date" runat="server" Text=<%#Eval("Day5date")%> style="display:none;"></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
