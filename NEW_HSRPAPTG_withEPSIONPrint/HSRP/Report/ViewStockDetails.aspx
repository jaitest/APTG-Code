<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewStockDetails.aspx.cs" Inherits="HSRP.Report.ViewStockDetails" %>
    ...
    <table style="height: 51px;" width="80%">
        <tr>
            ...
            <td style="height: 40px;" width="80">       
                    ...
                    <asp:DropDownList ID="ddlEmbossingCenters" runat="server" Height="22px" Width="170px">
