...
{
    public partial class CCACalculation_Report : System.Web.UI.Page
    {
        ...
        {
            string currentMonth = Utils.getDataSingleValue("select datepart(mm, getdate()) as CurrMonth", CnnString, "CurrMonth");
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //    SQLString = "Report_Monthly_Affixation '" + ReportMonth + "','" + ReportYear + "','" + HSRPStateID + "'";
                //}

                SQLString = "Business_Report_CCACalculation '" + ReportMonth + "','" + ReportYear + "','" + intHSRPStateID + "'";
                ...
                if (dt.Tables[0].Rows.Count > 0)
                {
                    ...
                    row.Cells.Add(new WorksheetCell("Card Name", "HeaderStyleData1"));
                    row.Cells.Add(new WorksheetCell("Payment Mode", "HeaderStyleData1"));
                    row.Cells.Add(new WorksheetCell("Total Order", "HeaderStyleData1"));
                    row.Cells.Add(new WorksheetCell("Total Amount", "HeaderStyleData1"));
                    row.Cells.Add(new WorksheetCell("Total TDS Amount", "HeaderStyleData1"));
                    row.Cells.Add(new WorksheetCell("Share 1 TDS Amount", "HeaderStyleData1"));
                    row.Cells.Add(new WorksheetCell("Share 2 TDS Amount", "HeaderStyleData1"));
                    row.Cells.Add(new WorksheetCell("TDS %", "HeaderStyleData1"));
                    ...
                    foreach (DataRow dtrows in dt.Tables[0].Rows) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dtrows["Card Name"].ToString(), "HeaderStyleData2"));
                        row.Cells.Add(new WorksheetCell(dtrows["Payment Mode"].ToString(), DataType.Number, "HeaderStyleData2"));
                        row.Cells.Add(new WorksheetCell(dtrows["Total Order"].ToString(), DataType.Number, "HeaderStyleData2"));
                        row.Cells.Add(new WorksheetCell(dtrows["Total Amount"].ToString(), DataType.Number, "HeaderStyleData2"));
                        row.Cells.Add(new WorksheetCell(dtrows["Total TDS Amount"].ToString(), DataType.Number, "HeaderStyleData2"));
                        row.Cells.Add(new WorksheetCell(dtrows["Share 1 TDS Amount"].ToString(), DataType.Number, "HeaderStyleData2"));
                        row.Cells.Add(new WorksheetCell(dtrows["Share 2 TDS Amount"].ToString(), DataType.Number, "HeaderStyleData2"));
                        row.Cells.Add(new WorksheetCell(dtrows["TDS %"].ToString(), DataType.Number, "HeaderStyleData2"));
