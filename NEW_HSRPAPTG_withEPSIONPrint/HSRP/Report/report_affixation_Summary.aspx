<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="report_affixation_Summary.aspx.cs" Inherits="HSRP.DLReports.report_affixation_Summary" %>
        ...
        <tr>
            <td valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Affixation Report</span>
                                    </td>
                                       ...
                                       <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional">
                                            ...
                                            <Triggers>
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Preview" ToolTip="Please Click for Report" Width="100px"
                                                        class="button" OnClick="btnExportToExcel_Click" />
                                                </td>

                                                <td></td>
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnDetails" runat="server" Text="Export Excel" ToolTip="Please Click for Report" Width="100px"
                    ...
                    <br />
                    <td align="center">
                     <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="false"
                            ShowHeader="true" Width="100%" BackColor="White" BorderColor="#FFCC99" BorderStyle="Solid" BorderWidth="1px">
                            <AlternatingRowStyle BackColor="White" />
                        <%--<asp:GridView ID="GridView1" runat="server" BackColor="#669999" BorderColor="White" AutoGenerateColumns="false"  BorderStyle="Solid" ForeColor="Yellow">--%>
                    <Columns>
                        ...
                        <asp:BoundField ReadOnly="True" HeaderText="Vehicle Type" DataField="Vehicle Type" SortExpression="Vehicle Type"/>
                        <asp:BoundField HeaderText="Opening"  DataField="Opening" SortExpression="Opening"/>                          
                        <asp:BoundField ReadOnly="True" HeaderText="Today Received" DataField="Today Received" SortExpression="Today Received"/>
                        <asp:BoundField HeaderText="Today Affixation" DataField="Today Affixation" SortExpression="Today Affixation"/>                        
                        <asp:BoundField HeaderText="Closing Balance" DataField="Closing Balance" SortExpression="Closing Balance"/>              
                    </Columns>
