...
//             }
         ...
         { //Define arbitrary function to run desired DHTML Window widget codes
             ...
             googlewin.onclose = function () {
                 window.location = 'ComplainReport.aspx';
                  ...
                  //window.open("ViewComplainReport.aspx?strComplaintID=" + a, 'View Complaint', 'height=400px,width=900px,resize=1,scrolling=1,center=1');
                 // return true;
         }
         ...
         function AddNewPopAction(z) { //Define arbitrary function to run desired DHTML Window widget codes
             ...
             //googlewin = dhtmlwindow.open("googlebox", "iframe", "UpdateSubmitRequest.aspx?StateId=" + i + "&RTOID=" + j + "&SubmitID=" + k, "Update Request", "width=900px,height=400px,resize=1,scrolling=1,center=1", "recal")
             // Change Window for ComplainrepoetResolution ----------------------
            ...
            //window.open("ComplainReportResolution.aspx?strComplaintID=" + z, 'Add Resolution', 'height=400px,width=900px,resize=1,scrolling=1,center=1');
             return true;
         }
        </script>
                                    ...
                                    <td>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:LinkButton ID="ViewRequest" runat="server" Text="View"  CommandName="ViewUpdateRquest" OnClick="Linkbutton1_Click"></asp:LinkButton>
                                                ...
                                                <ItemTemplate>
                                                <asp:LinkButton ID="AddResolution" runat="server" Text="Action"  CommandName="ViewUpdateRquest" OnClick="Linkbutton2_Click"></asp:LinkButton>
                                                </ItemTemplate>
                                                </asp:TemplateField>
