...
{
    public partial class DailyCashCollectionRTOLocationWise_WithDateNew : System.Web.UI.Page
    {
        ...
        private void ExportRecordExcel(Workbook book, DataTable dt, string RtoName = null, string RtoCode = null)
        {
            ...
            try
            {
                ...
                row.Cells.Add(new WorksheetCell("HSRPRecord_AuthorizationNo", "HeaderStyle6"));
                    ...
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                      ...
                      //  row.Cells.Add(new WorksheetCell(dtrows["embdate"].ToString(), DataType.String, "HeaderStyle"));
                       // row.Cells.Add(new WorksheetCell(dtrows["AffixDate"].ToString(), DataType.String, "HeaderStyle"));
                        ...
                        {
                            row.Cells.Add(new WorksheetCell(Math.Round(Convert.ToDecimal(dtrows["NetAmount"].ToString())).ToString(), DataType.Number, "HeaderStyle6"));
