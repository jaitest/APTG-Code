<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DealerLedger.aspx.cs" Inherits="HSRP.TG.DealerLedger" %>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td valign="middle" visible="true" class="form_text" nowrap="nowrap">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="ddlBothDealerHHT" InitialValue="--Select--" runat="server" ErrorMessage="Please Select Dealer"></asp:RequiredFieldValidator>
                                    </td>
                                    <td valign="middle" visible="true" class="form_text" nowrap="nowrap">
                                        &nbsp;&nbsp;
