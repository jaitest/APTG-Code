...
namespace HSRP.TG
{
    ...
    public partial class TGGetVehicleRegNoManully : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            ...
            try
            {
                ...
                string AuthData = objTgService.GetHSRPAuthorizationno(txtAuthono.Text);
                if (AuthData == "1")
                {
                ...
                if (e.CommandName == "Update")
                {
                    ...
                    if (hsrprecordid != "")
                    {
                        ...
                        if (i > 0)
                        {
                            lblErrMsg.Text = "";
                            lblSucMess.Text = "Record Updated Successfully";
                            Response.Redirect("TGGetVehicleRegNoManully.aspx?msg="+ lblSucMess.Text);
                        }
                        else
                        {
                            lblSucMess.Text = "";
                            lblErrMsg.Text = "Record Not Updated";
                            Response.Redirect("TGGetVehicleRegNoManully.aspx?msg=" + lblErrMsg.Text);
                        }
