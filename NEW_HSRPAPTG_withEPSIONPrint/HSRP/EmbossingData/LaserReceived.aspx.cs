        ...
        protected void btnUpdate_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                if (chk.Checked == true)
                {
                    ...
                    if (HSRPStateID == "11")
                    {
                        string SMSTexttg = string.Empty;

                        //string ResponseTG = string.Empty;
                        //string ResponseTG=objTGService.UpdateHSRPAvailableAtOffice(strAuthNo, DateTime.Now.ToString("dd/MM/yyyy"));
                        // Utils.ExecNonQuery("update hsrprecords set APwebservicerespEmb='" + ResponseTG + "',APwebservicerespEmbdate=Getdate(),  where HSRPRecordID='" + strRecordId + "' and vehicleregno='" + lblVehicleRegNo.Text + "'", CnnString);
                        if (PhoneNumber.Length > 0)
                        {

                            if (RTOLocationID == "827" || RTOLocationID == "828" || RTOLocationID == "829" || RTOLocationID == "830" || RTOLocationID == "831" || RTOLocationID == "832" || RTOLocationID == "834" || RTOLocationID == "836" || RTOLocationID == "863" || RTOLocationID == "864" || RTOLocationID == "865")
                            {

                                SMSTexttg = "Your H.S.R.P. for " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center Between 2 PM - 5.00 PM for Affixation,no extra fitting charge HSRP Team";
                            }

                            else if (RTOLocationID == "833" || RTOLocationID == "835" || RTOLocationID == "838" || RTOLocationID == "839" || RTOLocationID == "840" || RTOLocationID == "841" || RTOLocationID == "842" || RTOLocationID == "844" || RTOLocationID == "846" || RTOLocationID == "847" || RTOLocationID == "848" || RTOLocationID == "849" || RTOLocationID == "850" || RTOLocationID == "851" || RTOLocationID == "852" || RTOLocationID == "853" || RTOLocationID == "854" || RTOLocationID == "855" || RTOLocationID == "856" || RTOLocationID == "857" || RTOLocationID == "858" || RTOLocationID == "859" || RTOLocationID == "860" || RTOLocationID == "861" || RTOLocationID == "862" || RTOLocationID == "867" || RTOLocationID == "868" || RTOLocationID == "869" || RTOLocationID == "870" || RTOLocationID == "871" || RTOLocationID == "872" || RTOLocationID == "873" || RTOLocationID == "874")
                            {

                                SMSTexttg = "Your H.S.R.P. for " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center Between 10 AM - 5.00 PM for Affixation,no extra fitting charge HSRP Team";
                            }
                            else
                            {
                                SMSTexttg = "Your H.S.R.P. for " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center Between 2 PM- 5.00 PM for Affixation,no extra fitting charge HSRP Team";
                            ...
                            string SMSCheck = "Select top 1 HSRPRecordID from TSSMSDetail where HSRPRecordID='" + strRecordId + "'";
                            DataTable HSRPRecordID = Utils.GetDataTable(SMSCheck, CnnString);
                            if (HSRPRecordID.Rows.Count == 0)
                            {
                                sendURL = "http://quick.smseasy.in:8080/bulksms/bulksms?username=sse-tlhsrp1&password=tlhsrp1&type=0&dlr=1&destination=" + PhoneNumber + "&source=HSRPTS&message=" + SMSTexttg;
                                //sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-tlhsrp1&password=tlhsrp1&type=0&dlr=1&destination=" + PhoneNumber + "&source=TSHSRP&message=" + SMSText;
                                ...
                                sr.Close();
                                myResponse.Close();
                                SqlQuery = "insert into TSSMSDetail (HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode,SMSTEXT) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + PhoneNumber + "','" + result + "','" + SMSText + "')";
                                Utils.ExecNonQuery(SqlQuery, CnnString);
                            }
                        }
                        else
                        {
                            string getpaymentmobile = "Select isnull(paymentmobile,0) as paymentmobile from hsrprecords where Addrecordby='onlinedealer' and hsrprecordid='" + strRecordId + "'";
                            DataTable dt = Utils.GetDataTable(getpaymentmobile, CnnString);
                            if (dt.Rows.Count > 0)
                            {
                                string paymentmobile = dt.Rows[0]["paymentmobile"].ToString();

                                if (paymentmobile.Length > 0)
                                {
                                    ...
                                    if (HSRPRecordID.Rows.Count == 0)
                                    {
                                        ...
                                        sr.Close();
                                        myResponse.Close();
                                        SqlQuery = "insert into TSSMSDetail (HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode,SMSTEXT) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + PhoneNumber + "','" + result + "','" + SMSTexttg + "')";
                                        Utils.ExecNonQuery(SqlQuery, CnnString);
                                    }
                                }
                                else
                                {
                                    ...
                                    SqlQuery = "insert into TSSMSDetail (HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode,SMSTEXT) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + paymentmobile + "','" + result + "','" + SMSTexttg + "')";
                                    Utils.ExecNonQuery(SqlQuery, CnnString);
                                }
                            }
                            else
                    ...
                    {
                        string SMSTextap = string.Empty;
                       
                            string Responseap = objAPService.UpdateHSRPAvailableAtOffice(strAuthNo, DateTime.Now.ToString("dd/MM/yyyy"));
                            Utils.ExecNonQuery("update hsrprecords set apwebservicerespplatatoffice='" + Responseap + "',apwebservicerespplatatofficedatetime=Getdate() where HSRPRecordID='" + strRecordId + "' and vehicleregno='" + lblVehicleRegNo.Text + "'", CnnString);
                            if (PhoneNumber.Length > 0)
                            {                               
                                DataTable dtsms = Utils.GetDataTable("Select smstiming from rtolocation where HSRP_StateID=9 and activestatus='Y' and rtolocationid='" + RTOLocationID + "'", CnnString);
                                string smstiming = string.Empty;

                                if (dtsms.Rows.Count > 0)
                                {
                                    smstiming = dtsms.Rows[0]["smstiming"].ToString();
                                }
                                else
                                {
                                ...
                                if (rtolocationid == "767")
                                {
                                    //SMSTextap = "Your H.S.R.P. for " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center Between 10.30 AM - 5.00 PM for Affixation. HSRP Team";
                                    SMSTextap = "Your H.S.R.P. for " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center Between 2:00 PM - 6.00 PM for Affixation, no extra fitting charge HSRP Team";
                                }
                                else if (rtolocationid == "744")
                                {                                    
                                    SMSTextap = "Your HSRP for " + reg_no + " is ready for Affixation, please visit Gannavaram RTO office between 2:00 to 5:30 PM for affixation, no extra fitting charge –HSRP Team";
                                }
                                ...
                                else
                                {
                                    ...
                                    SMSTextap = "Your H.S.R.P. for " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center Between " + smstiming + " for Affixation,no extra fitting charge HSRP Team";
                                }
                                ...
                                if (HSRPRecordID.Rows.Count == 0)
                                {
                                    ...
                                    SqlQuery = "insert into APSMSDetail (HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode,SMSTEXT) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + PhoneNumber + "','" + result + "','" + SMSTextap + "')";
                                    Utils.ExecNonQuery(SqlQuery, CnnString);
                                }
                            }
            ...
            //{
            //    Utils.PopulateDropDownList(dropdownChallanNo, SQLString.ToString(), CnnString, "--Select Challan No--");
            //    dropdownChallanNo.ClearSelection();
            //}
            //else
            //{
            //    dropdownChallanNo.ClearSelection();
