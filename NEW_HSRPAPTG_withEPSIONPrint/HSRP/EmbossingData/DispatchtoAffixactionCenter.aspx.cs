    ...
    public partial class DispatchtoAffixactionCenter : System.Web.UI.Page
    {
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                book.Properties.Title = "AC Performance Report";
                ...
                WorksheetCell cell = row.Cells.Add("AC Performance Report");
                ...
                AddNewCell(row, OrderDate.SelectedDate.ToString("dd/MM/yyyy"), "HeaderStyle2", 1);
