<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="StockDetail.aspx.cs" Inherits="HSRP.Transaction.StockDetail" %>
                        ...
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td valign="middle">                                        
                                                <asp:DropDownList ID="ddlEmbossingCenters" Width="160px" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="ddlEmbossingCenters_SelectedIndexChanged">
                                    ...
                                    <%--<td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:Label Text="Warehouse Center:" Visible="false" runat="server" ID="Label2"  />
                                        &nbsp;&nbsp;
                                    </td>
                                     ...
                                     <td valign="middle">                                        
                                                <asp:DropDownList ID="ddlwherehousecenter"  Width="160px" runat="server"  AutoPostBack="True" Visible="false">
                                                </asp:DropDownList> 
                                    </td>
                                    &nbsp;&nbsp;--%>
