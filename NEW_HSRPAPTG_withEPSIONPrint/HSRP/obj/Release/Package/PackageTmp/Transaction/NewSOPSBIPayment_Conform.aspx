<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="NewSOPSBIPayment_Conform.aspx.cs" Inherits="HSRP.Transaction.NewSOPSBIPayment_Conform" %>
        ...
        <tr>
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" onmouseup="OrderDate_OnMouseUp()" align="left">
                                        ...
                                        <img id="calendar_from_button" tabindex="3" alt="" onclick="OrderDate_OnClick()"
                                            onmouseup="OrderDate_OnMouseUp()" class="calendar_button"  src="../images/btn_calendar.gif" /><asp:Button ID="btnGO" Width="58px" runat="server" Visible="true" Text="GO" ToolTip="Please Click for Report"
                                            class="button" OnClientClick=" return validate()" OnClick="btnGO_Click" />
                                        
                                    </td>
                                    <td><asp:Button ID="btnSync" runat="server" class="button" Text="Confirm" Visible="true" OnClick="btnSync_Click" /></td>
                                    <td valign="middle" align="left">
                                        &nbsp;</td>
                                     <td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:Label Text="Payment File Name:" runat="server" ID="labelOrganization" />
                                        &nbsp;&nbsp;
                                    </td>
                                    <td valign="middle">
                                        <asp:DropDownList AutoPostBack="true" Visible="true" CausesValidation="false" ID="DropDownListStateName"
                                            runat="server" DataTextField="OrderNo" DataValueField="OrderNo" OnSelectedIndexChanged="DropDownListStateName_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        &nbsp;</td>
            ...
            <tr>
                ...
                <ItemStyle Width="10%" />
                                                    ...
                                                    <%--<asp:BoundField HeaderText="Transaction Date" ItemStyle-HorizontalAlign="Center" DataField="TransactionDate" />--%>
                                                    <asp:BoundField HeaderText="Ref No" ItemStyle-HorizontalAlign="Center" DataField="RefNo" />
                                                    <asp:BoundField HeaderText="Chk No" ItemStyle-HorizontalAlign="Center" DataField="ChNo" />
                                                    <asp:BoundField HeaderText="HsrpNo" ItemStyle-HorizontalAlign="Center" DataField="HsrpNo" />
                                                    <asp:BoundField HeaderText="Amount" ItemStyle-HorizontalAlign="Center" DataField="Amount" />
                                                     <asp:BoundField HeaderText="UPLOADFILENAME" ItemStyle-HorizontalAlign="Center" DataField="UPLOADFILENAME" />
