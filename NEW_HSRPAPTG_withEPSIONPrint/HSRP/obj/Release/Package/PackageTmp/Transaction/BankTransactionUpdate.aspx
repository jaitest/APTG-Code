<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankTransactionUpdate.aspx.cs"    Inherits="HSRP.Master.BankTransactionUpdate" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function DepositDate1_OnDateChange(sender, eventArgs) {
            var fromDate = DepositDate1.getSelectedDate();
            CalendarDepositDate1.setSelectedDate(fromDate);

        }

        function DepositDate1_OnChange(sender, eventArgs) {
            var fromDate = CalendarDepositDate1.getSelectedDate();
            DepositDate1.setSelectedDate(fromDate);

        }

        function DepositDate1_OnClick() {
            if (CalendarDepositDate1.get_popUpShowing()) {
                CalendarDepositDate1.hide();
            }
            else {
                CalendarDepositDate1.setSelectedDate(DepositDate1.getSelectedDate());
                CalendarDepositDate1.show();
            }
        }

        function DepositDate1_OnMouseUp() {
            if (CalendarDepositDate1.get_popUpShowing()) {
                event.cancelBubble = true;
                event.returnValue = false;
                return false;
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("<%=ddldisipositeLocation.ClientID%>").value == "0") {
            ...
            if (document.getElementById("<%=DropDownApprovedby.ClientID%>").value == "0") {
                alert("Please  Select Approved By ");
                document.getElementById("<%=DropDownApprovedby.ClientID%>").focus();
                return false;
            }
            ...
            <fieldset>
                ...
                <div style="width: 100%; margin: 0px auto 0px auto">
                    ...
                    <table border="0" align="right" style="height: 348px; width: 85%;">
                        <tr>
                            <td class="style4">Deposit Date <span class="alert">* </span>
                            </td>
                            <td>
                                ...
                                <table id="Table2" runat="server" style="margin-left: 8px;" align="left" cellspacing="0"
                                    ...
                                    <tr>
                                        <td valign="top" onmouseup="DepositDate1_OnMouseUp()">
                                            <ComponentArt:Calendar ID="DepositDate1" runat="server" PickerFormat="Custom"
                                                PickerCustomFormat="dd/MM/yyyy" TabIndex="2"
                                                ControlType="Picker" PickerCssClass="picker" Visible="true">
                                                <ClientEvents>
                                                    <SelectionChanged EventHandler="DepositDate1_OnDateChange" />
                                                </ClientEvents>
                                            </ComponentArt:Calendar>
                                        </td>
                                        <td style="font-size: 10px;">&nbsp;
                                        ...
                                        <td valign="top">
                                            <img id="calendar_from_button1" alt="" onclick="DepositDate1_OnClick()"
                                                onmouseup="DepositDate1_OnMouseUp()" class="calendar_button" src="../images/btn_calendar.gif" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="style4">Bank Name <span class="alert">* </span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="style4">Branch Name
                        <span class="alert">* </span>
                            </td>
                            <td>

                                <asp:TextBox ID="txtBranchName" runat="server" class="form_textbox12" MaxLength="30" TabIndex="6"></asp:TextBox>

                            </td>
                        </tr>

                        <tr>
                            <td class="style4">Deposit Amount <span class="alert">* </span>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBoxDepositAmount" class="form_textbox12" runat="server"
                                    onkeypress="return isNumberKey(event)" MaxLength="30" TabIndex="7"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style4">Deposited by <span class="alert">* </span>
                            </td>
                            <td>

                                <asp:TextBox ID="TextBoxDepositby" class="form_textbox12" runat="server"
                                    MaxLength="30" onkeypress="return ischarKey(event)" TabIndex="8"></asp:TextBox>
                            </td>
                        </tr>
                        
                        <tr>
                            <td class="style4">Rto Location<span class="alert">* </span></td>
                            <td>

                                <asp:DropDownList ID="ddlLocation" runat="server"
                                    DataTextField="RTOLocationName" DataValueField="RTOLocationID" Height="20px"
                                    Style="margin-left: 10px" Width="163px" TabIndex="9">
                                </asp:DropDownList>
                            </td>
                        </tr>
                      
                        <tr>
                            <td class="style4">Deposited Location<span class="alert">* </span></td>
                            <td>

                                <asp:DropDownList ID="ddldisipositeLocation" runat="server"
                                    DataTextField="RTOLocationName" DataValueField="RTOLocationID" Height="20px"
                                    Style="margin-left: 10px" Width="163px" TabIndex="9">
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td class="style4">
                                <asp:Label ID="lbletaprocess" runat="server" Text="ETA Process" Visible="false"></asp:Label>

                            </td>
                            <td>
                                <asp:Label ID="txtetaprocess" runat="server" Text="ETA Process" class="form_textbox12" TabIndex="10" Width="160px" Visible="false"></asp:Label>
                                <%-- <asp:TextBox ID="txtetaprocess" class="form_textbox12" runat="server" 
                        ...
                        <tr>
                            <td class="style4">
                                <asp:Label ID="lblentrytype" runat="server" Text="Entry Type" Visible="false"></asp:Label>

                            </td>
                            <td>
                                <asp:Label ID="txtentrytype" runat="server" Text="Entry Type" class="form_textbox12" MaxLength="30" TabIndex="11" Width="160px" Visible="false"></asp:Label>
                                <%-- <asp:TextBox ID="txtentrytype" class="form_textbox12" runat="server" 
                            MaxLength="30" TabIndex="10" ></asp:TextBox>--%>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="style4">
                                <asp:Label ID="lbloldtransationid" runat="server" Text="Old TransactionID" Visible="false"></asp:Label>

                            </td>
                            <td>
                                <asp:TextBox ID="txtoldtrnid" class="form_textbox12" runat="server" Visible="false"
                        ...
                        <tr>
                            <td class="style4">
                                <asp:Label ID="lbldealerID" runat="server" Text="DealerID" Visible="false"></asp:Label>

                            </td>
                            <td>

                                <asp:Label ID="txtdealer" runat="server" Text="DealerID" class="form_textbox12" MaxLength="30" TabIndex="13" Width="160px" Visible="false"></asp:Label>

                                <%-- <asp:TextBox ID="txtdealer" class="form_textbox12" runat="server" 
                            MaxLength="30" TabIndex="10" ></asp:TextBox>--%>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="style4">
                                <asp:Label ID="lblchqno" runat="server" Text="Cheque No" Visible="false"></asp:Label>

                            </td>
                            <td>
                                <asp:Label ID="txtchqno" class="form_textbox12" runat="server" TabIndex="14" Width="160px" Visible="false"></asp:Label>
                                <%-- <asp:TextBox ID="txtchqno" class="form_textbox12" runat="server" 
                            MaxLength="30" TabIndex="10" ></asp:TextBox>--%>
                            </td>
                        </tr>
                    ...
                    <td>                  
                        <asp:TextBox ID="txtchqdate" class="form_textbox12" runat="server" 
                            MaxLength="30" TabIndex="10" ></asp:TextBox>
                    </td>
                </tr>--%>

                         <tr>
                            <td class="style4">  Approved By <span class="alert">* </span>
                            </td>
                            <td>


                                 <asp:DropDownList ID="DropDownApprovedby" runat="server"
                                     Height="20px" Style="margin-left: 10px" Width="163px" TabIndex="15">
                                </asp:DropDownList>
                                ...
                                <asp:Button ID="buttonSave" runat="server" TabIndex="18" class="button" Text="Save"
                                    ...
                                    OnClick="ButtonSubmit_Click" />&nbsp;&nbsp;
                                                            <input type="button" onclick="javascript: parent.googlewin.close();" name="buttonClose"
                                                                id="buttonClose" value="Close" class="button" tabindex="19" />
                                &nbsp;&nbsp;
                                                            <%-- <input type="reset" class="button" value="Reset" />--%>
                                <asp:Button ID="btnReset" runat="server" class="button" Text="Reset"
                                    OnClick="btnReset_Click" TabIndex="20" />
                            </td>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <ComponentArt:Calendar runat="server" ID="CalendarDepositDate1" AllowMultipleSelection="false"
                                AllowWeekSelection="false" AllowMonthSelection="false" ControlType="Calendar"
                                ...
                                ImagesBaseUrl="../images" PrevImageUrl="cal_prevMonth.gif" NextImageUrl="cal_nextMonth.gif">
                                <ClientEvents>
                                    <SelectionChanged EventHandler="DepositDate1_OnChange" />
                                </ClientEvents>
                            </ComponentArt:Calendar>
                        </td>
                    ...
                    <%-- <tr>
                  <td>  <ComponentArt:Calendar runat="server" ID="Calendarentrydate" AllowMultipleSelection="false"
                            AllowWeekSelection="false" AllowMonthSelection="false" ControlType="Calendar"
                            PopUp="Custom" PopUpExpandControlId="calendar_from_button1" CalendarTitleCssClass="title"
                            DayHoverCssClass="dayhover" DisabledDayCssClass="disabledday" DisabledDayHoverCssClass="disabledday"
                            OtherMonthDayCssClass="othermonthday" DayHeaderCssClass="dayheader" DayCssClass="day"
                            ...
                            ImagesBaseUrl="../images" PrevImageUrl="cal_prevMonth.gif" NextImageUrl="cal_nextMonth.gif">
                            <ClientEvents>
                                <SelectionChanged EventHandler="entrydate_OnChange" />
                            </ClientEvents>
