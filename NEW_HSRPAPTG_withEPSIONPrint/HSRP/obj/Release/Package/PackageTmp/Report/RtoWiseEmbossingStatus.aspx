                 ...
                 <Columns>
                                ...
                                <%--     <asp:BoundField HeaderText="Embossing Center" DataField="Embossing Center" />
                                                    ...
                                                    <asp:BoundField HeaderText="Day3" DataField="Day3" />
                                                     <asp:BoundField HeaderText="Day4" DataField="Day4" />--%>
                                                   <%-- <asp:BoundField HeaderText="Day5orMore" DataField="Day5 or More" />--%>
                              <asp:TemplateField HeaderText="Affixation Center" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                ...
                                <ItemStyle HorizontalAlign="Left" Width="6%"/>
                                        ...
                                        <asp:TemplateField HeaderText="Embossing Center" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblembname" runat="server" Text=<%#Eval("EmbossingCenter")%>></asp:Label>
                                        </ItemTemplate>
                                            <HeaderStyle ForeColor="White" />
                                         </asp:TemplateField>
                                      <asp:TemplateField HeaderText="AssignedLaserCoder" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblassgnlaser" runat="server" Text=<%#Eval("AssignedLaserCode")%>></asp:Label>
                                        </ItemTemplate>
                                          <HeaderStyle ForeColor="White" />
                                         </asp:TemplateField>
                                       <asp:TemplateField HeaderText="ToDayProd" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                      ...
                      <asp:TemplateField HeaderText="day1date" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                       ...
                       <asp:TemplateField HeaderText="day2date" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                       ...
                       <asp:TemplateField HeaderText="day3date" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                       ...
                       <asp:TemplateField HeaderText="day4date" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                           ...
                           <HeaderStyle ForeColor="White" />
                                   ...
                                   <asp:TemplateField HeaderText="Day1" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Day2" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="Day3" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Day4" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                 ...
                                 <HeaderStyle ForeColor="White" />
                                            ...
                                            <asp:TemplateField HeaderText="Day5orMore" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                 ...
                 <Columns>
                     ...
                     <asp:TemplateField HeaderText="Affixation Center" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                ...
                                <ItemStyle HorizontalAlign="Left" Width="6%"/>
                                        ...
                                        <asp:TemplateField HeaderText="PIP" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblcollection" runat="server" Text=<%#Eval("PIP")%>></asp:Label>
                                        </ItemTemplate>
                                            <HeaderStyle ForeColor="White" />
                                         </asp:TemplateField>
                                       <asp:TemplateField HeaderText="ToDayProd" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                 ...
                 <Columns>
                     ...
                     <asp:TemplateField HeaderText="Affixation Center" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                ...
                                <ItemStyle HorizontalAlign="Left" Width="6%"/>
                                   ...
                                   <asp:TemplateField HeaderText="OpeningWithRegNo(A)" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <%--<asp:Label ID="lblDay1" runat="server" Text=<%#Eval("Day1")%>></asp:Label>--%>
                                    ...
                                    <asp:TemplateField HeaderText="OpeningwithoutRegno(B)" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                              <%-- <asp:Label ID="lblDay2" runat="server" Text=<%#Eval("Day2")%>></asp:Label>--%>
                             ...
                             <asp:TemplateField HeaderText="TodayOrderswithRegNo(C)" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                            <%--   <asp:Label ID="lblDay4" runat="server" Text=<%#Eval("Day4")%>></asp:Label>--%>
                                 ...
                                 <HeaderStyle ForeColor="White" />
                                            ...
                                            <asp:TemplateField HeaderText="TodayOrderswithoutRegNo(D)" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
