<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"  CodeBehind="APTG_PoliceCollection_Report.aspx.cs" Inherits="HSRP.Report.APTG_PoliceCollection_Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            <td valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Police Status Report</span>
                                    </td>
                    ...
                    <tr>
                        <td>
                            <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader1">
                                <tr>
                                    <td>
                                        <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader1">
                                            <tr>
                                                <td>
                                                </td>
                                               ...
                                               <%-- <td valign="middle" class="form_text">
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="GO" runat="server" Text="GO" ToolTip="Please Click for Report" Visible="false"
                                                        class="button"  BackColor="Orange" ForeColor="#000000" OnClick="GO_Click"/>
                                                     &nbsp;&nbsp; &nbsp;&nbsp;
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Report In Excel" ToolTip="Please Click for Report"
                                                        class="button" OnClientClick=" return validate()" OnClick="btnExportToExcel_Click" BackColor="Orange" ForeColor="#000000" />
                                                </td>
                                                <tr>
                                                    <td colspan="9">
                                                        <asp:Label ID="LabelError" runat="server" Font-Names="Tahoma" ForeColor="Red"></asp:Label>

                                                        <asp:Label ID="lblsuccess" runat="server" Font-Names="Tahoma" ForeColor="Red"></asp:Label>
                                                    </td>
                                                </tr>
                    ...
                    <tr>
                        <td>
                            <table width="85%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                            </table>
                        </td>
                    </tr>
                    <tr>
    ...
    <tr>
            <td align="center">
                <asp:GridView ID="grdpending" runat="server" BackColor="White" 
              BorderColor="#3366CC" BorderStyle="None" AllowPaging="true"
              BorderWidth="1px" CellPadding="4" 
              style="text-align: center; margin-left: 5px" Width="280px" OnPageIndexChanging="grdpending_PageIndexChanging">
              ...
              <SortedDescendingHeaderStyle BackColor="#002876" />
                   <%-- <Columns>
                    ...
                    <asp:BoundField DataField="ownerName" HeaderText="ownerName" />
                        ...
                        <asp:BoundField DataField="OrderEmbossingDate" HeaderText="OrderEmbossingDate" />
