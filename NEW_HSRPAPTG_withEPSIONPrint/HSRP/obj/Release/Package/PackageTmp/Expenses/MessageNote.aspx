<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MessageNote.aspx.cs" Inherits="HSRP.Expenses.MessageNote" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function validate() { 
            if (document.getElementById("<%=textboxMessageText.ClientID%>").value == "") {
                alert("Please Provide Message Text");
                document.getElementById("<%=textboxMessageText.ClientID%>").focus();
                return false;
            }
            ...
            if (invalidChar(document.getElementById("textboxMessageTextURL"))) {
                alert("Special Characters Not Allowed.");
                document.getElementById("textboxMessageTextURL").focus();
                return false;
            }
            if (invalidChar(document.getElementById("textboxMessageText"))) {
                alert("Special Characters Not Allowed.");
                document.getElementById("textboxMessageText").focus();
                return false;
            }
        }
...
<body>
    ...
    <fieldset>
        ...
        <tr>
            ...
            <tr>
                <td class="form_text" style="padding-bottom: 10px" > Message Note : <span class="alert">* </span></td>
                <td > <asp:TextBox  ID="textboxMessageText" runat="server" class="form_textbox" ></asp:TextBox> </td> 
                <%--<td>&nbsp; &nbsp;</td>
                <td class="form_text" style="padding-bottom: 10px"> Message Text URL : <span class="alert">* </span></td>
                <td > <asp:TextBox ID="textboxMessageTextURL"  class="form_textbox"  runat="server" TabIndex="1"></asp:TextBox> </td>--%>
            </tr>
            
          <%--  <tr> 
                <td class="form_text" style="padding-bottom: 10px"> Active Status :</td>
                <td> <asp:CheckBox ID="chkActiveStatus"  runat="server" TabIndex="5" /> </td>
            </tr>--%>
            <tr>
