...
<body>
    ...
    <div style="height: 100%; vertical-align: ">
		...
		<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
                        ...
                        <tr>
                          <td height="26" valign="top" class="maintext">18.</td>
                          <td class="maintext">We are not out sourcing any of our HSRP activity to anyone. Be alert of fake calls/Misleading Information.Company will not be responsible for such Transactions/Dealings.<br />
                           
                            </font></td>
                        </tr>
                        <%--<asp:Label ID="LanIPAddress" runat="server" Visible="true"></asp:Label>--%>
                      </table></marquee>
                                            </td>
                                        </tr>
                                    </table>
