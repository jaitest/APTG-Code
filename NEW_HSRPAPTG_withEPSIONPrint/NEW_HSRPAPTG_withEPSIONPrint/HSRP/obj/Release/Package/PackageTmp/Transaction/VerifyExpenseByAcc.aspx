...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function VerifyAmount(i) {
            googlewin = dhtmlwindow.open("googlebox", "iframe", "VerifyAmountByAcc.aspx?ExpenseID=" + i, "Update Expense Details", "width=950px,height=450px,resize=1,scrolling=1,center=1", "recal")
            //strExpenseSaveIDgooglewin = dhtmlwindow.open("googlebox", "iframe", "VerifyAmountByAcc.aspx?Mode=Edit&ExpenseID=" + i, "Update Expense Details", "width=950px,height=450px,resize=1,scrolling=1,center=1", "recal")
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="padding-top: 1px;">
                            <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" CellPadding="4" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="false" ShowHeader="true" Width="100%" BackColor="White" BorderColor="#FFCC99" BorderStyle="Solid" BorderWidth="1px" DataKeyNames="ExpenseSaveID" OnRowCommand="GridView1_RowCommand">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Verified By Operation Head" DataField="VerifiedByCEO" />
                                    <asp:BoundField HeaderText="Status" DataField="CEOExpenseStatus" />
                                    <asp:BoundField HeaderText="Transfer" DataField="AccExpenseStatus" />
                                    <asp:TemplateField HeaderText="Approve">
                                        <ItemTemplate> 
                                            <asp:LinkButton ID="lnkApproval" runat="server" Text="Approve"  CommandName="Approved"></asp:LinkButton>                                        
                                            <%--<a href="javascript:VerifyAmount(<%#Eval("ExpenseSaveID")%>)"> <asp:Label runat="server" ID="lblApprove" Text="Approve"></asp:Label></a>--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Transfer Expense Bill For Operation Head Approval">
                                        <ItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="ByPass Expense">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkBypass" runat="server" CommandArgument='<%#Eval("ExpenseSaveID")%>' CommandName="ByPass">ByPass</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
