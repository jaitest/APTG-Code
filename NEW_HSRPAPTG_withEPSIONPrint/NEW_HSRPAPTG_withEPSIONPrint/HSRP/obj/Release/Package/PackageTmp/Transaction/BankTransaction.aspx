                    ...
                    <td>
                        <table id="Table1" runat="server" style="margin-left: 8px;" align="left" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <img id="calendar_from_button" alt="" onclick="DepositDate_OnClick()"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="DropDownListBankName" runat="server" 
                            Style="margin-left: 8px" TabIndex="3" Width="165px" AutoPostBack="true" 
                 ...
                 <tr>
                   ...
                   <asp:TextBox ID="txtBranchName" runat="server" class="form_textbox12" TabIndex="4" MaxLength="30" ></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxDepositAmount" class="form_textbox12" runat="server" 
                            onkeypress="return isNumberKey(event)" MaxLength="30" TabIndex="5"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style4">
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="TextBoxDepositby" class="form_textbox12" runat="server" 
                            MaxLength="30" onkeypress="return ischarKey(event)" TabIndex="6" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style4">
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="ddlLocation" runat="server" 
                            ...
                            style="margin-left: 10px" Width="163px" TabIndex="7">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                  ...
                  <td nowrap="nowrap" align="right"  >
                                  ...
                                  <%--<asp:Button ID="btnApproval" runat="server" TabIndex="10" class="button" Visible="true"
                                                            ...
                                                            <input type="button" onclick="javascript:parent.googlewin.close();" name="buttonClose"
                                                                id="buttonClose" value="Close" class="button" tabindex="10"/>
                                                            &nbsp;&nbsp;
                                                            <%-- <input type="reset" class="button" value="Reset" />--%>
                                                            <asp:Button ID="btnReset" runat="server"  class="button" Text="Reset" 
                                                                onclick="btnReset_Click" TabIndex="11" />
                                                        </td>
