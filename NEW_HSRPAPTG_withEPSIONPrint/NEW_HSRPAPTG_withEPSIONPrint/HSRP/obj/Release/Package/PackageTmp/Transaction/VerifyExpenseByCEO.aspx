<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VerifyExpenseByCEO.aspx.cs" Inherits="HSRP.Transaction.VerifyExpenseByCEO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function VerifyAmount(i) {
            googlewin = dhtmlwindow.open("googlebox", "iframe", "VerifyAmountByCEO.aspx?Mode=Edit&ExpenseID=" + i, "Update Expense Details", "width=950px,height=450px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function ()
            {
                window.location = "VerifyExpenseByCEO.aspx";
                return true;
            }
        }
    </script>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="padding-top: 1px;">
                            <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" CellPadding="4" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="false" ShowHeader="true" Width="100%" BackColor="White" BorderColor="#FFCC99" BorderStyle="Solid" BorderWidth="1px" OnRowCommand="GridView1_RowCommand">
