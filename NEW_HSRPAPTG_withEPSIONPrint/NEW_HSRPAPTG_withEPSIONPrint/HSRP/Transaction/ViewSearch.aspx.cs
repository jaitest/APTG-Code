...
namespace HSRP.Transaction
{
    public partial class ViewSearch : System.Web.UI.Page
    {
                ...
                if (e.Control.ID.ToString() == "LinkButtonCashReceipt")
                {
                    ...
                    if (obj.FillHSRPRecordDeliveryChallan(HSRPRecordID, ref dataSetFillHSRPDeliveryChallan))
                    {
                       ...
                       // string affixation="For affixation kindly visit";
                        ...
                        string getTinNonew = Utils.getScalarValue("select GSTIN from hsrpstate where HSRP_StateID='" + HSRPStateID + "' ", CnnString);
                        PdfPCell cellTinNo = new PdfPCell(new Phrase("GST (PROV ID NO.)" + getTinNonew.ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                        ...
                        PdfPCell cell1205 = new PdfPCell(new Phrase(" " + amt + "*", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                        cell1205.Colspan = 1;
                        cell1205.BorderWidthLeft = 0f;
                        cell1205.BorderWidthRight = 0f;
                        cell1205.BorderWidthTop = 0f;
                        ...
                        PdfPCell celldupCash4022 = new PdfPCell(new Phrase(" " + roundAmt, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                        celldupCash402.Colspan = 1;
                        celldupCash402.BorderWidthLeft = 0f;
                        celldupCash402.BorderWidthRight = 0f;
                        celldupCash402.BorderWidthTop = 0f;
        ...
        public void EpsionPrint(string hsrpRecordID)
        {
            ...
            string SQLString = "select hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType,CashReceiptNo,SGSTPer,SGSTAmount,CGSTPer,CGSTAmount,GSTBasicAmount from hsrprecords where HSRPRecordID='" + hsrpRecordID + "'";
            ...
            string strvehrecno = dataSetFillHSRPDeliveryChallan.Rows[0]["VehicleRegNo"].ToString();
            BAL obj = new BAL();
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                if (strvehrecno.ToString().Trim() == "")
                {
                    ...
                    PdfPCell cellnew = new PdfPCell(new Phrase(Messagenew, new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cellnew.Colspan = 2;
