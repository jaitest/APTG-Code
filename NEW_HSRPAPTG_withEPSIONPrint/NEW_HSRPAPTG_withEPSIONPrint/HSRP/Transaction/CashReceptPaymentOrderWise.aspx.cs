        ...
        public void DownloadReceipt(DataTable dt)
        {
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
                {
                    ...
                    PdfPCell cellInv22111 = new PdfPCell(new Phrase(": " + dataSetFillHSRPDeliveryChallan.Rows[0]["CashReceiptNo"].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    ...
                    PdfPCell cell55 = new PdfPCell(new Phrase(": " + dataSetFillHSRPDeliveryChallan.Rows[0]["HSRPRecord_AuthorizationNo"].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cell55.Colspan = 1;
                    ...
                    //decimal one = i / 128;
                    //decimal amt = one * 100;
                    //decimal tax = amt / 100 * 14;dataSetFillHSRPDeliveryChallan
                    //amt = decimal.Round(amt, 2, MidpointRounding.AwayFromZero);   //Math.Round(amt, 00);
                    //tax = decimal.Round(tax, 2, MidpointRounding.AwayFromZero); //Math.Round(tax, 00);
                    ...
                    PdfPCell celldupCash401 = new PdfPCell(new Phrase("CGST @14 % ", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                    ...
                    PdfPCell celldupCash402 = new PdfPCell(new Phrase(" " + tax1, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                    ...
                    PdfPCell celldupCash401sgst = new PdfPCell(new Phrase("SGST @14 % ", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                    ...
                    PdfPCell celldupCash402sgst = new PdfPCell(new Phrase(" " + tax, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                    ...
                    PdfPCell celldupCash4002 = new PdfPCell(new Phrase(" " + roundAmt + ".00", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                    ...
                    {
                        PdfPCell cellsp51 = new PdfPCell(new Phrase("https://hsrpap.com", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                        cellsp51.Colspan = 4;
                        cellsp51.BorderWidthLeft = 0f;
                        cellsp51.BorderWidthRight = 0f;
                        cellsp51.BorderWidthTop = 0f;
                    ...
                    {
                        PdfPCell cellsp52 = new PdfPCell(new Phrase("Email:online@hsrpap.com", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                        cellsp52.Colspan = 4;
                        cellsp52.BorderWidthLeft = 0f;
                        cellsp52.BorderWidthRight = 0f;
                        cellsp52.BorderWidthTop = 0f;
                    ...
                    //{
                    //    //9396844878
                    //    PdfPCell cellsp54 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    //    cellsp54.Colspan = 4;
                    ...
                    //else if (HSRPStateID == "9")
                    //{
                    //    PdfPCell cellsp55 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    //    cellsp55.Colspan = 4;
                    //    cellsp55.BorderWidthLeft = 0f;
                    //    cellsp55.BorderWidthRight = 0f;
                    //    cellsp55.BorderWidthTop = 0f;
