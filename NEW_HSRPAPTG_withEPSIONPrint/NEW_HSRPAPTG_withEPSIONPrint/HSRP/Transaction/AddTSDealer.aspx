<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="AddTSDealer.aspx.cs" Inherits="HSRP.Master.AddTSDealer" %>
                                            ...
                                            <td style="margin-left: 10px; font-size: medium; color: Black">
                                                <table border="0" align="center" cellpadding="3" cellspacing="3" style="height: 348px; width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 12px">&nbsp;</td>
                                                        <td class="style5" nowrap="nowrap" style="padding-bottom: 10px;">
                                                            Email-Id  <span class="alert">* </span> <br />    
                                                            &nbsp;                                   
                                                            <br />    
                                                            &nbsp;                                                                                                               
                                                        </td>                                                       
                                                        <td class="style5" nowrap="nowrap" style="padding-bottom: 10px;" >
                                                            <asp:TextBox ID="txtEmailid" MaxLength="50" TabIndex="3" class="form_textbox12" runat="server"></asp:TextBox>   <br />                                                        
