...
{
    public partial class LaserRequestionSheet : System.Web.UI.Page
    {
        ...
        {
                SQLString = "select distinct EmbCenterName,NAVEMBID from RTOLocation Where HSRP_StateID=" + HSRPStateID + " and navembid is not null and activeStatus='Y' Order by EmbCenterName ";
        ...
        private void ExportToPDF(string strStartDate,string strEndDate)
        {
            ...
            bool Check = false;
            int Itotal = 0;
            string filename = "LaserRequestionSheet- " + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".pdf";
