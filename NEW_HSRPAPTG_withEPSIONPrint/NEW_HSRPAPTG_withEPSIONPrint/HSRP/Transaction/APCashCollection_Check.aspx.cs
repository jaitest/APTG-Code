...
{
    public partial class APCashCollection_check : System.Web.UI.Page
    {
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            string sqry = "select cashreceiptno from hsrprecords where   HSRP_StateID='9' and HSRPRecord_AuthorizationNo ='" + strAuthNo + "'";
            sqry = Utils.getDataSingleValue(sqry, ConnectionString, "cashreceiptno");
            lblmsg1.Text = sqry;
            SQLString = "select  HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,RTOLocationID,OwnerName,EmailID,Address1,VehicleType,OrderType,VehicleClass,MobileNo,ManufacturerName,ManufacturerModel,EngineNo,ChassisNo from hsrprecords where HSRPRecord_AuthorizationNo='" + txtAuthNo.Text + "' and  HSRP_StateID='9'";
        ...
        protected void btnDownloadReceipt_Click(object sender, EventArgs e)
        {
          ...
          string  AffAddress = Utils.getDataSingleValue(sqlquery, ConnectionString, "Address1");
            ...
            string SQLString = "select hsrprecordID, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType,CashReceiptNo from hsrprecords where  HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text+"'";
        ...
        public void EpsionPrint()
        {
            ...
            string SQLString = "select hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType from hsrprecords where  HSRPRecord_AuthorizationNo ='" + txtAuthNo.Text + "'";
            DataTable dataSetFillHSRPDeliveryChallan = Utils.GetDataTable(SQLString, ConnectionString);
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                tax1 = decimal.Round(tax1, 2, MidpointRounding.AwayFromZero);


                PdfPCell cell1205 = new PdfPCell(new Phrase(" " + amt.ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell1205.Colspan = 0;
                ...
                PdfPCell cellNet120SGST = new PdfPCell(new Phrase("SGST @14% ", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell125 = new PdfPCell(new Phrase(" " + tax, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell125.Colspan = 0;
                ...
                PdfPCell cellNet120CGST = new PdfPCell(new Phrase("CGST @14%", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell205 = new PdfPCell(new Phrase(" " + tax1, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell205.Colspan = 0;
        ...
        protected void btnSync_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string orderdate = "select convert(varchar(50),hsrprecord_creationdate,103) as hsrprecord_creationdate from hsrprecords where HSRP_StateID='9' and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'";
                orderdate = Utils.getDataSingleValue(orderdate, ConnectionString, "hsrprecord_creationdate");

                string collectionamount = "select roundoff_netamount from hsrprecords where HSRP_StateID='9' and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'";
                ...
                int sqry11 = Utils.ExecNonQuery("update hsrprecords set apwebserviceresp='" + AuthData + "' where HSRP_StateID='9' and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'  ", ConnectionString);
