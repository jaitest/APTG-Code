...
{
    public partial class TGCashCollection_OnlineCheck : System.Web.UI.Page
    {
        ...
        protected void btnSync_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string orderdate = "select convert(varchar(50),hsrprecord_creationdate,103) as hsrprecord_creationdate from hsrprecords where HSRP_StateID='11' and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'";
                orderdate = Utils.getDataSingleValue(orderdate, ConnectionString, "hsrprecord_creationdate");

                string collectionamount = "select roundoff_netamount from hsrprecords where HSRP_StateID='11' and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'";
                collectionamount = Utils.getDataSingleValue(collectionamount, ConnectionString, "roundoff_netamount");

                HSRP.TGWebrefrence.HSRPAuthorizationService objAPService = new HSRP.TGWebrefrence.HSRPAuthorizationService();
                string AuthData = objAPService.UpdateHSRPCharges(lblAuthNo.Text, Math.Round(Convert.ToDecimal(collectionamount), 0), orderdate);

                int sqry11 = Utils.ExecNonQuery("update hsrprecords set apwebserviceresp='" + AuthData + "' where HSRP_StateID='11' and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'  ", ConnectionString);
