    ...
    public partial class AddAPDealer : System.Web.UI.Page
    {
                ...
                else
                {
                    ...
                    if (Utils.ExecNonQuery(SQLString2, CnnString) > 0)
                    {
                        if (textBoxMobileNo.Text.Length > 0)
                        {
                            ...
                            Utils.ExecNonQuery("insert into APSMSDetail(RtoLocationID,MobileNo,SentResponseCode,smstext) values('" + DropdownRTOName.SelectedValue + "'," + textBoxMobileNo.Text.ToString() + ",'" + result + "','" + SMSText + "')", CnnString);
        ...
        public void SendMail(string Dealershipname, string username, string password, string dealerEmailid)
        {
            try
            {
                ...
                msg.Body = "Dear M/S <b>“" + Dealershipname + "”</b><br /><br />We have received your application for “Pay Direct-LAPL”. Your application has been successfully updated. Thank you for showing your interest in “Pay Direct-LAPL”.<br />Now that you’ve signed up you will receive updates via email and SMS.<br /><br /><br />User Id :-    " + username + "<br />Password :- " + password + "<br /><br />It is recommended that you please change your password, immediately after you have logged in to your account. Do not share password with anyone.<br />We would request you to please visit the below link and log in to your account.<br /><a href='" + ActivationUrl + "'>www.hsrpap.com/hsrpap/login.aspx</a><br /><br /> If you have any query or for further business enquiry please email us on <a href='" + ActivationUrl1 + "'>online@hsrpap.com</a><br /> Or contact Support Team on following numbers:-<br /><br />1.       +91-7306132943<br /><br />2.       +91-9396844878<br /><br />3.       +91-9100026696<br /><br />4.       +91-9100026691<br /><br /><br /><br /><br /><br /><br />Thanking You<br /><br />Team-LAPL";
                msg.IsBodyHtml = true;
                SmtpClient smtpServer = new SmtpClient();
                smtpServer.Credentials = new NetworkCredential("automailer@hsrpap.com", "Link@1234");
                smtpServer.Port = 587;
                smtpServer.Host = "mail.hsrpap.com";
