                ...
                <div style="width: 880px; margin: 0px auto 0px auto">
                    ...
                    <td></td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="form_text_View" style="padding-bottom: 10px">
                                <asp:Label ID="LabelFrontPlateLeserNo" runat="server" class="form_text_View" Text=" Verified Amount : "></asp:Label>
                            ...
                            <td>
                                <asp:TextBox class="form_textbox11" TabIndex="1" Width="150" ID="txtVerifyAmt"
                                    runat="server" MaxLength="7" onkeyup="checkDec(this);"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Rows="4" TabIndex="2" Columns="30"></asp:TextBox>
                            </td>
                            <td></td>
                            <td>Checked For Operation Head Approval</td>
                            <td></td>
                            <td>
                                <asp:CheckBox ID="CheckBox1" runat="server" Text="Operation Head Approval" /></td>
