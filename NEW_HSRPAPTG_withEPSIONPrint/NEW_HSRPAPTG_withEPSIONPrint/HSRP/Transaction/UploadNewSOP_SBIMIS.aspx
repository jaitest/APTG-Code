<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="UploadNewSOP_SBIMIS.aspx.cs" Inherits="HSRP.Transaction.UploadNewSOP_SBIMIS" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnuploadhrexceldata" runat="server" 
                                    ...
                                    Text="Upload NewSop SBI" />
                            </td>
                        </tr>
                        <tr>

                             <td style="left:-300px">
                                <asp:Button ID="Button1" runat="server" Text="Conform SBI Payment" OnClick="Button1_Click"  Visible="false"/>
                            </td>
