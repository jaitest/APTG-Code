...
{
    public partial class Report_APNewsopPaymentDetails : System.Web.UI.Page
    {
        ...
        private void BindReportTypeddl()
        {
            ...
            string sqlstring = "[Business_ReportTypewisesummary_report_AP_NewSOP_SBI] '" + Dateto.SelectedDate.ToString("MM/dd/yyyy") + "','" + Dateto.SelectedDate.ToString("MM/dd/yyyy") + "','DB'";
            dt11 = new DataTable();
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@reportdate", Convert.ToDateTime(Datefrom.SelectedDate.ToString("MM/dd/yyyy"))));
                cmd.Parameters.Add(new SqlParameter("@reportto", Convert.ToDateTime(Dateto.SelectedDate.ToString("MM/dd/yyyy"))));                
        ...
        private void SaveAndDownloadFile2()
        {
            ...
            Export(strOrderType, book, 1, "Report_Newsop_BookedRecord");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                if (btndownload1 != true)
                {
                    cmd.Parameters.Add(new SqlParameter("@reportdate", Convert.ToDateTime(Datefrom.SelectedDate.ToString("MM/dd/yyyy"))));
                    cmd.Parameters.Add(new SqlParameter("@reportto", Convert.ToDateTime(Dateto.SelectedDate.ToString("MM/dd/yyyy"))));                
                    //cmd.Parameters.Add(new SqlParameter("@reporttype", "ALLData"));
                    cmd.Parameters.Add(new SqlParameter("@reporttype", DdlReportType.SelectedValue));
                   // cmd.Parameters.Add(new SqlParameter("@stateid", Convert.ToInt32(Session["UserHSRPStateID"])));
                   // cmd.Parameters.Add(new SqlParameter("@RTOLocationId", Convert.ToInt32(Session["UserRTOLocationID"])));
