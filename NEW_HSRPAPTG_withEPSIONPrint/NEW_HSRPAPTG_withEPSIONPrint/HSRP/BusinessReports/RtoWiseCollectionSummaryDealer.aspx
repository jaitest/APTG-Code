<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RtoWiseCollectionSummaryDealer.aspx.cs" Inherits="HSRP.BusinessReports.RtoWiseCollectionSummaryDealer" %>
...
<script type="text/javascript">
    ...
    <table style="height: 51px; padding-left:385px;" >
        <tr>
...
<%--            <td style="width: 50px; height: 40px;">               
                    ...
                    <asp:Label ID="label2" runat="server" Font-Bold="True" Visible="false" ForeColor="Black" 
                        Text="Order Type:" Width="100px" />
                
            </td>
            <td style="height: 40px;" width="80">               
                   
                    <asp:DropDownList ID="DropDownListOrderType" Visible="false" runat="server" 
                        CausesValidation="false" DataTextField="HSRPStateName" 
