...
{
    public partial class ReportFA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                CnnString2 = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionStringFA"].ToString();
        ...
        private void BindReportTypeddl()
        {
            ...
            string sqlstring = "[SP_FA_Report] '0','0','0','DB' ";
            dt11 = new DataTable();
            dt11 = Utils.GetDataTable(sqlstring, CnnString2);
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            {
                lblErrMess.Text = "";
                SqlConnection con = new SqlConnection(CnnString2);
                #region Fetch Data
                ...
                //change sp Name
                cmd = new SqlCommand("SP_FA_Report", con);//Business_ReportTypewisesummary_report
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@fa_no", "1"));
                cmd.Parameters.Add(new SqlParameter("@fa_location", "1"));
                cmd.Parameters.Add(new SqlParameter("@fa_employee","1"));
                cmd.Parameters.Add(new SqlParameter("@report_type", "FDL"));


                //cmd.Parameters.Add(new SqlParameter("@fa_no", Convert.ToDateTime(Datefrom.SelectedDate)));
                //cmd.Parameters.Add(new SqlParameter("@fa_location", Convert.ToDateTime(Dateto.SelectedDate)));
                //cmd.Parameters.Add(new SqlParameter("@fa_employee", DdlReportType.SelectedValue));
                //cmd.Parameters.Add(new SqlParameter("@report_type", Convert.ToInt32(Session["UserHSRPStateID"])));
               ...
               // cmd.Parameters.Add(new SqlParameter("@paymentgateway", DropDownListPaymentgetWay.SelectedValue));
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    grd.DataBind();
                    grd.Visible = true;
                    //if (DdlReportType.SelectedValue == "BT")
                    //{
                    //    decimal total = 0;// ds.Tables[0].AsEnumerable().Sum(row => row.Field<decimal>("DepositAmount"));
                    //    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    //    {
                    //        total = total + Convert.ToDecimal(ds.Tables[0].Rows[i]["DepositAmount"]);
                    //    }
                    //    grd.FooterRow.Cells[0].Text = "";
                    //    grd.FooterRow.Cells[1].Text = "";
                    //    grd.FooterRow.Cells[2].Text = "";
                    //    grd.FooterRow.Cells[3].Text = "Total";
                    //    grd.FooterRow.Cells[4].Text = "-";
                    //    //grd.FooterRow.Cells[1].HorizontalAlign = HorizontalAlign.Right;
                    //    grd.FooterRow.Cells[5].Text = total.ToString("N2");
                    //}
        ...
        private void SaveAndDownloadFile()
        {
            ...
            string filename = "FA Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";

            string strOrderType = string.Empty;

            Export(strOrderType, book, 1, "SP_FA_Report");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                book.Properties.Title = "APTG Online Report";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    row.Index = iIndex++;
                    row.Cells.Add(new WorksheetCell("Report :   FA Report - ", "HeaderStyle2"));
