...
{
    public partial class ReportTypeWiseSummary_report_Online : System.Web.UI.Page
    {
        ...
        private void BindReportTypeddl()
        {
            ...
            string sqlstring = "[Business_ReportTypewisesummary_report] '" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','DB','11','0','0','0' ";
            dt11 = new DataTable();
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "Business_ReportTypewisesummary_report");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    row.Index = iIndex++;
                    row.Cells.Add(new WorksheetCell("Report :   APTG Online Report - ", "HeaderStyle2"));
                   ...
                   // AddNewCell(row, "", "HeaderStyle6", 2);
                    ...
                    for (int j = 0; j < dt.Rows.Count; j++)
                    {
                        ...
                        for (int i = 0; i < dt.Columns.Count; i++)
                        {
                            //if (dt.Rows[j]["Location"].ToString().Equals("ZZ Total") && i.Equals(0))
                            //{
                            //    AddNewCell(row, "Total", "HeaderStyle6", 1);
                            //}
                            //else if (dt.Rows[j]["Payment Mode"].ToString().Equals("ZTotal") && i.Equals(0))
                            //{
                            //    AddNewCell(row, "Total", "HeaderStyle6", 1);
                            //}
                            //else
