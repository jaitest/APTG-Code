...
{
    public partial class AffixationScreen_TG : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // +"/" + dtPlateSize.Rows[0]["FrontPlateSize"].ToString() + "/" + dtPlateSize.Rows[0]["RearPlateSize"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    //hsrprecordid,rtolocationid,hsrp_stateid,closeduserid,orderstatus,ordercloseddate,EmbossingleadTime
                    SQLString = "select hsrprecordid,rtolocationid,hsrp_stateid,orderstatus,closeduserid,ordercloseddate,OrderEmbossingDate,PreCloserDateTime from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and HSRPRecord_AuthorizationNo='" + lblauthno.Text.Trim().ToUpper() + "' and orderstatus in ('Embossing Done') and RecievedAffixationStatus='Y' and orderdate>'1-jan-2015 00:00:00'";
                    //// string hsrpid = Utils.getDataSingleValue(SQLString, CnnString, "hsrprecordid");
                    DataTable dtinsert = Utils.GetDataTable(SQLString, CnnString);
                    ...
                    if (dtinsert.Rows.Count > 0)
                    {
                        ...
                        string hsrpid = dtinsert.Rows[0]["hsrprecordid"].ToString();
                        string rtolocationid = dtinsert.Rows[0]["rtolocationid"].ToString();
                        string hsrp_stateid = dtinsert.Rows[0]["hsrp_stateid"].ToString();
                        string ordercloseuserid = UserID;//dtinsert.Rows[0]["closeduserid"].ToString();
                        string preclosedatetime = System.DateTime.Now.ToString();//dtinsert.Rows[0]["PreCloserDateTime"].ToString(); //System.DateTime.Now.ToString();
                        string orderstatus = dtinsert.Rows[0]["orderstatus"].ToString();
                        string orderclosedate = System.DateTime.Now.ToString();//dtinsert.Rows[0]["ordercloseddate"].ToString();
                        string orderembossingleadtime = dtinsert.Rows[0]["OrderEmbossingDate"].ToString();
                       

                        //string qry = "insert into preclosehsrprecords([hsrprecordid],[precloseduserid],[rtolocationid],[hsrp_stateid],[preclosedatetime],[hsrprecordorderstatus],[hsrprecordcloseddatetime],[hsrprecordembossingdatetime],[processstatus],[processeddatetime]) values ('" + hsrpid + "','" + rtolocationid + "','" + hsrp_stateid + "','" + orderstatus + "') ";
                        string qry = "insert into preclosehsrprecords([hsrprecordid],[rtolocationid],[hsrp_stateid],[precloseduserid],[preclosedatetime],[hsrprecordorderstatus],[hsrprecordcloseddatetime],[hsrprecordembossingdatetime]) values ('" + hsrpid + "','" + rtolocationid + "','" + hsrp_stateid + "','" + ordercloseuserid + "','" + preclosedatetime + "','" + orderstatus + "','" + orderclosedate + "','" + orderembossingleadtime + "') ";
                        ...
                        UserID = Session["UID"].ToString();
                        SQLString = "update hsrprecords set orderstatus='PreClosed',PreCloserDateTime='" + preclosedatetime + "',hsrp_rear_lasercode= '" + lblRearLaserPlate.Text + "',hsrp_front_lasercode='" + lblFrontLaserPlate.Text + "' where hsrprecordid ='" + hsrpid + "'";
                       ...
                       string SQLStringlastdate = "select hsrprecordid,rtolocationid,hsrp_stateid,orderstatus,closeduserid,ordercloseddate,OrderEmbossingDate,PreCloserDateTime from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and HSRPRecord_AuthorizationNo='" + lblauthno.Text.Trim().ToUpper() + "' and orderstatus in ('Embossing Done') and RecievedAffixationStatus in('N','Y') and orderdate <'1-jan-2015 00:00:00'";
                        //// string hsrpid = Utils.getDataSingleValue(SQLString, CnnString, "hsrprecordid");
                       DataTable dtinsertlastdate = Utils.GetDataTable(SQLStringlastdate, CnnString);

                    //hsrpid = string.Empty;
                    //Convert.ToInt32
                    if (dtinsertlastdate.Rows.Count > 0)
                    {
                        string serverdate = System.DateTime.Now.ToString("dd/MM/yyyy");
                        string hsrpid = dtinsertlastdate.Rows[0]["hsrprecordid"].ToString();
                        string rtolocationid = dtinsertlastdate.Rows[0]["rtolocationid"].ToString();
                        string hsrp_stateid = dtinsertlastdate.Rows[0]["hsrp_stateid"].ToString();
                        string ordercloseuserid = UserID;//dtinsert.Rows[0]["closeduserid"].ToString();
                        string preclosedatetime = System.DateTime.Now.ToString();//dtinsert.Rows[0]["PreCloserDateTime"].ToString(); //System.DateTime.Now.ToString();
                        string orderstatus = dtinsertlastdate.Rows[0]["orderstatus"].ToString();
                        string orderclosedate = System.DateTime.Now.ToString();//dtinsert.Rows[0]["ordercloseddate"].ToString();
                        string orderembossingleadtime = dtinsertlastdate.Rows[0]["OrderEmbossingDate"].ToString();
        ...
        protected void btnGO_Click(object sender, EventArgs e)
        {
            ...
            if (dtRecords1.Rows[0]["HSRPRecord_AuthorizationNo"].ToString() == "" || dtRecords1.Rows[0]["RTOLocationName"].ToString() == "")
            {
            ...
            else
            {
                ...
                SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND HSRPRecord_AuthorizationNo ='" + lblauthno.Text.Trim().ToUpper() + "' AND orderstatus='Embossing Done' and RecievedAffixationStatus='Y'";
                ...
                else
                {
                    ...
                    if (HSRPStateID == "11")
                    {
                        SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,mobileno,vehicletype,vehicleclass,ordertype from hsrprecords where  orderstatus='New Order' and hsrprecord_authorizationno ='" + lblauthno.Text.Trim().ToUpper() + "' and isnull(aptgvehrecdate,GETDATE())>dateadd(day,-3,GETDATE())  order by VehicleClass,VehicleType,VehicleRegNo";
                        dtcount = Utils.GetDataTable(SQLString, CnnString);
                    }
                    else
                    {
