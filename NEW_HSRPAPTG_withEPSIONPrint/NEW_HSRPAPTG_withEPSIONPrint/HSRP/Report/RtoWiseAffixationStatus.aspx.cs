...
{
    public partial class RtoWiseAffixationStatus : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "Business_report_RTOwiseaffixation_Summary");
            ...
            try
            {
               ...
               // cell1.StyleID = "HeaderStyle6";
                ...
                for (int j = 0; j < dt.Rows.Count; j++)
                {
                    for (int i = 0; i < dt.Columns.Count; i++)
                    {
                        if (dt.Rows[j]["zonalmanager"].ToString().Equals("ZZ") && i.Equals(0))
                        {
                            AddNewCell(row, "", "HeaderStyle6", 1);                          
                        }                        
                        else
        ...
        protected void grdAffection_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //Worksheet sheet11 = book.Worksheets.Add("Affixation Report");
                ...
                Worksheet sheet = book.Worksheets.Add("Affixation Report Details");
                ...
                row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                row.Cells.Add(new WorksheetCell(" ", "HeaderStyle3"));
                WorksheetCell cell = row.Cells.Add("Affixation Report Details");
