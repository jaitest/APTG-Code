...
{
    public partial class InvoiceSummaryWithAmount : System.Web.UI.Page
    {
        int UserType1;
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //change sp Name
                cmd = new SqlCommand("Business_report_InvoiceSummaryWithAmount", con);//Business_ReportTypewisesummary_report
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "Business_report_InvoiceSummaryWithAmount");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                book.Properties.Title = "Invoice Summary With Amount";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    WorksheetCell cell = row.Cells.Add("Invoice Summary With Amount");
