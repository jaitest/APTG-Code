...
{
    public partial class AvgVehicleCountReport : System.Web.UI.Page
    {
        int UserType;
        ...
        public void BuildGrid1()
        {
            try
            {
                ...
                string ReportDate2 = ReportDateEnd;
                ...
                string ReportDate1 = ReportDate;

                if (ddlOrderType.SelectedItem.ToString() == "Booking")
                {
                    SQLString = "select convert(varchar(4),DATEPART(YEAR, hsrprecord_creationdate)) as [YEAR],DATENAME(MONTH, hsrprecord_creationdate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and Convert(Date,hsrprecord_creationdate) between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED') group by vehicletype,VehicleClass,DATEPART(YEAR, hsrprecord_creationdate),DATENAME(MONTH, hsrprecord_creationdate)";
                    //SQLString = "select convert(varchar(5),DATEPART(YEAR, ORDERDATE)) as [YEAR],DATENAME(MONTH, ORDERDATE) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and Convert(Date,hsrprecord_creationdate) between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED') group by vehicletype,VehicleClass,DATEPART(YEAR, ORDERDATE),DATENAME(MONTH, ORDERDATE)";
                }
                else if (ddlOrderType.SelectedItem.ToString() == "Production")
                {

                    SQLString = "select convert(varchar(4),DATEPART(YEAR, OrderEmbossingDate)) as [YEAR],DATENAME(MONTH, OrderEmbossingDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and Convert(Date,OrderEmbossingDate) between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED') and Orderstatus in('Embossing Done','closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderEmbossingDate),DATENAME(MONTH, OrderEmbossingDate)";
                }
                else
                {

                    SQLString = "select convert(varchar(4),DATEPART(YEAR, OrderClosedDate)) as [YEAR],DATENAME(MONTH, OrderClosedDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and Convert(Date,OrderClosedDate) between   '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED') and Orderstatus in('closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderClosedDate),DATENAME(MONTH, OrderClosedDate)";
                }
        ...
        public void BuildGrid()
        {
            try
            {
                ...
                {
                    SQLString = "select convert(varchar(4),DATEPART(YEAR, hsrprecord_creationdate)) as [YEAR],DATENAME(MONTH, hsrprecord_creationdate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and Convert(Date,hsrprecord_creationdate) between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED') group by vehicletype,VehicleClass,DATEPART(YEAR, hsrprecord_creationdate),DATENAME(MONTH, hsrprecord_creationdate)";
                    //SQLString = "select convert(varchar(5),DATEPART(YEAR, ORDERDATE)) as [YEAR],DATENAME(MONTH, ORDERDATE) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and RTOLocationID=" + dropDownListClient.SelectedValue.ToString() + " and Convert(Date,hsrprecord_creationdate) between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED') group by vehicletype,VehicleClass,DATEPART(YEAR, ORDERDATE),DATENAME(MONTH, ORDERDATE)";
                }
                else if (ddlOrderType.SelectedItem.ToString()=="Production")
                {
                ...
                else
                {
                    ...
                    SQLString = "select convert(varchar(4),DATEPART(YEAR, OrderClosedDate)) as [YEAR],DATENAME(MONTH, OrderClosedDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and RTOLocationID=" + dropDownListClient.SelectedValue.ToString() + " and Convert(Date,OrderClosedDate) between  '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED') and Orderstatus in('closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderClosedDate),DATENAME(MONTH, OrderClosedDate)";
                }
        ...
        protected void btnexport_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                    row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                    row.Cells.Add(new WorksheetCell("Date from:", "HeaderStyle2"));
                    ...
                    row.Cells.Add(new WorksheetCell("Date To:", "HeaderStyle2"));
                    ...
                    if (dropDownListClient.SelectedItem.Text == "ALL")
                    {
                        ...
                        else
                        {
                            ...
                            SQLString = "select convert(varchar(4),DATEPART(YEAR, OrderClosedDate)) as [YEAR],DATENAME(MONTH, OrderClosedDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords"
                            + " where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and Convert(Date,OrderClosedDate) between   '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED') and Orderstatus in('closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderClosedDate),DATENAME(MONTH, OrderClosedDate)";
                        }
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                            {
                                ...
                                totalAmount = totalAmount + int.Parse(dtrows["Total"].ToString());
                    ...
                    else
                    {
                        ...
                        {
                            SQLString = "select convert(varchar(4),DATEPART(YEAR, OrderEmbossingDate)) as [YEAR],DATENAME(MONTH, OrderEmbossingDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and RTOLocationID=" + dropDownListClient.SelectedValue.ToString() + " and Convert(Date,OrderEmbossingDate0  between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED') and Orderstatus in('Embossing Done','closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderEmbossingDate),DATENAME(MONTH, OrderEmbossingDate)";
                                         //+ "  UNION "
                                         //+ "  SELECT 'Total' as [YEAR],'' AS [MONTHNAME],13 AS ORDERMONTH, "
                                         //+ "  SUM(CASE WHEN  (VehicleType = 'MOTOR CYCLE' OR VehicleType ='SCOOTER') and (orderType='DR' or orderType ='DF') THEN 1 ELSE 0 END ) AS [2W Single Plate],"
                                         //+ "  SUM(CASE WHEN  VehicleType = 'THREE WHEELER' and (orderType='DR' or orderType ='DF') THEN 1 ELSE 0 END ) AS [3W Single Plate],"
