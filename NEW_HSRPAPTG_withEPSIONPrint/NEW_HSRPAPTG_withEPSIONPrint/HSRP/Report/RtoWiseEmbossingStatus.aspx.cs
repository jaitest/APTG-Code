...
{
    public partial class RtoWiseEmbossingStatus : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFileAssignment()
        {
            ...
            ExportAssignment(strOrderType, book, 1, "Business_report_AssignmentVSProduction_Summary");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("Business_report_AssignmentVSProduction_Summary", con);
        ...
        private void PIPVSProduction()
        {
            ...
            Exportpip(strOrderType, book, 1, "Business_report_PIPVSProduction_Summary");
        ...
        protected void btndetail_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("Business_report_PIPVSProduction_Summary", con);
        ...
        protected void gridpip_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day5orMore")
            {
                ...
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,Convert(varchar(15),challandate,103) as 'challandate',RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,Convert(varchar(15),PdfDownloadDate,103) as 'PdfDownloadDate' from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and isnull(vehicleregno,'')!='' and convert(date,aptgvehrecdate)<dateadd(day,-4,'" + ReportDate2 + "')  and (convert(date,orderembossingdate)>='" + ReportDate2 + "' or isnull(orderembossingdate,'')='') order by 1");
            ...
            if (e.CommandName == "Day1")
            {
                ...
                Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,Convert(varchar(15),challandate,103) as 'challandate',RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,Convert(varchar(15),PdfDownloadDate,103) as 'PdfDownloadDate' from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and isnull(vehicleregno,'')!='' and convert(date,aptgvehrecdate)=dateadd(day,0,'" + ReportDate2 + "') and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
            ...
            if (e.CommandName == "Day2")
            {
                ...
                Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,Convert(varchar(15),challandate,103) as 'challandate',RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,Convert(varchar(15),PdfDownloadDate,103) as 'PdfDownloadDate' from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and isnull(vehicleregno,'')!='' and convert(date,aptgvehrecdate)=dateadd(day,-1,'" + ReportDate2 + "') and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
            }
            if (e.CommandName == "Day3")
            {
                ...
                Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,Convert(varchar(15),challandate,103) as 'challandate',RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,Convert(varchar(15),PdfDownloadDate,103) as 'PdfDownloadDate' from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and isnull(vehicleregno,'')!='' and convert(date,aptgvehrecdate)=dateadd(day,-2,'" + ReportDate2 + "') and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
            }
            if (e.CommandName == "Day4")
            {
                ...
                Label embcenter = (Label)gridpip.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,Convert(varchar(15),challandate,103) as 'challandate',RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,Convert(varchar(15),PdfDownloadDate,103) as 'PdfDownloadDate' from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and isnull(vehicleregno,'')!='' and convert(date,aptgvehrecdate)=dateadd(day,-3,'" + ReportDate2 + "') and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
