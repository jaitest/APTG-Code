    ...
    public partial class InvoiceSummaryReport : System.Web.UI.Page
{
    ...
    private void Export(string strStateId, string strStateName)
    {
        try
        {
            ...
            DataTable dt = new DataTable();
            if(DropDownListOrderType.SelectedItem.Text=="Dealer")
            {
                //Create by Amit
                //sql = "select challanno as InvoiceNo,convert(date,challandate,106) as InvoiceDate,RTOLocationName as Location,b.EmbCenterName as EmbossingCenter,SUM(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) as 'Motorcycle',SUM(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) as 'Scooter', SUM(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END ) '3W',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END ) as 'LMV',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END ) as 'LMV Transport', SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END ) as MCV, SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) as Tractor,(sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ))as TotalQuantity from HSRPRecords a ,rtolocation b where a.rtolocationid=b.rtolocationid  and a.HSRP_StateID='" + strStateId + "' and convert(date,challandate,106) between '" + OrderDate.SelectedDate + "'  and '" + HSRPAuthDate.SelectedDate + "' and addrecordby !='Dealer' and challanno is not null and challandate is not null group by EmbCenterName, challanno, convert(date,challandate,106),RTOLocationName order by convert(date,challandate,106) ,challanno";
                sql = "select challanno as InvoiceNo,convert(date,challandate,106) as InvoiceDate,RTOLocationName as Location,b.EmbCenterName as EmbossingCenter,SUM(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) as 'Motorcycle',SUM(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) as 'Scooter',SUM(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END ) '3W',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END ) as 'LMV',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END ) as 'LMV Transport', SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END ) as MCV, SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) as Tractor,(sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ))as TotalQuantity,(sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END )*96 + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END )*120 +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)*120+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )*344+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )*344+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )*388+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END )*96)as TotalWeight from HSRPRecords a ,rtolocation b where a.rtolocationid=b.rtolocationid  and a.HSRP_StateID='" + strStateId + "' and convert(date,challandate,106) between '" + OrderDate.SelectedDate + "'  and '" + HSRPAuthDate.SelectedDate + "' and addrecordby !='Dealer' and challanno is not null and challandate is not null group by EmbCenterName, challanno, convert(date,challandate,106),RTOLocationName order by convert(date,challandate,106) ,challanno";
                //sql = "select challanno as InvoiceNo,convert(date,challandate,106) as InvoiceDate,RTOLocationName as Location,SUM(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) as 'Motorcycle',SUM(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) as 'Scooter', SUM(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END ) '3W',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END ) as 'LMV',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END ) as 'LMV Transport', SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END ) as MCV, SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) as Tractor from HSRPRecords a ,rtolocation b where a.rtolocationid=b.rtolocationid  and a.HSRP_StateID='" + strStateId + "' and convert(date,challandate,106) between '" + OrderDate.SelectedDate + "' and '" + HSRPAuthDate.SelectedDate + "' and addrecordby !='Dealer' and challanno is not null and challandate is not null group by challanno, convert(date,challandate,106),RTOLocationName order by convert(date,challandate,106) ,challanno ";
            }

            if (DropDownListOrderType.SelectedItem.Text == "Non Dealer")
            {
                //sql = "select challanno as InvoiceNo,convert(date,challandate,106) as InvoiceDate,RTOLocationName as Location,SUM(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) as 'Motorcycle',SUM(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) as 'Scooter', SUM(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END ) '3W',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END ) as 'LMV',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END ) as 'LMV Transport', SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END ) as MCV, SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) as Tractor from HSRPRecords a ,rtolocation b where a.rtolocationid=b.rtolocationid  and a.HSRP_StateID='" + strStateId + "' and convert(date,challandate,106) between '" + OrderDate.SelectedDate + "' and '" + HSRPAuthDate.SelectedDate + "' and addrecordby !='Non Dealer' and challanno is not null and challandate is not null group by challanno, convert(date,challandate,106),RTOLocationName order by convert(date,challandate,106) ,challanno ";
                //Create by Amit
                sql = "select challanno as InvoiceNo,convert(date,challandate,106) as InvoiceDate,RTOLocationName as Location,b.EmbCenterName as EmbossingCenter,SUM(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) as 'Motorcycle',SUM(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) as 'Scooter',SUM(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END ) '3W',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END ) as 'LMV',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END ) as 'LMV Transport', SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END ) as MCV, SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) as Tractor,(sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ))as TotalQuantity,(sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END )*96 + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END )*120 +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)*120+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )*344+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )*344+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )*388+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END )*96)as TotalWeight from HSRPRecords a ,rtolocation b where a.rtolocationid=b.rtolocationid  and a.HSRP_StateID='" + strStateId + "' and convert(date,challandate,106)  between '" + OrderDate.SelectedDate + "'  and '" + HSRPAuthDate.SelectedDate + "' and addrecordby !='Non Dealer' and challanno is not null and challandate is not null group by EmbCenterName, challanno, convert(date,challandate,106),RTOLocationName order by convert(date,challandate,106) ,challanno";
                //sql = "select challanno as InvoiceNo,convert(date,challandate,106) as InvoiceDate,RTOLocationName as Location,b.EmbCenterName as EmbossingCenter,SUM(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) as 'Motorcycle',SUM(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) as 'Scooter', SUM(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END ) '3W',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END ) as 'LMV',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END ) as 'LMV Transport', SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END ) as MCV, SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) as Tractor,(sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ))as TotalQuantity from HSRPRecords a ,rtolocation b where a.rtolocationid=b.rtolocationid  and a.HSRP_StateID='" + strStateId + "' and convert(date,challandate,106)  between '" + OrderDate.SelectedDate + "'  and '" + HSRPAuthDate.SelectedDate + "' and addrecordby !='Non Dealer' and challanno is not null and challandate is not null group by EmbCenterName, challanno, convert(date,challandate,106),RTOLocationName order by convert(date,challandate,106) ,challanno";
            }
            ...
            //add New Column by Amit
            row.Cells.Add(new WorksheetCell("EmbossingCenter", "HeaderStyle6"));

            row.Cells.Add(new WorksheetCell("Location", "HeaderStyle6"));
           // row.Cells.Add(new WorksheetCell("2W", "HeaderStyle6"));
            row.Cells.Add(new WorksheetCell("Motorcycle", "HeaderStyle6"));
            ...
            row.Cells.Add(new WorksheetCell("TotalQuantity", "HeaderStyle6"));
            row.Cells.Add(new WorksheetCell("TotalWeight", "HeaderStyle6"));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                {
                    ...
                    row.Cells.Add(new WorksheetCell(dtrows["EmbossingCenter"].ToString(), DataType.String, "HeaderStyle"));
                   ...
                   // row.Cells.Add(new WorksheetCell(dtrows["2W"].ToString(), DataType.String, "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell(dtrows["Motorcycle"].ToString(), DataType.String, "HeaderStyle"));
                    ...
                    row.Cells.Add(new WorksheetCell(dtrows["TotalQuantity"].ToString(), DataType.String, "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell(dtrows["TotalWeight"].ToString(), DataType.String, "HeaderStyle"));
