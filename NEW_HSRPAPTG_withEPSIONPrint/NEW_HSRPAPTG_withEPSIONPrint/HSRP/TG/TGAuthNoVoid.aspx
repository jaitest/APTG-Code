<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TGAuthNoVoid.aspx.cs" Inherits="HSRP.TG.TGAuthNoVoid" %>
                        ...
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr id="TR1" runat="server">
                                    <td>
                                        <asp:Label ID="Label4" class="headingmain" runat="server">TG Auth NO. Void</asp:Label>
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr>
                                    <td align="center" style="padding-top: 10px">
                                        <asp:Button ID="btnSyncWithGovt" ClientIDMode="Static" runat="server" Text="Void" BackColor="Orange" ForeColor="#000000" autoposback="true" OnClientClick="validatevalue();" Visible="false" OnClick="btnChalan_Click" />
                                    </td>
