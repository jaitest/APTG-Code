    ...
    public partial class ReprintProdSheet : System.Web.UI.Page
    {
        ...
        protected void btnGO_Click(object sender, EventArgs e)
        {
            ...
            {                
                    ...
                    SQLString = "select  Distinct newpdfrunningno   from hsrprecords  where hsrp_StateID='" + DropDownListStateName.SelectedValue +
                        ...
                        strFrmDateString + "' and  '" + strToDateString + "' order by newpdfrunningno";
        ...
        protected void btnChalan_Click(object sender, EventArgs e)
        {
           ...
           // string From1 = "11/28/14";
            //string ToDate = From1 + " 23:59:59";
            string ToDate = HSRPAuthDate.SelectedDate.ToString();

          
            //string from2 = From1 + " 00:00:00";
            string from2 = HSRPAuthDate.SelectedDate.ToString();
                //string from3 = From + " 00:00:00";
            string from3 = OrderDate.SelectedDate.ToString();
            String ReportDateTo = HSRPAuthDate.SelectedDate.ToString();
            String ReportDateFrom=OrderDate.SelectedDate.ToString();
            ...
            strSQL.Append("Select a.hsrprecordID,a.roundoff_netamount,a.OrderStatus, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate, left(a.OwnerName,19) as OwnerName, a.MobileNo,(select  AffixCenterDesc from AffixationCenters where Affix_id= a.affix_id ) as AffixCenterDesc, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, (select rtolocationname from rtolocation where  rtolocationid =a.rtolocationid) as RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, (select HSRPStateName from hsrpstate where HSRP_StateID=a.HSRP_StateID)  as HSRPStateName, (select replace(ProductCode,'MM-','') from Product where productid= a.RearPlateSize) AS RearProductCode,(select replace(ProductCode,'MM-','') from Product where productid= a.FrontPlateSize) AS FrontProductCode,a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a   where  isnull(newpdfrunningno,'')='"+dropdownDuplicateFIle.SelectedItem+"'   ");
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        PdfPCell cell786a = new PdfPCell(new Phrase("Production Sheet No:  " + dropdownDuplicateFIle.SelectedValue.ToString(), new iTextSharp.text.Font(bfTimes, 10f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                        cell786a.Colspan = 14;
                        ...
                        if (dropdownDuplicateFIle.SelectedValue != "")
                        {
                            string squery = "Select distinct erpassigndate from hsrprecords where isnull(newpdfrunningno,'')='" + dropdownDuplicateFIle .SelectedValue+ "'";
                            DataTable dateReportDate = Utils.GetDataTable(squery.ToString(), CnnString);
                            if (dateReportDate.Rows.Count > 0)
                            {
                                ReportDateFrom = Convert.ToDateTime(dateReportDate.Rows[0]["erpassigndate"].ToString()).ToShortDateString();
                            }                            
                        }
                        ...
                        //}
                        if (HSRPStateID == "1" || HSRPStateID == "2" || HSRPStateID == "3" || HSRPStateID == "6" || HSRPStateID == "9" || HSRPStateID == "11" || HSRPStateID == "4" )
                        {
                        ...
                        for (int i = 0; i <= dt.Rows.Count - 1; i++)
                        {
                            ...
                            if (total == 44)
                            {
                                ...
                                PdfPCell cell12093a = new PdfPCell(new Phrase(" ", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                                ...
                                PdfPCell cell123456 = new PdfPCell(new Phrase(" ", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                            ...
                            PdfPCell cell1209316 = new PdfPCell(new Phrase(dt.Rows[i]["FrontProductCode"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                            ...
                            PdfPCell cell1123 = new PdfPCell(new Phrase(dt.Rows[i]["HSRP_Front_LaserCode"].ToString().Replace(".", ""), new iTextSharp.text.Font(bfTimes, 12f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK))); //6
                            cell1123.Colspan = 1;
                            ...
                            PdfPCell cell1124 = new PdfPCell(new Phrase(dt.Rows[i]["RearProductCode"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                            cell1124.Colspan = 1;
                            ...
                            PdfPCell cell1209340 = new PdfPCell(new Phrase(dt.Rows[i]["HSRP_Rear_LaserCode"].ToString().Replace(".", ""), new iTextSharp.text.Font(bfTimes, 12f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK))); // 6
                            ...
                            if (strStateID == "1")
                            {
                                ...
                                PdfPCell ABCDEF = new PdfPCell(new Phrase(dt.Rows[i]["AffixCenterDesc"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                                ABCDEF.Colspan = 1;
                            ...
                            {
                                PdfPCell cell1209329 = new PdfPCell(new Phrase(dt.Rows[i]["roundoff_netamount"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                            ...
                            PdfPCell cell1209329a = new PdfPCell(new Phrase(dt.Rows[i]["Orderstatus"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
