...
{
    public partial class GST_APChalan_New : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (dtData.Rows.Count > 0)
            {
                GenerateCell(table, 9, 0, 0, 0, 0, 1, 0, "(Annexure-" + dtData.Rows[0]["Receipt Voucher No."].ToString() + ")" + "     Commodity - " + GetAddress.Rows[0]["CompanyName"].ToString() + "  (HSN Code - 8310)", 0, 0);
