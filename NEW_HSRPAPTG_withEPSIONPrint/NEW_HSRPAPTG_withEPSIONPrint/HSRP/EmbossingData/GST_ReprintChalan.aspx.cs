...
namespace HSRP.EmbossingData
{
    public partial class GST_ReprintChalan : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            GenerateCell(table, 8, 0, 0, 0, 0, 1, 0, "(Annexure-" + dropdownDuplicateFIle.SelectedValue.ToString() + ")" + "  Commodity - " + GetAddress.Rows[0]["CompanyName"].ToString() + ", (HSN Code - 8310)", 0, 0);
