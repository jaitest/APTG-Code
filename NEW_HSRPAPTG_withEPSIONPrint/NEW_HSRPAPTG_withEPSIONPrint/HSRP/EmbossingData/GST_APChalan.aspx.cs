...
{
    public partial class GST_APChalan : System.Web.UI.Page
    {
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        {                           
                            ...
                            if (true)
                            {
                                ...
                                GenerateCell(table, 3, 0, 1, 0, 0, 1, 0, "Challan No", 0, 0);
                                ...
                                GenerateCell(table, 4, 0, 1, 0, 0, 0, 1, System.DateTime.Now.ToString(), 0, 0);
                                ...
                                {
                                    GenerateCell(table, 3, 1, 1, 1, 0, 0, 1, "Dispatch From:", 20, 0);
                                }
                                else
                                {
                                    GenerateCell(table, 3, 1, 1, 1, 0, 0, 1, "Dispatch From:", 20, 0);
                                ...
                                if (strEmbStationName.Equals("Chintal"))
                                {
                                    GenerateCell(table, 3, 1, 1, 0, 0, 0, 1, "Dispatch To:", 0, 0);
                                }
                                else
                                {
                                    GenerateCell(table, 3, 1, 1, 0, 0, 0, 1, "Dispatch To:", 0, 0);
                                ...
                                #region BlankRow
                                GenerateCell(table, 10, 1, 1, 1, 0, 0, 1, "", 30, 0);
                                #endregion
                                ...
                                GenerateCell(table, 1, 1, 0, 0, 0, 1, 1, "", 0, 0);
                                GenerateCell(table, 4, 1, 1, 1, 0, 1, 1, "Sub Total", 0, 0);
                                ...
                                GenerateCell(table, 4, 1, 1, 0, 0, 1, 1, "CGST@", 0, 0);
                                GenerateCell(table, 1, 0, 0, 0, 0, 1, 1, cgstpre + "%", 0, 0);
                                GenerateCell(table, 1, 1, 1, 0, 0, 1, 1, "", 0, 0);
                                GenerateCell(table, 1, 0, 1, 0, 0, 1, 1, "", 0, 0);
                                ...
                                GenerateCell(table, 4, 1, 1, 0, 1, 1, 1, "SGST@", 0, 0);
                                GenerateCell(table, 1, 0, 0, 0, 1, 1, 1, sgstpre + "%", 0, 0);
                                GenerateCell(table, 1, 1, 1, 0, 1, 1, 1, "", 0, 0);
                                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, "", 0, 0);
                                GenerateCell(table, 1, 0, 1, 0, 1, 2, 1, "", 0, 0);
