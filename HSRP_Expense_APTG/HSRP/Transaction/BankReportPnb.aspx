<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BankReportPnb.aspx.cs" Inherits="HSRP.Transaction.BankReportPnb" %>
                                   ...
                                   <td valign="middle" class="form_text" nowrap="nowrap">                                    
                                    ...
                                    <tr>
                                       ...
                                       <td valign="middle" class="form_text" nowrap="nowrap">
                                            ...
                                            <asp:Label Text="Year:"  runat="server" ID="lblyear"   ForeColor="Black" />&nbsp;&nbsp;          </td>
                                    ...
                                    <tr>
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                             <asp:Button ID="btn_download" runat="server" Text="Export Details For PNB Bank A/C "  Font-Bold="True" ForeColor="#3333FF" OnClick="btn_download_Click" />
                                            &nbsp;&nbsp;&nbsp;
                                        </td>

                                          <td valign="middle" class="form_text" nowrap="nowrap">
                                             <asp:Button ID="Button1" runat="server" Text=" Export Details For Non- PNB Bank A/C"      Font-Bold="True" ForeColor="#3333FF" OnClick="btn_detail_NonPNB" Width="287px" />
                                        </td>
                                       
                                    </tr>
                                         <tr> 
                                        
                                       <td  colspan="5" valign="middle" class="form_text" nowrap="nowrap">                                        
