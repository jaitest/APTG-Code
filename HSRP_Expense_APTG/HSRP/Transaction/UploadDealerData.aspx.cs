...
{
    public partial class UploadDealerData : System.Web.UI.Page
    {
        ...
        private void InsertionOfRecords(DataTable dt)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                string strVehicle = "select count(*) from hsrprecords where hsrp_stateid='" + DropDownListStateName.SelectedValue.ToString() + "' and vehicleregno='" + tt + "' and OrderType='" + OrderType + "'";
