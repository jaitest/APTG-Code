                    ...
                    <table align="center" width="100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 165px">
                                ...
                                <asp:DropDownList AutoPostBack="true" ID="DropDownListStateName" Visible="false" CausesValidation="false"
                        ...
                        <tr>
                            ...
                            <td valign="middle" class="Label_user_batch" style="width: 165px">
                                ...
                                <asp:DropDownList ID="ddlEmbossingCenter"
                                    ...
                                    <asp:ListItem>BURARI Embossing Center</asp:ListItem>
                                    <asp:ListItem>MAYAPURI Embossing Center</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
                                <asp:Label Text="RTO Location:" runat="server" ID="labelClient" Visible="false" ForeColor="Black" /></td>
                            <td valign="middle" class="Label_user_batch" style="width: 165px">
                                ...
                                <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>
                                        &nbsp;<asp:DropDownList ID="dropDownListClient" Visible="false"
                                            CausesValidation="false" AutoPostBack="true"
...
Validations Codes on HSRP File Upload:	<br />
