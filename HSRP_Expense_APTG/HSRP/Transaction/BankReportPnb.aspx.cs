...
{
    public partial class BankReportPnb : System.Web.UI.Page
    {
        ...
        protected void btn_download_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd = new SqlCommand("BankReportDetail_For_PNB", con);
                ...
                com = new SqlCommand("BankReportDetail_For_PNB", con);
                ...
                if (dt.Rows.Count > 0)
                {
                    string filename = "BankDetailReport_PNB" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                    ...
                    row = sheet.Table.Rows.Add();
                     ...
                     row.Index = 6;
                    WorksheetCell cell22 = row.Cells.Add("PUNJAB NATIONAL BANK");
                    cell22.MergeAcross = 4; // Merge two cells together
                    cell22.StyleID = "HeaderStyle2";
                    row = sheet.Table.Rows.Add();
	

                    row.Index = 7;
                    WorksheetCell cell3 = row.Cells.Add("JANGPURA EXTN.,");
                    cell3.MergeAcross = 6; // Merge two cells together
                    cell3.StyleID = "HeaderStyle2";
                    row = sheet.Table.Rows.Add();

                    row.Index = 8;
                    WorksheetCell cell33 = row.Cells.Add("NEW DELHI - 110014");
                    cell33.MergeAcross = 6; // Merge two cells together
                    cell33.StyleID = "HeaderStyle2";
                    row = sheet.Table.Rows.Add();

                    row.Index = 10;
                     WorksheetCell cell5 = row.Cells.Add("Sub : Transfer of Funds from Current Account No. 3090002100112812");
                    ...
                    row.Index = 12;
                    WorksheetCell cell4 = row.Cells.Add("Dear Sir / Madam");
                    ...
                    row.Index = 14;
                    WorksheetCell cell6 = row.Cells.Add("Please find enclosed herewith Cheque No.___________, Dated: " + System.DateTime.Now.ToString("dd/MMM/yyyy") + " for Rs." + dt1.Rows[0]["Totalmount"].ToString() + " only.");
                    ...
                    WorksheetCell cell12 = row.Cells.Add("FOR PNB TO PNB TRANSFER");
                    cell12.MergeAcross = 3; // Merge two cells together
                    cell12.StyleID = "HeaderStyle2";
                    row = sheet.Table.Rows.Add();

                    row.Index = 18;
                    row.Cells.Add(new WorksheetCell("S.No", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Sender A/c No.", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Sender A/c Name", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("EMPLOYEE CODE", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("BENEFICIARY NAME", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("BENEFICIARY A/C NO.", "HeaderStyle"));
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        foreach (DataRow dtrows in dt.Rows) 
                        {
                            ...
                            row.Cells.Add(new WorksheetCell("3090002100112812", DataType.String, "HeaderStyle1"));
                            row.Cells.Add(new WorksheetCell(DDlCompany_Name.SelectedItem.Text.ToString().ToUpper(), DataType.String, "HeaderStyle1"));
                            row.Cells.Add(new WorksheetCell(dtrows["empcode"].ToString(), DataType.String, "HeaderStyle1"));
        ...
        protected void btn_detail_NonPNB(object sender, EventArgs e)
        {
            try
            {
                lblerror.Text = "";
                ...
                SqlCommand cmd = new SqlCommand();
                string strParameter = string.Empty;
                cmd = new SqlCommand("BankReportDetail_For_NON_PNB", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@stateid", Convert.ToInt32(DDlState_Name.SelectedValue.ToString()));
                cmd.Parameters.AddWithValue("@Company_Name", DDlCompany_Name.SelectedValue.ToString());
                cmd.Parameters.AddWithValue("@Month", Convert.ToInt32(DDLMonth.SelectedValue.ToString()));
                ...
                if (dt.Rows.Count > 0)
                {
                    string filename = "BankDetailReport_NONPNB" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                    Workbook book = new Workbook();
                    ...
                    row.Index = 4;
                    WorksheetCell cell1 = row.Cells.Add("TO");
                    cell1.MergeAcross = 2; // Merge two cells together
                    cell1.StyleID = "HeaderStyle2";
                    row = sheet.Table.Rows.Add();
                    ...
                    row.Index = 6;
                    WorksheetCell cell3 = row.Cells.Add("PUNJAB NATIONAL BANK");
                    cell3.MergeAcross = 4; // Merge two cells together
                    cell3.StyleID = "HeaderStyle2";

                    row = sheet.Table.Rows.Add();
                    row.Index = 7;
                    WorksheetCell cell33 = row.Cells.Add("UDYOG VIHAR PHASE-I");
                    cell33.MergeAcross = 4; // Merge two cells together
                    cell33.StyleID = "HeaderStyle2";
                    row = sheet.Table.Rows.Add();
                    
                    row.Index = 8;
                    WorksheetCell cell333 = row.Cells.Add("GURGAON-122016");
                    cell333.MergeAcross = 4; // Merge two cells together
                    cell333.StyleID = "HeaderStyle2";
                    row = sheet.Table.Rows.Add(); 


                    row.Index = 10;
                    WorksheetCell cellsub = row.Cells.Add("Sub.:	Transfer of Funds from Current A/c No.3862002101009305,  I.F.S.C.: PUNB0386200	");
                    cellsub.MergeAcross = 8; // Merge two cells together
                    ...
                    string s1 = "Totalamount";
                    SqlCommand com = new SqlCommand();
                    com = new SqlCommand("BankReportDetail_For_NON_PNB", con);
                    com.CommandType = CommandType.StoredProcedure;
                    com.Parameters.AddWithValue("@stateid", Convert.ToInt32(DDlState_Name.SelectedValue.ToString()));
                    com.Parameters.AddWithValue("@Company_Name", DDlCompany_Name.SelectedValue.ToString());
                    com.Parameters.AddWithValue("@Month", Convert.ToInt32(DDLMonth.SelectedValue.ToString()));
                    ...
                    row.Index = 14;
                    WorksheetCell cell5 = row.Cells.Add("Please find enclosed herewith Cheque No.___________, Dated: " + System.DateTime.Now.ToString("dd/MMM/yyyy") + "  for Rs." + dt1.Rows[0]["Totalmount"].ToString() + " only.");
                    cell5.MergeAcross = 11; // Merge two cells together
                    cell5.StyleID = "HeaderStyle2";
                    row = sheet.Table.Rows.Add();


                    row.Index = 15;
                    WorksheetCell cell56 = row.Cells.Add("You are requested to debit our account against the above cheque and Credit to the following given Account Numbers.");
                    cell56.MergeAcross = 11; // Merge two cells together
                    cell56.StyleID = "HeaderStyle2";
                    row = sheet.Table.Rows.Add();
                                       

                    row.Index = 17;
                    WorksheetCell cell14 = row.Cells.Add("For Non- PNB Bank Accounts");
                    cell14.MergeAcross = 4; // Merge two cells together
                    ...
                    row.Index = 19;                  	
                    row.Cells.Add(new WorksheetCell("S.No", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Account Number", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Amount", "HeaderStyle"));                    
                    row.Cells.Add(new WorksheetCell("Transaction Particulars", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Beneficiary IFSC Code", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Beneficiary  A/c No.", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Beneficiary Name", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Beneficiary Branch", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Sender to Receiver Info1", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Sender to Receiver Info2", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Charge Account", "HeaderStyle"));
                    row.Cells.Add(new WorksheetCell("Employee Code", "HeaderStyle"));
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        foreach (DataRow dtrows in dt.Rows) 
                        {
                            ...
                            row = sheet.Table.Rows.Add();
                            row.Cells.Add(new WorksheetCell(sno.ToString(), DataType.String, "HeaderStyle1"));
                            row.Cells.Add(new WorksheetCell("3862002101009305", DataType.String, "HeaderStyle1"));
                            row.Cells.Add(new WorksheetCell(dtrows["Net_salary"].ToString(), DataType.String, "HeaderStyle1"));
                            row.Cells.Add(new WorksheetCell("Salary"+ DDLMonth.SelectedItem.Text.ToString()+ddlyear.SelectedItem.Text.ToString(), DataType.String, "HeaderStyle1"));
        ...
        {
            if (DDlState_Name.SelectedItem.Text.ToString() != "--Select State Name--")
            {
                CnnString1 = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ToString();
        ...
        //        SqlCommand cmd = new SqlCommand();
        //        string strParameter = string.Empty;
        //        cmd = new SqlCommand("BankReportDetail_For_cheque", con);
        //        cmd.CommandType = CommandType.StoredProcedure;
        //        cmd.Parameters.AddWithValue("@stateid", Convert.ToInt32(DDlState_Name.SelectedValue.ToString()));
        //        cmd.Parameters.AddWithValue("@Company_Name", DDlCompany_Name.SelectedValue.ToString());
        //        cmd.Parameters.AddWithValue("@Month", Convert.ToInt32(DDLMonth.SelectedValue.ToString()));
        ...
        //        string s1 = "Totalamount";
        //        SqlCommand com = new SqlCommand();
        //        com = new SqlCommand("BankReportDetail_For_cheque", con);
        //        com.CommandType = CommandType.StoredProcedure;
        //        com.Parameters.AddWithValue("@stateid", Convert.ToInt32(DDlState_Name.SelectedValue.ToString()));
        //        com.Parameters.AddWithValue("@Company_Name", DDlCompany_Name.SelectedValue.ToString());
        //        com.Parameters.AddWithValue("@Month", Convert.ToInt32(DDLMonth.SelectedValue.ToString()));
        ...
        //        if (dt.Rows.Count > 0)
        //        {
        //            string filename = "BankDetailReport_Cheque" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
        //            Workbook book = new Workbook();
        ...
        //            Worksheet sheet = book.Worksheets.Add("Cheque Detail Report");
        ...
        //            //cell6.StyleID = "HeaderStyle2";
        //            //row = sheet.Table.Rows.Add();
        //            #endregion comented code

        //            row.Index = 6;
        //            row.Cells.Add(new WorksheetCell("S.No", "HeaderStyle"));
        //            row.Cells.Add(new WorksheetCell("Employee Name", "HeaderStyle"));
        //            row.Cells.Add(new WorksheetCell("Cpmpany Name", "HeaderStyle"));
        //            row.Cells.Add(new WorksheetCell("Amount", "HeaderStyle"));
        ...
        //        SqlCommand cmd = new SqlCommand();
        //        string strParameter = string.Empty;
        //        cmd = new SqlCommand("BankReportDetail_For_hold", con);
        //        cmd.CommandType = CommandType.StoredProcedure;
        //        cmd.Parameters.AddWithValue("@stateid", Convert.ToInt32(DDlState_Name.SelectedValue.ToString()));
        //        cmd.Parameters.AddWithValue("@Company_Name", DDlCompany_Name.SelectedValue.ToString());
        //        cmd.Parameters.AddWithValue("@Month", Convert.ToInt32(DDLMonth.SelectedValue.ToString()));
        ...
        //        string s1 = "Totalamount";
        //        SqlCommand com = new SqlCommand();
        //        com = new SqlCommand("BankReportDetail_For_hold", con);
        //        com.CommandType = CommandType.StoredProcedure;
        //        com.Parameters.AddWithValue("@stateid", Convert.ToInt32(DDlState_Name.SelectedValue.ToString()));
        //        com.Parameters.AddWithValue("@Company_Name", DDlCompany_Name.SelectedValue.ToString());
        //        com.Parameters.AddWithValue("@Month", Convert.ToInt32(DDLMonth.SelectedValue.ToString()));
        ...
        //        if (dt.Rows.Count > 0)
        //        {
        //            string filename = "BankDetailReport_Hold" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
        //            Workbook book = new Workbook();
        ...
        //            Worksheet sheet = book.Worksheets.Add("Hold salary Detail Report");
        ...
        //            row.Cells.Add(new WorksheetCell("Employee Name", "HeaderStyle"));
        //            row.Cells.Add(new WorksheetCell("Cpmpany Name", "HeaderStyle"));
        //            row.Cells.Add(new WorksheetCell(" Salary Status", "HeaderStyle"));
        //            row.Cells.Add(new WorksheetCell("Amount", "HeaderStyle"));
        ...
        //                    row.Cells.Add(new WorksheetCell(dtrows["Name"].ToString(), DataType.String, "HeaderStyle1"));
        //                    row.Cells.Add(new WorksheetCell(dtrows["CompanyName"].ToString(), DataType.String, "HeaderStyle1"));
        //                    row.Cells.Add(new WorksheetCell(dtrows["status"].ToString(), DataType.String, "HeaderStyle1"));
        //                    row.Cells.Add(new WorksheetCell(dtrows["Net_salary"].ToString(), DataType.String, "HeaderStyle1"));
