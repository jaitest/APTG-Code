<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AttandancReport_1.aspx.cs" Inherits="HSRP.Expenses.AttandancReport_1" %>
                                    ...
                                    <tr>
                                        <td >
                                            <asp:Label Text="HSRP State:" runat="server" ID="labelOrganization1"
                                                ForeColor="Black" Font-Bold="True" Width="80px" />
                                        </td>
                                        <td >
                                         ...
                                         <td>
                                            <asp:Label Text="Location Name:" runat="server" ID="lbllocation"
                                                ForeColor="Black" Font-Bold="True" Width="80px" />
                                        </td>
                                         <td style="width:110px">
                                           <asp:DropDownList ID="ddllocation" runat="server" Style="margin-left: 5px" TabIndex="3" Width="165px" DataTextField="RTOLocationName" 
                                          ...
                                          <td>
                                            <asp:Label Text="EmpName:" runat="server" ID="label2"
                                                ForeColor="Black" Font-Bold="True" Width="80px" />
                                        </td>
                                         <td style="width:110px">
                                        ...
                                        <td>
                                            <asp:Button ID="btn" runat="server" Text="Preview" Visible="false"
