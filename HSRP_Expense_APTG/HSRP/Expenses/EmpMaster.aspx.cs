...
namespace HSRP.Expenses
{
    public partial class EmpMaster : System.Web.UI.Page
    {
        ...
        {
            string sqlstring = "[BusinessReport_ExpenseMaster] 'EmpMaster','" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','','Report'," + HSRP_StateID1 + " ";
            dt11 = new DataTable();
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@pagename", "EmpMaster")); 
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                book.Properties.Title = "Emplloyee Report";
