<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AttendanceReport_New.aspx.cs" Inherits="HSRP.Expenses.AttendanceReport_New" %>
                                        ...
                                        <asp:Label Text="EmpName:" Visible="true" runat="server" ID="labelemp" />&nbsp;
                                         ...
                                         <td style="width:105px">
                                           <asp:DropDownList ID="ddlUserAccount" runat="server" Style="margin-left: 5px" TabIndex="3" Width="165px" AutoPostBack="true">                                             
                                             ...
                                             <%--<asp:DropDownList AutoPostBack="false" Visible="true" ID="dropDownEmpid" 
                                                    runat="server" DataTextField="EmpName" 
