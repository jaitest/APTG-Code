...
namespace HSRP.Expenses
{
    public partial class AttendanceReport_New : System.Web.UI.Page
    {
        ...
        public void FillUsername()
        {
            ...
            string SQLString = "Select distinct e.Emp_id,(e.Emp_id +'_'+ Emp_Name) as 'Emp_Name' from EmployeeMaster e , AttendanceLog a where e.Emp_id=a.Emp_Id and e.hsrp_stateid='" + HSRPStateID + "' and e.rtolocationid='" + ddllocation.SelectedValue + "' and activestatus='Y'  order by Emp_Name";
       ...
       // string strInvoiceNo = "54321";
        ...
        private void Export(Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                {
                    strquery1 = "select Top 1 ad.Emp_ID as 'EmpID', em.Emp_Name as 'Name', r.RtolocationName as 'RTOLocationName' from AttendanceLog ad, employeemaster em , rtolocation r where ad.Emp_ID=em.Emp_id and em.rtolocationid=r.rtolocationid and ad.hsrp_stateid='" + HSRPStateID + "' and em.Emp_ID like '%LR%' and ad.Emp_ID='" + ddlUserAccount.SelectedValue.ToString() + "'";
               ...
               // string strquery1 = "select Top 1 ad.Emp_ID as 'EmpID', em.Emp_Name as 'Name', r.RtolocationName as 'RTOLocationName' from AttendanceLog ad, employeemaster em , rtolocation r where ad.Emp_ID=em.Emp_id and em.rtolocationid=r.rtolocationid and ad.hsrp_stateid='" + HSRPStateID + "' and ad.Emp_ID='" + ddlUserAccount.SelectedValue.ToString() + "'";
                ...
                cmd.Parameters.Add(new SqlParameter("@att_date", Convert.ToDateTime(OrderDate.SelectedDate)));
                cmd.Parameters.Add(new SqlParameter("@datefrom",Convert.ToDateTime( OrderDate.SelectedDate)));
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    AddNewCell(row, dtempdata.Rows[0]["RTOLocationName"].ToString(), "HeaderStyle2", 1);
                    ...
                    AddNewCell(row, OrderDate.SelectedDate.ToShortDateString(), "HeaderStyle2", 1);
