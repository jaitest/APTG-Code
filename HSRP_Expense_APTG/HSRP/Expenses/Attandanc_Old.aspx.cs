       ...
       // String ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ToString();
        ...
        public void Attandanc_Grid()
        {
            try
            {
                    ...
                    string strquerydata = "select distinct Row_Number() over(order by Emp_ID) as SNo,Emp_ID,Emp_Name from employeeMaster where hsrp_stateid='" + HSRP_StateID + "' and Rtolocationid='" + dropDownListClient.SelectedValue.ToString() + "'";
        ...
        protected void btnintime_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //   // Utils.user_attandanc_in(userid, indate, outdate, HSRPStateID, Request.UserHostAddress.ToString(), MacAddress, BrowserName, ClientOSName, computername, "P", "G11", CnnString);
                //    //lblErrMess.Text = "";
                //    lblSucMess.Text = "Employee Attendance Logout";
                //}
                //else
                //{
                //    lblSucMess.Text = "";
            ...
            try
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < grd.Rows.Count; i++)
                    {
                        ...
                        //    Label lblVehicleRegNo = grd.Rows[i].Cells[1].FindControl("Emp_ID") as Label;

                         //   Label OrderStatus = grd.Rows[i].Cells[2].FindControl("Emp_Name") as Label;
