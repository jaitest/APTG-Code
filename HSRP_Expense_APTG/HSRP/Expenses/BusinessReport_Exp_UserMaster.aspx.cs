...
{
    public partial class BusinessReport_Exp_UserMaster : System.Web.UI.Page
    {
        ...
        {
            string sqlstring = "[BusinessReport_ExpenseUserMaster] '" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','','Report'," + HSRP_StateID1 + " ";
            dt11 = new DataTable();
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //change sp Name
                cmd = new SqlCommand("BusinessReport_ExpenseUserMaster", con);//Business_ReportTypewisesummary_report
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "BusinessReport_ExpenseUserMaster");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    WorksheetCell cell = row.Cells.Add("User Master Report");
