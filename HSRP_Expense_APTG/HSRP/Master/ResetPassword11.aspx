<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="ResetPassword11.aspx.cs" Inherits="HSRP.Master.ResetPassword"%>
                        ...
                        <tr>
                            <td height="27" style="background-image: url(../images/midtablebg.jpg)">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td height="26">
                                            <span class="headingmain">Reset Password</span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <td height="26" bgcolor="#FFFFFF" class="maintext">
                                            <table width="98%" border="0" align="center" cellpadding="3" cellspacing="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <asp:DropDownList ID="ddlUserid" Height="20px" Width="209px" 
                                                    runat="server" DataTextField="Names" AutoPostBack="false"
                                                    DataValueField="Userid" style="margin-left: 11px" >
                                                </asp:DropDownList>
