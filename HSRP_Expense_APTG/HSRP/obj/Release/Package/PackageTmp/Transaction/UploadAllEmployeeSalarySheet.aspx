            ...
            <div style="margin: 20px;" align="left">
                <div>
                    ...
                    <td style="width: 165px">                     
                     ...
                     <tr>
                    <td > <asp:Label Text="Company Name:"  Visible="false"  runat="server" ID="lblCompanyName" ForeColor="Black" />&nbsp;&nbsp;</td>
                    <td  style="width: 165px">                     
                        <asp:DropDownList  ID="DDlCompany_Name"  Visible="false" runat="server" DataTextField="CompanyName" DataValueField="CompanyName" >
                            </asp:DropDownList>
                    </td>
                    </tr>
...
5. There should not be any special character .(Eg. single quote ‘ )</span>
                         ...
                         <td colspan="2">
                                <span nowrap="nowrap" style="color: Maroon; font: verdana arial 12px;">
6.Amount Column should contain only number. (Eg.1000).</span>
                            </td>
                        </tr>
                         <tr>
                         <td colspan="2">
                        ...
                        <tr>
                          ...
                          <tr>
                          <td style=" color:Black;">Total Uploaded Records :</td>
