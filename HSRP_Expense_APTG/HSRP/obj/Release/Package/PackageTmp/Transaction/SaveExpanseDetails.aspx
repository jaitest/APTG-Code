...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("ctl00_ContentPlaceHolder1_dropDownListEmployee").value == "--Select Employee--") {

                alert("Select Employee");

                document.getElementById("ctl00_ContentPlaceHolder1_dropDownListEmployee").focus();
            ...
            //if (!reg.test(document.getElementById("ctl00_ContentPlaceHolder1_txtBillNo").value)) {

            //    alert("Enter Valid Bill No ");
            ...
            //if (!regg.test(document.getElementById("ctl00_ContentPlaceHolder1_txtClaimedBy").value)) {

            //    alert("Enter Valid Claimed By Person");
...
//           var charCode = (evt.which) ? evt.which : event.isNumberKey
                    ...
                    <td colspan="5">
                        <table style="background-color: #FFFFFF" width="85%" border="0" align="center" cellpadding="3"
                            ...
                            <tr>
                                ...
                                <td align="left">
                                             <asp:DropDownList ID="dropDownListEmployee" runat="server" AutoPostBack="true" DataTextField="Emp_Name" DataValueField="ID" Style="margin-left: 8px" Font-Size="Small" Width="170px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtAmount" runat="server" Text="0"  AutoPostBack="true" MaxLength="7" 
                                        class="form_textbox" ontextchanged="txtAmount_TextChanged" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"
                                        ></asp:TextBox>
                                </td>
                            ...
                            <td align="left" valign="top" class="form_text">
                                    VAT\CST: </td>
                                <td align="left" class="form_text" valign="top"> 
                                    <asp:TextBox ID="txtVat" AutoPostBack="true" Text="0" runat="server" class="form_textbox" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"
                                        ontextchanged="txtVat_TextChanged"></asp:TextBox>
                                </td>
                            <td align="left" valign="top" class="form_text">
                                    Service Tax: </td>
                                <td align="left" class="form_text"> 
                                    <asp:TextBox ID="txtservicetax" runat="server" AutoPostBack="true" Text="0" class="form_textbox"  onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"
                            ...
                            <td align="left" valign="top" class="form_text">
                                    Excise Duty + Cess: </td>
                                <td align="left" class="form_text" valign="top"> 
                                    <asp:TextBox ID="txtExcduty" runat="server" AutoPostBack="true" Text="0" class="form_textbox" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"
                                        ontextchanged="txtExcduty_TextChanged"></asp:TextBox>
                                </td>
                            <td align="left" valign="top" class="form_text">
                                    Others :</td>
                                <td align="left" class="form_text"> 
                                    <asp:TextBox ID="txtOthers" Text="0" AutoPostBack="true" runat="server" class="form_textbox"  onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"                                       
                            ...
                            <%--<td align="left" valign="top" class="form_text">
                              ...
                              <td align="left" class="form_text" valign="top">
                                <%--<asp:DropDownList ID="ddlClaimedBy" Style="margin-left: 8px" Font-Size="Small" Width="170px" runat="server"></asp:DropDownList>
                                    
                                <asp:TextBox ID="txtClaimedBy" runat="server" class="form_textbox" ReadOnly="True"></asp:TextBox>
                                </td>--%>
                            <td align="left" valign="top" class="form_text">
                                    Remarks:</td>
                                <td align="left" class="form_text"> 
                                    <asp:TextBox ID="txtRemarks" runat="server" style="border-top: 1px solid #E5E5E5; border-bottom: 1px solid #999999; background-color: #FBFBFB; border-left: 1px solid #E5E5E5; border-right: 1px solid #E5E5E5; color: #5C5B5B; font-size: medium; font-weight: normal;left: -50px; padding-left: 2px;    position: relative;    text-decoration: none;    top: 0; width: 215px;" TextMode="MultiLine" Rows="4" Columns="40"  ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
