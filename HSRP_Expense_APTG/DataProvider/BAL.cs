       ...
       string StringRearPlatePrize, string StringStickerPrize, string StringScrewPrize, ref int isexists)
        ...
        public void SaveBankTranctionDealer(List<string> lst, out string strResult)
        {
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@tranctionMode", lst[13]));
        ...
        public int UpdateBankTranctionDetails(List<string> lst)
        {
            ...
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
              ...
              //  cmd.Parameters.Add(new SqlParameter("@ETAProcess ", lst[13]));
               // cmd.Parameters.Add(new SqlParameter("@EntryType", lst[14]));
                cmd.Parameters.Add(new SqlParameter("@oldTransactionID", lst[13]));

                cmd.Parameters.Add(new SqlParameter("@EntryDate",Convert.ToString(lst[14])));               
               // cmd.Parameters.Add(new SqlParameter("@dealerID", lst[17]));
               // cmd.Parameters.Add(new SqlParameter("@chq_No", lst[18]));
                //cmd.Parameters.Add(new SqlParameter("@chq_date", lst[19]));
                cmd.Parameters.Add(new SqlParameter("@ApprovedStatus", lst[15]));
                //cmd.Parameters.Add(new SqlParameter("@VoidStatus", lst[20]));
